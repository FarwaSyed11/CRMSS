...
var listActivities = [], listActExcludingCallNEmail = [];
    ...
    $(function () {
        ...
        oFullCalendar = new Calendar(calendarEl, {
            ...
            drop: function (info) {
                ...
                resetAllActControls(); $('#ddlActStatus,#ddlActivityOn').prop('disabled', false)
            ...
            eventClick: function (info) {
                ...
                setTimeout(function () {
                    ...
                    //        $('.add-proj-for-GV-only, .txtProjIdMultiDiv').addClass('hidden');
        ...
        loadCallAndEmailActivities();
    });// End Calendar Event function bracket
}
...
function getLostReason() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetLostReason",
        type: "POST",
...
function getCompititorList() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetCompetitorList",
...
function addUpdateReqLost(optNo, revRowId, OppOrRev) {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/AddUpdateLostReason",
...
function getTaggedPersonByRevenue() {
    $.ajax({
        url: "CalendarActivity.aspx/GetTaggedPersonByOptNo",
...
function loadAllEmployees() {
    $.ajax({
        url: "CalendarActivity.aspx/GetAllEmployees",
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
        success: function (result) {
...
function getTaggedPersonByAccNoForBlist() {
    $.ajax({
        url: "CalendarActivity.aspx/GetTaggedPersonByAccNoForBlist",
...
function insertUnderRiskReason() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/UpdateUnderRiskOppReason",
...
function insertUnderRiskReasonForRevenue() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/UpdateUnderRiskRevReason",
...
function insertBlistReason() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/UpdateBlistReason",
        data: JSON.stringify({
...
function getBlistReson() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetBlistReson",
        data: JSON.stringify({
            "UserId": currUserId,
            "ActId": ActIdForAttachment
        }),
...
function getRevenueById() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetRevenueById",
...
function getSalesForecast() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetSalesForecast",
        data: JSON.stringify({ 'OptNo': selOptNumber, 'UserId': currUserId, "RolesList": rolesList }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function getRemainingForecastRevenueProduct() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetRemainingForecastRevenueProduct",
...
function getSalesForecastRevenue(forecastid) {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetSalesForecastRevenue",
...
function addUpdateSalesForcastRevenue(ids) {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/AddUpdateSalesForcastRevenue",
        data: JSON.stringify({
...
function updateOppotunity(loggedInUserRole, isURisk) {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/UpdateOpportunity",
...
function updateRevenue(loggedInUserRole) {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/UpdateRevenue",
...
function generateTitleForEvent() {
    for (var i = 0; i < listActExcludingCallNEmail.length; i++) {

        let item = listActExcludingCallNEmail[i];
...
function showTabsAccordingly(typeName) {
    ...
    $('.txtProjIdDiv, .txtOppIdDiv, .ddlAccIDDiv,.add-acc-icon-div').removeClass('hidden');
    ...
    if (typeName == 'General Visit') {
        ...
        $('.txtProjIdDiv, .txtOppIdDiv, .ddlAccIDDiv,.add-acc-icon-div').addClass('hidden');
...
function addUpdateActivity() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/InserUpdatetActivity",
        data: JSON.stringify({
            'Id': $('#hfId').val(),
            "Type": $('#txtType').val(),
...
function getAllActivity() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetAllActivity",
        ...
        success: function (result) {
            ...
            listActExcludingCallNEmail = listActivities.filter(s => s.ActivityOn != 'Email' && s.ActivityOn != 'Call');

            $.each(listActExcludingCallNEmail, function (key, item) {
                var itemsub = {};
...
function GetAllAcoountDDL() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetAllAccDDl",
...
function loadVlistUpdate() {
    $.ajax({
        url: "CalendarActivity.aspx/GetVLUpdated",
...
function loadVLHistory() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetVLHistory",
...
function updateVL(vlstatus, selComm, quarter, year) {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/UpdateVL",
        data: JSON.stringify({
            'VLStatus': vlstatus,
            'Quarter': quarter,
            'Year': year,
...
function deleteAttachment(id, fname, serverpath) {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/DeleteAttachment",
...
function getAllAttachment() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetAllAttachment",
...
function GetOptHistory() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetOptHistory",
        data: JSON.stringify({ 'OptNo': selOptNumber, "RolesList": rolesList }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function GetOptOtherUpdates() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetOptOtherUpdates",
        data: JSON.stringify({ 'OptNo': selOptNumber, "RolesList": rolesList }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function addRelatedProj() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/AddRelatedProject",
...
function loadOppOnly() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetAllOppRelated",
...
function loadprj() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetAllPRJRelated",
...
function deleteActivity() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/DeleteActivity",
...
function LoadCompanyDDL() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetCompanyDDL",
...
function LoadManager() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/Getmanager",
...
//    $.ajax({
//        url: "CalendarActivity.aspx/GetMember",
...
function loadAllAttendees() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/GetAllAttendees",
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
        async: true,
...
function addParticipants() {
    ...
    for (var i = 0; i < particpantsEmpNos.split(',').length; i++) {
        $.ajax({
            url: "CalendarActivity.aspx/Insertparticipants",
            data: JSON.stringify({
...
function sendEmailtoAttendees() {
    $.ajax({
        url: "CalendarActivity.aspx/SendEmailInvitationToAttendees",
        data: JSON.stringify({
            "ActId": ActIdForAttachment,
...
$('.btn-delete-participant').on('click', function () {
    $.ajax({
        url: "CalendarActivity.aspx/DeleteParticipant",
        data: JSON.stringify({
            "PartiId": selPartiId
        }),
        type: "POST",
...
function getAllparticipantsByActId() {
    $.ajax({
        url: "CalendarActivity.aspx/GetParticipantsById",
        data: JSON.stringify({
            "ActId": ActIdForAttachment
        }),
        type: "POST",
...
function loadCallAndEmailActivities() {
    var htm = '';
    $.each(listActivities.filter(s => s.ActivityOn == 'Call' || s.ActivityOn == 'Email'), function (key, item) {
        htm += "<li data-actid='" + item.Id + "' data-frmdt='" + item.FromDate + "' class='InviReqModalli'>" + item.Subject + " (" + getDateInWordsFormat(item.FromDate) + " )</li>";
    });

    $('#ulActInvitationsReq').html(htm);

    //let date = ''; let dateValue = new Date(oFullCalendar.currentData.viewApi.activeStart);
    //for (var i = 0; dateValue < (new Date(oFullCalendar.currentData.viewApi.activeEnd - 1)); i++) {
        
    //    date += getDateCustomFormate(oFullCalendar.currentData.viewApi.activeStart, i) + ',';
    //    dateValue = new Date(getDateCustomFormate(oFullCalendar.currentData.viewApi.activeStart, i));
    //}
...
$('#ulActInvitationsReq').on('click', '.InviReqModalli', function () {
    loadCallorEmailEvents(this);
});

function loadCallorEmailEvents(obj) {

    var fromDate = $(obj).data('frmdt').split(' ')[0].replaceAll('/', '-');
    ...
    $('#EventModal').modal('show');
    currEventDate = fromDate;

    ActIdForAttachment = actId;
    actIDForAttach.val(ActIdForAttachment)

    selActivityObj = listActivities.filter(s => s.Id == actId);
    selActDateForAttendees = selActivityObj[0].FromDate;
    showTabsAccordingly(selActivityObj[0].Type);
    if (selActivityObj[0].Status == "COMPLETED") { $('.del-act-icon-div').addClass('hidden'); $('#ddlActStatus,#ddlActivityOn').prop('disabled', true); } else { $('.del-act-icon-div').removeClass('hidden'); $('#ddlActStatus,#ddlActivityOn').prop('disabled', false); };
    selActivityObj[0].Status == 'PENDING' ? $('.taMOMDiv ').addClass('hidden') : $('.taMOMDiv ').removeClass('hidden');
    //selActivityObj[0].Status == "COMPLETED" ? $('.del-act-icon-div').addClass('hidden') : $('.del-act-icon-div').removeClass('hidden');
    $('#ddlActivityOn').val(selActivityObj[0].ActivityOn);
...
//    $.ajax({
//        url: "CalendarActivity.aspx/GetAllInvitationRequest",
//        data: JSON.stringify({
//            "EmpNo": EmpNo
//        }),
//        type: "POST",
...
$('.btn-InviYes').on('click', function () {
    ...
    if ($(this).text().trim() == "Yes" || $(this).text().trim() == "No") {
        $.ajax({
            url: "CalendarActivity.aspx/UpdatePartiReq",
            data: JSON.stringify({
                "EmpNo": empno,
                "ActId": ActiId,
                "InviId": InviId,
...
function addActivitiesInBulk() {
    ...
    $.ajax({
        url: "CalendarActivity.aspx/InserActivitiesInBulk",
        data: JSON.stringify({
            "data": listActsInBulk
        }),
        type: "POST",
...
$('.btn-add-Acc-Modal').on('click', function (key,item) {
    $('#addAccountDetailsModal').modal('show');
    getSectors();
    getCountriesList();
})
...
$('#ddlSector').on('change', function () {
    //selSector = $('#ddlSector option:selected').val() == $('#txtOther').val() ? '' : $('#ddlSector option:selected').val()
    $('#ddlSector option:selected').val() == 'OTHER' ? $('.other_sector').removeClass('hidden') : $('.other_sector').addClass('hidden')

})

$('#btnSaveNewCustomer').on('click', function () {

    if (!validateAccountAddControls()) {
...
function getCountriesList() {
    $.ajax({
        url: "CalendarActivity.aspx/LoadCountry",
        //data: JSON.stringify({
        //    "data": listActsInBulk
        //}),
        type: "POST",
        ...
        success: function (result) {
            ...
            $.each(result.d, function (key, item) {
                htm += item.Value.trim() == 'United Arab Emirates' ? '<option value="' + item.Value + '" selected>' + item.Name + ' </option>' : '<option value="' + item.Value + '">' + item.Name + ' </option>';
            })
            $('#ddlCountry').html(htm);
            getCitiesList();
        },
...
function getCitiesList() {
    $.ajax({
        url: "CalendarActivity.aspx/LoadCity",
        data: JSON.stringify({
...
function getSectors() {
    $.ajax({
        url: "CalendarActivity.aspx/LoadSector",
        data: JSON.stringify({
            "UserID": currUserId
        }),
        type: "POST",
...
function UpdateCustomerAccountDetails() {
    $.ajax({
        url: "CalendarActivity.aspx/UpdateCustomerDetails",
        data: JSON.stringify({
            "AccountID": 0,
            "AccountName": $('#txtCustomerName').val(),
            "OwnerID": $('#ddlSalesman option:selected').val().trim(),
            "Owner": $('#ddlSalesman option:selected').text().trim(),
            "Phone": $('#txtPhone').val(),
            "Email": $('#txtPhone').val(),
            "URL": $('#txtURL').val(),
            ...
            "City": $('#ddlCity').val(),
            "userid": currUserId,
            "Sector": $('#ddlSector option:selected').val() == "OTHER" ? $('#txtOther').val() : $('#ddlSector option:selected').val()
        }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function validateAccountAddControls() {
    var isValid = true;
    ...
    if ($('#txtCustomerName').val().trim() == "") {
        $('#txtCustomerName').css('border-color', '#ea090970');
        $('#txtCustomerName').css('box-shadow', '0px 1px 2.5px #e36033d9');
        isValid = false;
    }
    else {
        $('#txtCustomerName').css('border-color', 'lightgrey');
        $('#txtCustomerName').css('box-shadow', '');
    }

    if ($('#txtPhone').val().trim() == "") {
        $('#txtPhone').css('border-color', '#ea090970');
        $('#txtPhone').css('box-shadow', '0px 1px 2.5px #e36033d9');
        isValid = false;
    }
    else {
        $('#txtPhone').css('border-color', 'lightgrey');
        $('#txtPhone').css('box-shadow', '');
    }
       
    if ($('#txtCustomerEm').val().trim() == "") {
        $('#txtCustomerEm').css('border-color', '#ea090970');
        $('#txtCustomerEm').css('box-shadow', '0px 1px 2.5px #e36033d9');
        isValid = false;
    }
    else {
        $('#txtCustomerEm').css('border-color', 'lightgrey');
        $('#txtCustomerEm').css('box-shadow', '');
    }
    
  
        if ($('#txtAddress').val().trim() == "") {
            $('#txtAddress').css('border-color', '#ea090970');
            $('#txtAddress').css('box-shadow', '0px 1px 2.5px #e36033d9');
            isValid = false;
        }
        else {
    ...
    if ($('#ddlSector option:selected').val().trim() == "OTHER") {
        if ($('#txtOther').val() == '') {
            $('#txtOther').css('border-color', '#ea090970');
            $('#txtOther').css('box-shadow', '0px 1px 2.5px #e36033d9');
            isValid = false;
        }
        else {
            $('#txtOther').css('border-color', 'lightgrey');
            $('#txtOther').css('box-shadow', '');
        }
    }
...
function resetAllActControls() {
    ...
    $('#ddlCustStatus').val('-1');
    $('#ddlActivityOn').val('Actual Visit');

}

function getDateCustomFormate(dt, nod) {
