<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DailyActivities.aspx.cs" Inherits="KamiraCosmetics_DailyActivities" %>
...
<head runat="server">
   ...
   <link rel="shortcut icon" href="#" />
    ...
    <script src="Scripts/DailyActivities.js?v=2"></script>
...
.col-form-label {
  ...
  .select2-container--default .select2-selection--single .select2-selection__arrow {
    ...
    background-color: #ae382dd9 !important;
    color: white !important;
    height: 80px;
    font-size: 3rem;
}
        ...
        <div class="card ActivityList" style="margin-top: 1%; left: 1.5%;">
            <div class="card-header" style="border-bottom: 1px solid #98a2af !important;">
                ...
                <h4 id="RequestHeader" style="color: #ffffff; float: left;padding-left: 32%;">Day Activities</h4>
                         ...
                         <i style="float:right;font-size: 4.5rem;" class="fa fa fa-plus"   aria-hidden="true" onclick="AddNewActivity()"></i>
                        </span>
                    </div>
                <div class="row">
            ...
            <div class="card-footer">
                <div class="row">
                    <div class="divDierctMeet" style="width:33%;text-align-last: center;" onclick="VisitList()">
                         <i style="font-size: 4.5rem;" class="fa fa fa-tasks" aria-hidden="true"></i>
                    </div>
                    <div class="divOncall" style="text-align-last: center;width:33%" onclick="CallList()">
                         <i style="font-size: 4.5rem;" class="fa fa fa-phone"   aria-hidden="true"></i>
                    </div>
                    <div class="divOnEmail" style="text-align-last: center;width:33%" onclick="EmailList()">
                        <i style="font-size: 4.5rem;" class="fa fa fa-envelope"   aria-hidden="true"></i>
                    </div>
