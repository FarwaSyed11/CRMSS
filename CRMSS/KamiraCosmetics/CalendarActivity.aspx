<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="CalendarActivity.aspx.cs" Inherits="KamiraCosmetics_CalendarActivity" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    border-color: #f8b884 !important;
        ...
        .office {
         ...
         .vl-visit {
            border-color: #49c516d9;
            background-color: #49c516d9;
            color: white;
        }
        ...
        @media (min-width: 992px) {
         ...
         @media (min-width: 992px) {
            #vlHistoryModal .modal-lg {
                max-width: 1100px;
            }
        }

         /* Media query for activity modal */
...
/*Media Query for Add Account modal*/
         @media only screen and (min-width: 576px) {
    #addAccountDetailsModal .modal-xl{
        max-width: 880px;
    margin: 13.75rem auto;
    }
}
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;zoom:90%;">
        ...
        <div style="padding-left: 2%; padding-top: 1%;">
            ...
            <div class="pull-left">
                <h4 style="color: #a92828;">Calendar </h4>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-3" style="display:flex;justify-content:flex-end;"><asp:Label ID="Label1" Text="Team Member" runat="server" Font-Size="Medium" Font-Bold="true" /></div>
                    <div class="col-md-5"> <select class="form-select placement-dropdown" id="ddlSalesman"></select></div>
                    <div class="col-md-2"><input type="button" id="btnSearch" value="Search" class="btn btn-primary d-block" style="font-size: small" /></div>
                    <div class="col-md-2"><i class="fa fa-file-excel-o cal-week-rep-btn" style="cursor: pointer; font-size: xx-large; color: #d54832;" aria-hidden="true" title="Generate Report"></i></div>
       ...
       <%-- <table class="table table-condensed tblfilter" style="border-bottom-width: 0px !important;" runat="server" id="tbltopsearch">
            <tr>
                ...
                <td class="no-border label-alignment hidden" style="width: 3%">
                    <asp:Label ID="Label8" Text="Company" runat="server" Font-Size="Medium" Font-Bold="true" />
                </td>
                <td class="no-border hidden" style="width: 12%">
                ...
                <td class="no-border label-alignment" style="width: 1%"></td>
                <td class="no-border  label-alignment hidden" style="width: 5%">
                    <asp:Label ID="Label11" Text="Team Member" runat="server" Font-Size="Medium" Font-Bold="true" />
                </td>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-2">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body" style="padding-top: 5%">
                                            ...
                                            <div id="external-events">
                                                <div class="external-event office">Office</div>
                                                <div class="external-event general-visit">General Visit</div>
                                                <div class="external-event customer-visit">Customer Visit</div>
                                               <%-- <div class="external-event project-visit">Project Visit</div>
                                                <div class="external-event bg-danger finalization-visit">Finalization Visit</div>
                                                <div class="external-event surveyy">Survey</div>--%>
                                                <div class="external-event vl-visit hidden">VL Visit</div>
                                ...
                                <div style="max-height:300px; overflow-y:auto;"> <h5 style="text-align: center;border-bottom: 1px solid;">Activity on Calls & Email</h5>
                    ...
                    <div class="nav-align-top">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item hidden">
                             ...
                             <li class="nav-item hidden">
                                <button type="button" class="nav-link liVendorList not-allowed-cursor" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-vl-list" aria-controls="navs-top-vl-list" aria-selected="false">Vendor List Update</button>
                            </li>
                            <li class="nav-item hidden">
                        ...
                        <div class="tab-content" style="min-height: 550px;">                            
                            ...
                            <div class="tab-pane fade show active" id="navs-top-home" role="tabpanel">
                                ...
                                <div class="del-act-icon-div col-1"><span><i class="fa fa-refresh recur-icon " style="float: left; font-size: x-large; color: #4b95e1; cursor: pointer;" aria-hidden="true" title="Repeat Activity"></i></span></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        ...
                                        <div class="">
                                            <select id="txtType" class="form-select color-dropdown" disabled>
                                                ...
                                                <option value="Finalization Visit">Finalization Visit</option>
                                                <option value="Survey">Survey</option>--%>
                                            </select>
                                        </div>
                                    </div>

                                       <div class="col-3 perform-act-on-div">
                                        <label class="col-form-label label-custom" for="basic-default-name">Activity Perform at</label>
                                        <div class="">
                                            <select id="ddlActivityOn" class="form-select color-dropdown">
                                                <option value="-1">--- Select Activity On ---</option>
                                                <option value="Actual Visit" selected>Actual Visit</option>
                                    ...
                                    <div class="col-6">
                                        <label for="html5-number-input" class="col-form-label label-custom">Subject <span style="color: red;">*</span></label>
                                        <div class="">
                                ...
                                <div class="row">
                                    ...
                                    <div class="add-acc-icon-div" style="width:4%; padding-top: 39px;"> <i style="border: 1px solid #938c8c26;border-radius: 50%;padding:4px;color: #cc2c00cc;cursor: pointer;" class='bx bx-plus-medical btn-add-Acc-Modal'></i> </div>

                                    <div style="width:2%" class="add-proj-for-GV-only hidden">
                                ...
                                <div class="row cv-parent-div hidden" style="border: 1px solid #d8c5c5;margin-top: 14px;">
                                   <div style="background: #f8a28754; display: flex;justify-content: center;"><h5>Customer Related Details</h5></div>
                                    <div class="col-4">
                                        ...
                                        <div class="">
                                            ...
                                            <div>
                                                ...
                                                <select id="txtPercWithCust" class="form-select color-dropdown">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="">
                                            ...
                                            <select id="ddlCustStatus" class="form-select color-dropdown">
                                                ...
                                                <%--<option value="PREFER_OTHER">Prefer Other </option>
                                                <option value="PRICE_DRIVEN">Price Driven </option>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div class="">
                                            <%--<input class="form-control" type="text" value="" id="txtOppId" />--%>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <label class="col-form-label label-custom" for="basic-default-name">Remarks <span style="color: red;">*</span> &nbsp;&nbsp; <b class="blink hidden" style="color: #ff3636;">Please specify the customer name in  remarks. </b></label>
                                ...
                                <div class="row taMOMDiv">
                                    ...
                                    <div class="col-12">
                                        <label class="col-form-label label-custom" for="basic-default-name">Minutes Of Meeting <span style="color: red;">*</span></label>
                                        <div>
                                            <textarea class="form-control" id="taMOM" rows="4" placeholder="Enter Minutes of the Meeting"></textarea>
                                        </div>
                         ...
                         <div class="col-8">
                            ...
                            <div class="tab-pane fade" id="navs-top-attachment" role="tabpanel">
                                ...
                                <div class="input-group mb-3" style="position: relative; top: 10px;">
                                    <asp:FileUpload ID="FUUploadNewAttach" CssClass="form-control" runat="server" multiple />
                                ...
                                <div class="input-group input-group-merge">
                                    <textarea id="txtAttachComm" class="form-control" placeholder="Type your Comments…" runat="server" aria-describedby="basic-icon-default-message2"></textarea>
                                    <%--<textarea id="txtAttachComm" class="form-control taEmployeeCommentC" placeholder="Type your Comments…." aria-describedby="basic-icon-default-message2"></textarea>--%>
                                </div>

                                <div style="padding-top: 7px;">

                                    <%--<button type="button" id="btnUpload" class="btn btn-primary">Upload</button>--%>
                                    <asp:Button ID="btnUpload" runat="server" Text="Add Attachment" Style="float: right;" OnClick="btnUpload_Click" CssClass=" btn btn-primary" />
                                </div>
                            ...
                            <%--vendorlist update tab--%>
                              <div class="tab-pane fade" id="navs-top-vl-list" role="tabpanel">
                                <%--5--%>
                                
                                <div class="row">
                                  <table class="table table-bordered table-striped vl-list-table" style="width: 100%">
                                        <%--<caption class="ms-4">List of Projects</caption>--%>
                                        <thead>
                                            <tr>
                                                <th>Product Group</th>
                                                ...
                                                <th>Commitment Quarter</th>
                                                <th>Commitment Year</th>
                                                <th>Actions</th>                                                

                                            </tr>
                                        </thead>
                                        <tbody class="tbody-vl-list">
                                        </tbody>
                                    </table>
                                </div>
                    ...
                    <div class="row" style="margin-top: 1%; max-height: 500px; overflow-y: auto;">
                        <table class="table table-bordered table-striped revenue-table">
                            ...
                            <thead>
                                <tr>
                                                <th>Product Type</th>
                                    <th class="rev-col-hide-for-export">Scope</th>
                                    <th class="rev-col-hide-for-export">Vendor List</th>
                                                <th>Revenue Status </th>
                                                <th style="width: 12%;">Sub Stage </th>

                                    <th class="rev-col-hide-for-export">Waiting Till</th>
                                    <th class="rev-col-hide-for-export" style="width: 12%;">Overview</th>
                                    <th class="rev-col-hide-for-export">Remarks</th>
                                    <th class="rev-col-hide-for-export" style="width: 6%;">Win %</th>
                                                <th>VALUE</th>
                                    <th class="rev-col-hide-for-export">Updated Status</th>

                                    <th class="rev-col-hide-for-export">Action</th>
...
<div class="modal fade" id="InviReqModal" tabindex="-1" aria-hidden="true">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content oppInfoModalContent">
      ...
      <div class="modal-body">
          ...
          <div class="row">
              ...
              <div class="ddlEmpListForUnderRiskDiv hidden" style="margin-top: 2%;margin-bottom: 2%;">                                                                                     
                <select id="ddlEmpListForUnderRisk" class="form-select color-dropdown ddlEmpListForUnderRisk">  </select>                                           
              </div>
          </div>
    ...
    <%--end--%>
       ...
       <%--when user slect customer as BlackListed so this will arise--%>

    <div class="modal fade" id="bListCustModal" tabindex="-1" aria-hidden="true" style="background: #00000052;">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content bListCustModalContent">
      <div class="modal-header">
        <h5 class="modal-title" id="bListCustModalLabel3">Action Plan</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
     
           <div class="row">
              <label for="html5-number-input " class="col-form-label label-custom">Account Name</label>
              <input type="text" class="form-control" id="ddlBlistAccName" disabled/>
          </div>

          <div class="row">
              <label for="html5-number-input " class="col-form-label label-custom">Action Owner *</label>
              <%--<input type="text" class="form-control" id="txtActionOwner">--%>
              <select class="form-select color-dropdown" id="ddlBlistTaggedPerson"> </select> <br />
              <textarea class="form-control hidden" id="taBlistTaggedOther" style="margin-top: 6px;" placeholder="Mention Action Owner" aria-describedby="basic-icon-default-message2"></textarea>
          </div>

          <div class="row">
              <label for="html5-number-input " class="col-form-label label-custom">Due Date *</label>
              <input type="text" class="form-control" style="background-color: white;" id="dpBlistDueDate">
          </div>

          <div class="row">              
              <label for="html5-number-input " class="col-form-label label-custom">Action Required *</label> 
              <textarea class="form-control" id="taBlistActionRequired" placeholder="Input Remarks…." aria-describedby="basic-icon-default-message2"></textarea>
            </div>

      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-label-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary btnUpdateBlist">Save</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="partiReqNoComment" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    ...
    <%--VL Detailshistory--%>
    <div class="modal fade" id="vlHistoryModal" tabindex="-1" aria-hidden="true" style="background: #00000052;">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="lblvlHistoryModal">VL HISTORY</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">

                    <div class="row" style="margin-top: 1%; max-height: 600px; overflow-y: auto;">
                        <table class="table table-bordered table-striped vl-history-table">
                            <%--<caption class="ms-4">List of Projects</caption>--%>
                            <thead>
                                <tr>
                                    <th>Product Group</th>
                                    <th>Marketing Comments</th>
                                    <th>Updated By</th>
                                    <th>Updated Date</th>
                                   <%-- <th>VL Status </th>--%>
                                    <th>Audit Status </th>
    ...
    <%--Revenuw popup when user going to select underrisk for updating opportunities--%>

    <div class="modal fade" id="revInfoModal" tabindex="-1" aria-hidden="true" style="background: #00000052;">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content revInfoModalContent">
      <div class="modal-header">
        <h5 class="modal-title" id="revInfoModalLabel3">OPPORTUNITY INFORMATION</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
          ...
          <div class="row">
              <label for="html5-number-input " class="col-form-label label-custom">Action Owner *</label>
              <%--<input type="text" class="form-control" id="txtActionOwner">--%>
              <select class="form-select color-dropdown" id="ddlTaggedPersonRev"> </select> <br />
              <textarea class="form-control hidden" id="taTaggedOtherRev" style="margin-top: 6px;" placeholder="Mention Action Owner" aria-describedby="basic-icon-default-message2"></textarea>
              <div class="ddlEmpListForUnderRiskRevDiv hidden" style="margin-top: 2%;margin-bottom: 2%;">                                                                                     
                <select id="ddlEmpListForUnderRiskRev" class="form-select color-dropdown ddlEmpListForUnderRisk">  </select>                                           
              </div>
          </div>

          <div class="row">
              <label for="html5-number-input " class="col-form-label label-custom">Due Date *</label>
              <input type="text" class="form-control" style="background-color: white;" id="dpDueDateRev">
          </div>

          <div class="row">              
              <label for="html5-number-input " class="col-form-label label-custom">Action Required *</label> 
              <textarea class="form-control" id="taActionRequiredRev" placeholder="Input Remarks…." aria-describedby="basic-icon-default-message2"></textarea>
            </div>

      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-label-secondary" data-bs-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary btnUpdateRevUR">Save</button>
      </div>
    </div>
  </div>
</div>
 ...
 <div class="modal fade" id="addAccountDetailsModal" style="background: #281d1bbd;" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel4">Account Details</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
                     ...
                     <div class="row">
                                <div class="col-6">
                                    <label class="col-form-label label-custom" for="basic-default-name">Customer Name</label>&nbsp;<span style="color: red;">*</span>
                                    <div class="">
                                ...
                                <div class="col-2">
                                    <label class="col-form-label label-custom" for="basic-default-name">Phone</label>&nbsp;<span style="color: red;">*</span>
                                    <div class="">
                                        <input class="form-control" type="number" value="" id="txtPhone" />

                                    </div>
                                </div>
                                <div class="col-2">
                                    <label class="col-form-label label-custom" for="basic-default-name">Customer Email</label>&nbsp;<span style="color: red;">*</span>
                                    <div class="">
                                ...
                                <div class="row">                                    
                                   ...
                                   <div class="col-3">
                                    ...
                                    <div class="col-3 hidden other_sector">
                                        <label for="html5-number-input" class="col-form-label label-custom">Other</label>&nbsp;<span style="color: red;">*</span>
                                        <div class="">
          ...
          <div class="row">
              <div class="col-12">
                      <label for="html5-number-input" class="col-form-label label-custom">Address</label>&nbsp;<span style="color: red;">*</span>
                      <div class="">
      ...
      <div class="modal-footer">
      <button type="button" class="btn btn-label-secondary" data-bs-dismiss="modal">Close</button>
          <button type="button" class="btn btn-primary" id="btnSaveNewCustomer">Add Account</button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            EmpNo = '<%= Session["EmpNo"] %>';
            myrole = '<%=Session["Role"]%>';
            myroleId = '<%=Convert.ToInt32(Session["Role_ID"])%>';
    ...
    <script src="Scripts/calendar-activity.js?v=2.2"></script>
