...
public partial class KPI_AdminKPIDashboard : System.Web.UI.Page
{
    ...
    public static MyAndMyManagerDetailsForddl GetMyAndMyManagerDetails(string EmpNumber)
    {
        ...
        DBH.CreateDatasetCRMEBSDATA_NewServer(ds, "sp_KPIAdminDashboard", true, pa, pv);
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static List<EmployeeDLL> GetHOD(string orgName, int deptId = -1)
    {
        DBHandler DBH = new DBHandler();
        DataSet ds = new DataSet();
        ArrayList pa = new ArrayList();
        ...
        List<EmployeeDLL> empList = new List<EmployeeDLL>();
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            {
                empList.Add(new EmployeeDLL()
                {
                    EmpNo = dt.Rows[i]["EmpNo"].ToString(),
                    EmpName = dt.Rows[i]["FName"].ToString(),
                    UserId = dt.Rows[i]["User_Id"].ToString(),
                    EmpProPicUrl = dt.Rows[i]["UserImageLink"].ToString(),
                    EmpPageUrl = dt.Rows[i]["rediUrlMyKpi"].ToString(),
                    ManPageUrl = dt.Rows[i]["rediUrlManagerKpi"].ToString(),
                    IsManager = dt.Rows[i]["isManager"].ToString()
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static List<EmployeeDLL> GetManagers(string orgName, int deptId = -1, string LineMan = "-1", string HOD = "-1")
    {
        DBHandler DBH = new DBHandler();
        DataSet ds = new DataSet();
        ArrayList pa = new ArrayList();
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
            {
                ...
                {
                    EmpNo = ds.Tables[0].Rows[i]["EmpNo"].ToString(),
                    EmpName = ds.Tables[0].Rows[i]["FName"].ToString(),
                    UserId = ds.Tables[0].Rows[i]["User_Id"].ToString(),
                    EmpProPicUrl = ds.Tables[0].Rows[i]["UserImageLink"].ToString(),
                    EmpPageUrl = ds.Tables[0].Rows[i]["rediUrlMyKpi"].ToString(),
                    ManPageUrl = ds.Tables[0].Rows[i]["rediUrlManagerKpi"].ToString(),
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static List<EmployeeDLL> GetEmployees(string orgName, int deptId = -1, string LineMan = "-1", string HOD = "-1")
    {
        DBHandler DBH = new DBHandler();
        DataSet ds = new DataSet();
        ArrayList pa = new ArrayList();
