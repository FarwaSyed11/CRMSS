<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="AdminKPIDashboard.aspx.cs" Inherits="KPI_AdminKPIDashboard" %>
                        ...
                        <%--   <td class="no-border  label-alignment" style="width: 3%">
                          ...
                          <td class="no-border" style="width: 17%">
                              <span id="Label10" style="font-family:Times New Roman;font-size:Medium;font-weight:bold;">Organization</span>
                                  <select class="form-select placement-dropdown" id="ddlOrg" > </select>   
                          </td>
...
<%--                          <td class="no-border  label-alignment" style="width: 3%">
                         ...
                         <%-- <td class="no-border  label-alignment" style="width: 8%">
                          ...
                          <td class="no-border" style="width: 17%">
                              ...
                              <select class="form-select placement-dropdown" id="ddlHOD"> </select>   
            ...
            <script src="Scripts/admin-kpi-dashboard.js?v=2.2"></script>
