<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="KPIAdminNew.aspx.cs" Inherits="KPI_KPIAdminNew" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <ul class="nav nav-tabs ass-ul" role="tablist">
    <li class="nav-item">
    ...
    <li class="nav-item">
      <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-profile" aria-controls="navs-top-profile" aria-selected="false">Bussiness Unit KPI</button>
    </li>
  ...
  <table class="table table-bordered table-striped kpi-user-list-table">
    ...
    <div class="tab-pane fade" id="navs-top-profile" role="tabpanel" style="min-height:180px;">
        ...
        <div><h4 style="color: #a92828; margin-top:13px;">Bussiness Unit List </h4></div> 
          <div class="card-body" style="margin-top: -2%; zoom: 90%;">
               ...
               <table class="table table-condensed tblfilter" style="border-bottom-width: 0px !important;" runat="server" id="Table1">
                      <tr>
                          ...
                          <td class="no-border" style="width: 20%">
                              <%--<asp:DropDownList ID="ddlCompany" runat="server" Font-Names="tahoma" CssClass="form-select color-dropdown" AutoPostBack="true" />--%>
                              <select id="ddlOrgBU" class="form-select color-dropdown"> </select>
                          </td>


                          <td class="no-border label-alignment" style="width: 1%"></td>
                          <td class="no-border  label-alignment" style="width: 3%">
                              <asp:Label ID="Label2" Text="Department" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Times New Roman" />
                          </td>
                          <td class="no-border" style="width: 20%">
                              <select class="form-select placement-dropdown" id="ddlDepartBU"> </select>
                              <%--<asp:DropDownList ID="ddlManager" runat="server" Font-Names="tahoma" CssClass="form-select color-dropdown" AutoPostBack="true" />--%>
                          </td>
                          <td class="no-border label-alignment" style="width: 1%"></td>
                          ...
                          <td class="no-border" style="width: 5%">
                              ...
                              <%--<asp:LinkButton ID="btnSearch" runat="server" Text="Search"
                                  CssClass="btn btn-primary d-block" Font-Size="Small"></i>Search</asp:LinkButton>--%>
                              <input type="button" id="btnSearchDashBoardBU" value="Search" class="btn btn-primary d-block" style="font-size:small" /> 
                          </td>
                      </tr>
                  </table>

                 <div class="" style="margin-top: 1%;">
                            <table class="table table-bordered table-striped kpi-hod-list-table">
                              <%--<caption class="ms-4">List of Projects</caption>--%>
                              <thead>
                                <tr>
                                  <th>HOD Emp No</th>
                    ...
                    <div class="" style="width:25%;">
                            ...
                            <div class="table-responsive" style="overflow-y: hidden;width: 100%;padding-top: 10px;">
                                         <table class="table assignment-list-table" style="width: 100%;margin-top: 11px;">
                                           ...
                                           <tbody class="tbody-assignment-list" style="color: #b35653;">
...
<div class="modal fade" id="delKpiConfirmPopup1" style="background: #f0f8ff5c;" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog modal-dialog-centered">
    ...
    <script src="Scripts/kpi-admin-new.js?v1.1"></script>
    <script src="Scripts/kpi-admin-bunit.js?v1.1"></script>
