...
function loadEmployeesList(loadername) {
    ...
    //$('.ajax-loader').show();
    $.ajax({
        url: "KPIAdmin.aspx/GetEmployeesList",
...
function loadKPIAccToUser(empnum) {   // Load KPI Only  // exclude this function
    ...
    $.ajax({
        url: "KPIAdmin.aspx/GetKPIAccToUser",
...
function loadKPIAndMatrics() {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/GetMatricsAccToUserKPI",
...
function addIndicator(indicator, weghtage, targetDesc, indType) {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/InsertIndicator",
...
function updateIndicator(indicator, weghtage, targetDesc, indType) {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/UpdateIndicator",
        data: JSON.stringify({ data: dataObj }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function addMatrics() {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/InsertMatrics",
        data: JSON.stringify({ data: dataObj }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function updateMatrics() {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/UpdateMatrics",
        data: JSON.stringify({ data: dataObj }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function copyKPIToOtherEmp(eFrom, eTo) {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/CopyKPIToOtherEmployee",
...
function deleteKPI() {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/DeleteKPIById",
...
function deleteAssById() {
    $.ajax({
        url: "KPIAdmin.aspx/DeleteAssById",
...
function addUpdateAssignment(msg) {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/AddUpdateAssignment",
...
function loadAllAssignments() {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/GetAllAssignments",
...
function loadAllKPIs() {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/GetAllKPIsList",
...
function loadKPIAccToUserForPopup1(empnum) {   // Load KPI Only, For Indicator Tab only inside the popup
    ...
    //$('#cbIsKpiInsertOn')[0].checked = false;
    $.ajax({
        url: "KPIAdmin.aspx/GetKPIAccToUser1",
        data: JSON.stringify({ empnum: empnum }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function loadRecentAddedKPIAccToUser(empnum) {   // Load Recent KPI of Today Only, For Indicator Tab only inside the popup
    ...
    //$('#cbIsKpiInsertOn')[0].checked = false;
    $.ajax({
        url: "KPIAdmin.aspx/GetRecentAddedKPI",
...
function loadRecentAddedKPIAndMatrics() {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/GetRecentAddedKPIAndMatrics",
        data: JSON.stringify({ 'TodayDate': FormateDateWithTime(new Date()) }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function loadKPIAndMatrics1() {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/GetMatricsAccToUserKPI1",
...
function addIndicator1(indicator, weghtage, targetDesc, indType) {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/InsertIndicator1",
        data: JSON.stringify({ data: dataObj }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function updateIndicator1(indicator, weghtage, targetDesc, indType) {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/UpdateIndicator1",
        data: JSON.stringify({ data: dataObj }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function addMatrics1() {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/InsertMatrics1",
        data: JSON.stringify({ data: dataObj }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function updateMatrics1() {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/UpdateMatrics1",
        data: JSON.stringify({ data: dataObj }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function addKpisIntoAss(kpiid,assid,cbStatus) {
    ...
    $.ajax({
        url: "KPIAdmin.aspx/AddKPIIntoAss",
        data: JSON.stringify({ data: dataObj }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
