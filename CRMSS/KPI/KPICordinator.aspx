<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="KPICordinator.aspx.cs" Inherits="KPI_KPICordinator" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <link href="Css/kpi.css?v=1.8" rel="stylesheet" />
           ...
           <table class="table table-condensed tblfilter" style="border-bottom-width: 0px !important;" runat="server" id="tbltopsearch">
                      <tr>
                          ...
                          <td class="no-border  label-alignment" style="width: 5%">
                              <asp:Label ID="Label11" Text="Employee" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Times New Roman" />
                          </td>
                          <td class="no-border" style="width: 12%">
                              <select class="form-select placement-dropdown" id="ddlEmployee"> </select>
                          </td>

                          <td class="no-border label-alignment" style="width: 1%"></td>
                        
                          <td style="width: 5%"> <label for="defaultSelect" class="form-label">Years</label> </td>
                          <td style="width: 12%">                   
            ...
            <div class="row" style="margin-bottom:12px; margin-top: 15px;">
                <div class="col-10"></div>
                <div class="col-2">
                    <input id="myInput" class="form-control" type="text" style="width:100%;" placeholder="Search..">
                </div>
            </div>

            <div class="table-responsive" style="max-height:765px; overflow-y:auto;">
            <table class="table kpi-year-table">

                <thead style="position:sticky;top:0;text-align:center;">
                    <tr>
                            <th>Employee</th>
                            <th style="padding-right:86px;">Status</th>
                            <th>January</th>
                            <th>February</th>
                            <th>March</th>
                            <th>April</th>
                ...
                <tbody class="tbody-kpi-status-grid" style="text-align:center;">
...
<%--    <table class="table DT-Test-Table">
                ...
                <tbody class="tbody-DT-Test" style="text-align:center;">    
                    <tr>
                        <td>Anwar</td>
                        <td>SUBMITTED</td>
                        <td>SUBMITTED</td>
...
<%--    <div class="modal fade" id="approveconfirmmodal" tabindex="-1" aria-hidden="true">
 ...
 <%--<div class="modal fade" id="rejectconfirmmodal" tabindex="-1" aria-hidden="true">
  ...
  <div class="modal-dialog modal-dialog-centered">
    ...
    <script src="Scripts/kpi-cordinator.js?v=1.9"></script>
