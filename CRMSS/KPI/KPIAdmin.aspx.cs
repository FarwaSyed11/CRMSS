...
public partial class KPI_KPIAdmin : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        Session["ApplicationId"] = 9;
        //string EmpNo = 
        Common.SaveAppUserActivityHistory(Session["ApplicationId"].ToString(), "/KPI/KPIAdmin.aspx", "KPI Admin 1st Tab.", Session["empno"].ToString() , 0);
    }
