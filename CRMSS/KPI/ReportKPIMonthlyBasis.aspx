<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="ReportKPIMonthlyBasis.aspx.cs" Inherits="KPI_ReportKPIMonthlyBasis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
       <div style="padding-left: 2%; padding-top: 1%;"><h5 style="color: #a92828; margin-top:13px">Monthly Employee KPI Point Report</h5></div> 
           ...
           <table class="table table-condensed tblfilter" style="border-bottom-width: 0px !important;" runat="server" id="tbltopsearch">
                  ...
                  <%--        <td class="no-border label-alignment" style="width: 10%">
                        ...
                        <td class="no-border label-alignment" style="width: 10%">
                          ...
                          <td class="no-border label-alignment" style="width: 20%">
  ...
  <table class="table table-bordered table-striped kpi-user-list-table">
    ...
    <thead>
          ...
          <tr>
              <th colspan="5" style="background-color:#a92828 !important; padding-right: 400px;">Employee Details</th>
              <%--<th>Employee Name</th>
              <th>Employee EmpNo</th>
              <th>Employee Organization</th>
              <th>Employee Department</th>
              <th>Employee Position</th>--%>
              <th colspan="13" style="background-color:#a92828 !important;text-align:center;">KPI Monthly Points</th>            
          </tr>
...
<div class="modal fade" id="delKpiConfirmPopup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    ...
    <script src="Scripts/report-kpi-monthly-basis.js?v1.3"></script>
