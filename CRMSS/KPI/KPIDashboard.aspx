<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="KPIDashboard.aspx.cs" Inherits="KPI_KPIDashboard" %>
...
<%--                          <td class="no-border  label-alignment" style="width: 3%">
                         ...
                         <%-- <td class="no-border  label-alignment" style="width: 8%">
                          ...
                          <%-- <td class="no-border  label-alignment" style="width: 10%">
                              ...
                              <select Id="ddlManager" class="form-select color-dropdown" disabled>  </select>                                                 
                          </td>
                         ...
                         <%-- <td class="no-border  label-alignment" style="width: 3%">
                          ...
                          <td class="no-border" style="width: 10%">      
                              ...
                              <select Id="ddlEmployee" class="form-select color-dropdown" disabled>  </select>                                                 
                          </td>
                                ...
                                <div class="row">
                                    <div class="col-md-1 colwidthfirst">
                                        ...
                                        <div style="text-align: center; padding-top: 25%;">
                                            <img src="" id="dashboardProPic" alt="../Dashboard/assets/img/avatars/5.png" style="width: 60%; border-radius: 60%;" /></div>

                                    </div>

                                    <div class="col-md-2 loggedin-username" style="padding-top: 2%;">
                                         <%--<h5 class="loggedin-username"> Good Morning..</h5>--%> 
                                        <h4 class=""> &nbsp&nbsp ANWAR AHMED</h4> <br />
                                    ...
                                    <div class="col-md-2" style="text-align: center; padding-top: 1%; border-left: solid 8px #e6e6e6; border-right: solid 8px #e6e6e6;">
                                        ...
                                        <div class="text-center fw-semibold pt-3 mb-2 overall-growth"></div>

                                    </div>

                                    <div class="col-md-6">
                                        <div class="text-center rowfisthding">KPI </div>
                                        <div id="KpiPointsYearlyBarChart" class="px-2  totrev"></div>
    ...
    <script src="../assets/js/econnect-common.js"></script>
            ...
            <script src="Scripts/kpi-dashboard.js?v=1.1"></script>
