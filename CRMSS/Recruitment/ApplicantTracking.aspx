<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="ApplicantTracking.aspx.cs" Inherits="Recruitment_ApplicantTracking" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <style type="text/css">
        ...
        .tbody-rrf, .tbody-rrfreq-attach,.tbody-CandiShorlisted,.tbody-interview,.tbody-candiselected,.tbody-history td {
            text-align: center;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="row" style="/*display: flex; justify-content: flex-end; margin-top: -25px; */">
                        ...
                        <div class="col-md-9">
                            <select id="ddlFilterAssignedToMeTask" class="form-select color-dropdown">
                ...
                <div class="col-md-3">
                    <%--<a href="#" class="btn btn-primary" id="btn-add-rff-grid" style="float: right;"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Add RRF</a>--%>
    ...
    <div class="modal fade" id="addExisCandidateModal" tabindex="-1" data-bs-backdrop="static" style="background-color: rgba(0, 0, 0, 0.44); z-index: 9999" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" style="border-bottom: 0px;">
                              <h5 class="modal-title">Existing Candidates List</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

            <div class="modal-body" style="margin-top: -20px; padding-bottom: 0;">

                 <div class="row" style="margin-top:12px;max-height: 600px; overflow-y: auto;overflow-x:hidden;">
                                            <table class="table table-bordered table-striped nowrap tablepopup tbl-exist-candidate" style="width:100%;">
                                                ...
                                                <tbody class="tbody-exist-candidate" style="text-align:center;">
                                                </tbody>
                                            </table>
                                        </div>
            ...
            <div class="modal-footer" style="justify-content: flex-start;">
                ...
                <a href="#" class="btn btn-primary pull-right btn-add-exis-candi"> Select</a>
            </div>
        </div>
    </div>
    </div>
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="closed-rrf-process hidden" style="display: flex; justify-content: end; width: 71%;"> <span class="btn btn-primary btnCloseRRF"><i class="fa fa-check" aria-hidden="true" style="color: #ffffff;"></i> &nbsp; Close RRF</span></div>
                        ...
                        <div class="" style="margin-top: 1%;">
                            ...
                            <div class="nav-align-top">
                                <ul class="nav nav-tabs" role="tablist">
                                 ...
                                 <%--   <li class="nav-item">
                                        <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#tab-ViewQualification" aria-controls="tab-ViewQualification" aria-selected="false">Qualification &nbsp;<i class="fa fa-graduation-cap"></i></button>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#tab-AllCandidates" aria-controls="tab-AllCandidates" aria-selected="true">All Candidates &nbsp;<i class="fa fa-user-circle"></i></button>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <%--    <div class="tab-pane fade show active" id="tab-ViewQualification" role="tabpanel">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="pull-right rrfreq-approve-div hidden">
                                                    <a href="#" class="btn btn-success btn-approve-rrfreq" title="Approved" style="padding: 3px 12px; background: #98ca3c; border-color: #98ca3c; border-radius: 5px;"><i class="bx bx-check"></i>Approve</a>
                                                    <a href="#" class="btn btn-danger  btn-reject-rrfreq" title="Rejected" style="padding: 3px 9px; border-radius: 5px;"><i class="bx bx-x"></i>Reject</a>
                                                </div>
                                            </div>
                                    ...
                                    <div class="tab-pane fade show active" id="tab-AllCandidates" role="tabpanel">

                                        <div class="row">
                                            <div>
                                                <a href="#" class="btn btn-primary pull-right btn-add-candi-grid" style="margin-left: 12px;"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; New Candidate</a>
                                                <a href="#" class="btn btn-primary pull-right btn-add-exis-candi-grid"><i class="fa fa-plus" aria-hidden="true"></i>&nbsp; Existing Candidate</a>
                                            </div>
                                        </div>
  ...
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="modal fade" id="ModalEvelutionForm" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
         <div class="modal-dialog modal-xl" role="document" style="background:white;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Interview Evaluation Form</h5>
                     ...
                     <div class="row" style="padding-top:1%;">
                                ...
                                <div class="row" style="padding-top:1%;">
                                    ...
                                    <div class="col-2">
                                       ...
                                       <%--    <select class="form-control" id="txtInterviewType1" style="border-color: lightgrey;" disabled>
                                             </select>--%>
                                          <input class="form-control" type="text" id="txtInterviewType1" readonly="" disabled="">
                                    </div>
                                     ...
                                     <div class="col-2">
                                         ...
                                         <%--<input class="form-control" type="text" id="txtInterviewType2" readonly="" disabled="">--%>
                                     </div>
  ...
  <div class="modal-dialog modal-dialog-centered">
    ...
    <%--Shortlisted Docs Details MODAL--%>
    
        <div class="modal fade" id="selectedCandiDetModal" style="background-color:#00000070;" tabindex="-1" aria-hidden="true">
             <div class="modal-dialog modal-lg" role="document">
               <div class="modal-content">
                 <div class="modal-header">
                   <h5 class="modal-title" id="lblselectedCandiDetModalCandiDetModal">Checklist</h5>
                   <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                 </div>
                 <div class="modal-body">
                 
                      <table class="table table-striped nowrap tablepopup tbl-selected-candi-detail" style="width: 100%;">
                                    ...
                                    <tbody class="tbody-selected-candi-detail">
                                       <%-- <tr>
                                            <td>1</td>
                                            <td>Offer Letter</td>
                                            <td>Submitted</td>
                 ...
                 <div class="modal-footer finDocFooter">
                   <button type="button" class="btn btn-label-secondary" data-bs-dismiss="modal">Close</button>
                   <button type="button" class="btn btn-primary btnUpdateFinalDocs">Save changes</button>
                 </div>
               </div>
             </div>
    </div>
    
    <%--Shortlisted Docs Details MODAL end--%>
    ...
    <script src="Scripts/applicant-tracking.js?v=1.1"></script>
