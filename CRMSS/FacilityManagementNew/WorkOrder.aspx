...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <style>
        ...
        .table-Approvedreq th{
            background-color: #d54832 !important;
            color: white !important;
        }

        .table-Approvedreq td{
            color: #333333 !important;
        }
        ...
        .table-Allproblem-List th{
            background-color: #d54832 !important;
            color: white !important;
        }

        .table-Allproblem-List td{
            color: #333333 !important;
        }

        .AllWODailySummary-table th{
            background-color: #d54832 !important;
            color: white !important;
        }

        .AllWODailySummary-table td{
            color: #333333 !important;
        }

        .table-AllAttechements th{
            background-color: #d54832 !important;
            color: white !important;
        }

          .table-AllAttechement td{
            color: #333333 !important;
        }

        .table-AllMaterialRequest th
        {
            background-color: #d54832 !important;
            color: white !important;
        }
        .table-AllMaterialRequest td{
            color: #333333 !important;
        }
            ...
            <div class="nav-align-top row">
                <ul class="nav nav-tabs" id="propery-tabs-ul"  role="tablist">
                    <li class="nav-item">
                     ...
                     <li class="nav-item tabApprovedrequest">
                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-Approvedreq">Approved Request</button>
                    </li>
                  <%--  <li class="nav-item">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="navs-top-my-project">
                          <div class="divddlstatus">
                                <asp:Label ID="lblReq" Text="Filter Based On Status:" runat="server" Font-Size="Medium" Font-Bold="true" />
                                &nbsp;&nbsp
                           
                                <select class="form-select placement-dropdown" id="ddlStatus" style="Width:9%">
                                    <option value="-1" selected> --- ALL --- </option>
                                    <option value="0">  NEW  </option>
                                     <option value="1"> WO-APPROVED  </option>
                    ...
                    <div class="tab-pane fade" id="navs-top-Approvedreq" role="tabpanel">
                        <table class="table  table-Approvedreq" style="width: 100%">
        ...
        <div class="modal-dialog modal-xl" role="document" style="max-width: 95%">
            <div class="modal-content" <%-- style="background: antiquewhite;"--%>>
                ...
                <div class="modal-body">
                    ...
                    <div id="ContractDetailsRowDiv" style="background: #d16b6b36; padding: 17px; border-radius: 12px; border: 1px solid #1d1b1b36; box-shadow: 4px 4px 13px -7px #d16b6b36;">
                        ...
                        <div class="row">
                            ...
                            <div style="width: 10%;">
                                ...
                                <div class="">
                                    <input class="form-control" type="text" id="textWOstatus1" readonly />
                        ...
                        <div class="nav-align-top">
                            ...
                            <div class="tab-pane fade show active" id="navs-Workorderlist" role="tabpanel">
                                ...
                                <div class="table-responsive" style="margin-top: 1%; width: 100%">
                                    ...
                                    <table class="table WorkOreder-List" style="width: 100%">
                            ...
                            <div class="tab-pane" id="navs-top-Allproblems" role="tabpanel">
                                    ...
                                    <div class="table-responsive active" id="" style="margin-top: 1%; width: 100%;">
                                        ...
                                        <table class="table table-Allproblem-List" style="width: 100%;">
                                            ...
                                            <tbody class="tbody-AllWOproblem-list" style="text-align: center;">
                                            </tbody>
                                        </table>
                            ...
                            <div class="tab-pane" id="navs-top-alldaysummary" role="tabpanel">
                                    ...
                                    <div class="table-responsive" style="margin-top: 0%; width: 100%;">
                                        <table class="table AllWODailySummary-table" style="width: 100%;">
                                            ...
                                            <tbody class="tbody-AllWODailySummary-List" style="text-align: center;">
                                            </tbody>
                                        </table>
                                    </div>
                                </div>
                   ...
                   <br />
                      ...
                      <div class="row">
                          ...
                          <div class="col-9" style="display:inline-flex">
                              ...
                              <div class="input-group" style="width: 100%" id="btn-documetuploaded">
                                  <label style="margin-right: 10px; display: none;" class="lbl-fufile-count"></label>
                                   <div>  <textarea class="form-control" id="textattachementremarks" rows="1"></textarea></div>
...
<%--                        <div class="row">                           
                        ...
                        <div class="row">
                             <div>
                                <label class="col-form-label label-custom" for="basic-default-name">Problem <span style="color: red;">*</span></label>
                                <div>
                    ...
                    <div class="modal-body proj-popup">
                        ...
                        <div class="row">
                            <div class="col-5">
                                ...
                                <div>
                                    <select id="ddlDailyworkEmpName" class="form-select color-dropdown" multiple> </select>
                             ...
                             <div class="col-5">
                                <label class="col-form-label label-custom" for="basic-default-name">Employee Description <span style="color: red;">*</span></label>
                                <div>
                                    <textarea class="form-control" id="textemployeedescription" rows="2"></textarea>
                                </div>
                            </div>
                        ...
                        <button type="button" class="btn btn-primary" runat="server"  data-bs-dismiss="modal" onclick="addWODailySummary()">Save</button>
                      </div>
   ...
   <%-- End --%>
    ...
    <script src="js/workorder.js?v=1.3"></script>
