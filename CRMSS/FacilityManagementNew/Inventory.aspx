<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="Inventory.aspx.cs" Inherits="FacilityManagementNew_Inventory" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="card-body" style="margin-top: -1%; min-height: 85vh;">
            ...
            <div class="nav-align-top">
                 ...
                 <ul class="nav nav-tabs" id="WORequest-List-ul" role="tablist">
                       ...
                       <li class="nav-item">
                         <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-completedRequest" aria-controls="navs-top-completedRequest" aria-selected="false">Pending</button>
                     </li>

                     <li class="nav-item">
                         <button type="button" class="nav-link " role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-NewRequest" aria-controls="navs-top-NewRequest" aria-selected="false">Request</button>
                     </li>
                     
                     
                 </ul>
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="navs-top-completedRequest" role="tabpanel" style="margin-top: -2%;">
                    ...
                    <div class="tab-pane" id="navs-top-NewRequest">

                     <div>
                        <a href="#" class="btn btn-primary pull-right btn-add-MeterialRequest"><i class="fa fa-plus" aria-hidden="false"></i>&nbsp; Material Request</a>
                    </div>
                        ...
                        <div class="" style="margin-top: 0%;">
                            <table class="table table-AllmaterialRequest" style="width: 100%;">
                                ...
                                <tbody class="tbody-AllMeterialRequest" style="text-align: center;">
                                </tbody>
                            </table>
    ...
    <%-- dal for MAterial request --%>

    <div class="modal fade" id="ModalCreateMaterialRequest" tabindex="-1" aria-hidden="true">
                ...
                <div class="modal-body proj-popup">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3">
                                ...
                                <div>
                                    <input type="text" id="textMaterialreqno" class="form-control"  disabled />
                            ...
                            <div class="col-3">
                                <label for="html5-number-input" class="col-form-label label-custom">Property Name <span style="color: red;">*</span></label>
                                 <div>
                                        <select id="ddlpropertyname" class="form-select color-dropdown">
                                        </select>
                                    </div>
                            </div>
