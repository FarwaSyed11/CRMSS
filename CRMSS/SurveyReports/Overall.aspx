<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="Overall.aspx.cs" Inherits="SurveyReports_Overall" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <table class="table table-bordered table-striped SurveyReport">
    ...
    <thead>
      <tr>
          <th colspan="8" style="height:70px;text-align:center;font-style:oblique;vertical-align:middle;font-size: x-large;">Overall Competency Level Feedback </th>
    </tr>
        
        <tr>

            <th style="width:10%;text-align:center;font-style:oblique;vertical-align:middle">Competency Name</th>
             <th style="width:5%;text-align:center;font-style:oblique;vertical-align:middle">Skill No</th>
