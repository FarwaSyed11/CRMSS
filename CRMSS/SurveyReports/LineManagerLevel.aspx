<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="LineManagerLevel.aspx.cs" Inherits="SurveyReports_LineManagerLevel" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <table class="table table-bordered table-striped SurveyReport">
    ...
    <thead>
      <tr>
          <th colspan="8" style="height:70px;text-align:center;font-style:oblique;vertical-align:middle;font-size: x-large;">Line Manager Level Feedback </th>
    </tr>
        
        <tr>
             <th style="width:10%;text-align:center;font-style:oblique;vertical-align:middle">LM EmpNo</th>
            <th style="width:15%;text-align:center;font-style:oblique;vertical-align:middle">LM Name</th>
            <th style="width:10%;text-align:center;font-style:oblique;vertical-align:middle">No of Direct Reporting</th>
             <th style="width:10%;text-align:center;font-style:oblique;vertical-align:middle">Recent cross functional evaluation rate</th>
            ...
            <th style="width:10%;text-align:center;font-style:oblique;vertical-align:middle">Section name</th>
...
<%--    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.3.2/js/dataTables.buttons.min.js"></script>
 ...
 <%--     
    ...
    <script src="Scripts/LineManagerLevel.js"></script>
