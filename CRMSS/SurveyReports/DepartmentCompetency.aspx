<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="DepartmentCompetency.aspx.cs" Inherits="Survey_DepartmentCompetency" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <table class="table table-bordered table-striped SurveyReport">
    ...
    <thead>
      <tr>
          <th colspan="8" style="height:70px;text-align:center;font-style:oblique;vertical-align:middle;font-size: x-large;">Department Competency Level Feedback </th>
    </tr>
        
        <tr>
             <th style="width:10%;text-align:center;font-style:oblique;vertical-align:middle">HOD EmpNo</th>
            <th style="width:10%;text-align:center;font-style:oblique;vertical-align:middle">HOD Name</th>
            <th style="width:10%;text-align:center;font-style:oblique;vertical-align:middle">Competency Name</th>
             <th style="width:30%;text-align:center;font-style:oblique;vertical-align:middle">Skill Name</th>
             <th style="width:10%;text-align:center;font-style:oblique;vertical-align:middle">Recent evaluation rate</th>
            <th style="width:10%;text-align:center;font-style:oblique;vertical-align:middle">Accumulated evaluation rate</th>
            <th style="width:10%;text-align:center;font-style:oblique;vertical-align:middle">Department name</th>
            <th style="width:10%;text-align:center;font-style:oblique;vertical-align:middle">Organization name</th>
        </tr>
    </thead>
...
<%--    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.3.2/js/dataTables.buttons.min.js"></script>
 ...
 <%--     
    ...
    <script src="Scripts/DeptCompetency.js"></script>
