...
<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="MTAccounts.aspx.cs" Inherits="Marketing_MTAccound" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script src="../CustomSearch/js/jquery-customselect-1.9.1.js"></script>
     ...
     <script src="../Marketing/Scripts/MTAccounts.js?v=0.5"></script>
                ...
                <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                    ...
                    <div class="card-block">
                        ...
                        <div class="row">
                             <div class="pull-right">
                              ...
                              &nbsp;&nbsp;  &nbsp;&nbsp;
                               ...
                               <div class="pull-right">
                                <label class="form-label">
                                    Marketing : 
                                                <asp:DropDownList ID="ddlMarketingSearch" runat="server" ForeColor="Black"  CssClass="textBox11 form-control"></asp:DropDownList>
                                </label>
                            </div>
                             &nbsp;&nbsp;  &nbsp;&nbsp;
                               <div class="pull-right">
                             ...
                             &nbsp;&nbsp;  &nbsp;&nbsp;
                               ...
                               <div class="pull-right">
                                <label class="form-label">
                                    Update Status : 
                                                <asp:DropDownList ID="ddlStatusSearch" runat="server" ForeColor="Black" CssClass="textBox11 form-control">
                                                    <asp:ListItem Value="0" Text="NOT UPDATED"></asp:ListItem>
                        ...
                        <div id="dvupdate" runat="server" style="overflow-y: auto; height: calc(100vh - 270px);overflow-x:hidden">
                            <asp:GridView ID="gdvSummaryDetails" runat="server" AutoGenerateColumns="False" OnRowCommand="gdvSummaryDetails_RowCommand" OnRowDataBound="gdvSummaryDetails_RowDataBound"
                                 Style="overflow-x: scroll" OnSorting="gdvSummaryDetails_Sorting" OnRowUpdating="gdvSummaryDetails_RowUpdating"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Account Name" ItemStyle-Width="5%" Visible="True" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="AccountName">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Last Assignment Date" ItemStyle-Width="15%" Visible="True" SortExpression="LastAssignmentDate">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Phone" ItemStyle-Width="10%" Visible="true" ItemStyle-HorizontalAlign="Center" SortExpression="Phone">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Email" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Left" SortExpression="Email">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="URL" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Left" SortExpression="URL">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Address" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center" SortExpression="Address">
                                        <ItemTemplate>
                                     ...
                                     <asp:TemplateField HeaderText="City" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center" SortExpression="City">
                                        <ItemTemplate>
                                  ...
                                  <asp:TemplateField HeaderText="% Of Relation With Account"  ItemStyle-Width="7%" Visible="true" ItemStyle-HorizontalAlign="Center" SortExpression="RelationPerc">
                                    ...
                                    <asp:TemplateField HeaderText="Others" ItemStyle-Width="5%" Visible="false" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbOthers" runat="server" Visible="false" CommandName="Others" CommandArgument='<%#(Eval("CRMAccountId").ToString()) %>' CssClass="btn rounded-pill btn-icon btn-round">
                            ...
                            <div class="row">
                                <asp:Button runat="server" ID="btnLoadMoreSummary" Width="100%" Text="Load More" Visible="false" OnClick="btnLoadMoreSummary_Click"></asp:Button>
                            </div>
                        </div>
                        </div>
                    </div>
...
<%--                        <div class="pull-left">
                                 ...
                                 <div style="padding-bottom:1%;padding-top:1%">
                                     ...
                                     <tr style="font-size: 13px;">
                                         ...
                                         <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
                                             ...
                                             <asp:HiddenField ID="hfdRelated" runat="server" Value="5" />
                                         </td>
                        ...
                        <asp:Panel ID="pnlRelatedDetails" runat="server" CssClass="pnlsubheading">
                             <div class="pull-left" style="margin-top: -8px;">
                              ...
                              <%--         <a id="aOpportunity" runat="server">
                                     ...
                                     <a id="aRelatedPRJ" runat="server">
                                             <asp:Button ID="btnRelatedPRJ" runat="server" Text="Related Project" Width="235px" BackColor="Transparent" BorderStyle="None" OnClick="btnRelatedPRJ_Click"/>
                             ...
                             <div class="pull-right" style="margin-top: -9px; width: 10%; padding-right: 1%;">
                                  <asp:DropDownList ID="ddlStatus" runat="server" CssClass="textBox1 form-control" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged" BackColor="#e8eaed" AutoPostBack="true"></asp:DropDownList>
                         ...
                         <div id="Div1" runat="server" style="overflow-y: auto; max-height: calc(100vh - 480px);overflow-x:hidden">
                            ...
                            <asp:GridView ID="gdvRelated" runat="server" AutoGenerateColumns="False"
                                 CellSpacing="0" BorderWidth="0" AllowSorting="True" EmptyDataText="No Data Found" OnSorting="gdvRelated_Sorting"
                                class="table-striped table-bordered nowrap" ForeColor="#333333" CellPadding="4" GridLines="None">
                                <FooterStyle CssClass="GridFooter" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                                <RowStyle CssClass="GridItem" BackColor="#E3EAEB" />
                                <HeaderStyle HorizontalAlign="Center" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                        ...
                        <div class="card-body" style="margin-top: -2%;">
                            <div class="nav-align-top tab-Inspections" style="padding-top: 1%;">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#tab-SalesmanUpdate" aria-controls="tab-SalesmanUpdate" aria-selected="false">Marketing Update</button>
                                    </li>
                                    <li class="nav-item">
                                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#tab-SalesmanagerUpdate" aria-controls="tab-SalesmanagerUpdate" aria-selected="false">MarketingManager Update</button>
                                    </li>
    ...
    <asp:UpdateProgress ID="UpdateProgress1" AssociatedUpdatePanelID="UpdatePanel1" runat="server" >
        <ProgressTemplate >
         <div style="z-index:100002 !important; background: url('/CRMSS/CRMSS/Style/Engine/images/black-bg.png');">
                <div class="CenterPB" >
