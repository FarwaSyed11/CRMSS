<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="HoldUpdate.aspx.cs" Inherits="Marketing_HoldUpdate" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
       <link rel="stylesheet" href="../Theme/Modified/modifiedcss.css" type="text/css" />
        ...
        <script src="Scripts/HoldUpdate.js?v=0.7"></script>
                ...
                <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="pnlheading">
                        <div class="card-header pnlheading">
                            <h3>
                                <asp:Label ID="Label13" ForeColor="White" Font-Bold="true" runat="server" Text="HOLD UPDATE"></asp:Label>
                    ...
                    <div class="card-block">
                        ...
                        <asp:GridView ID="gdvHoldUpdate" runat="server" AutoGenerateColumns="False" CellSpacing="0" BorderWidth="0" 
                            AllowSorting="True" EmptyDataText="No Data Found"  AllowPaging="false" 
                             OnSorting="gdvHoldUpdate_Sorting" OnRowDataBound="gdvHoldUpdate_RowDataBound"  OnRowCommand="gdvHoldUpdate_RowCommand"
                            OnRowEditing="gdvHoldUpdate_RowEditing" OnRowUpdating="gdvHoldUpdate_RowUpdating"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Hold Overview" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="ddlHoldOverview" runat="server" >
                                        </asp:DropDownList>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Hold Overview" ItemStyle-Width="5%" Visible="false" ItemStyle-HorizontalAlign="Center" >
                                    <ItemTemplate>
                                        <asp:Label ID="lblHoldOverview" Text='<%#(Eval("HoldOverview").ToString()) %>' runat="server" >
                                        </asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Remaks" ItemStyle-Width="10%" Visible="true" ItemStyle-HorizontalAlign="Center">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtRemarks" runat="server" Height="100px" Style="resize:none;text-align:center" TextMode="MultiLine"  Text='<%#(Eval("Remarks").ToString()) %>'/>
                                    </ItemTemplate>
                                </asp:TemplateField>
