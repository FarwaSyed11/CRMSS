...
public partial class Marketing_MTAccound : System.Web.UI.Page
{
	...
	public void BindCompany()
	{
		try
		{
			...
			DBH.CreateDatasetCRMEBSDATA(ds, "Sp_MTAccound", true, pa, pv);
	...
	public void BindSalesman()
	{
		try
		{
			...
			DBH.CreateDatasetCRMEBSDATA(ds, "Sp_MTAccound", true, pa, pv);
			ddlMarketingSearch.DataSource = ds.Tables[0];
            ddlMarketingSearch.DataTextField = "Name";
            ddlMarketingSearch.DataValueField = "EmployeeRowID";
            ddlMarketingSearch.DataBind();
			if(ds.Tables[0].Rows.Count>1)
                ddlMarketingSearch.Items.Insert(0, new ListItem("ALL", "-1"));
	...
	public void BindAccound()
	{
		try
		{
			...
			pa.Add("@MarketingId");
			pv.Add(ddlMarketingSearch.SelectedValue);

            pa.Add("@AccountName");
            pv.Add(txtAccnamesearch.Text.Trim());

            pa.Add("@UpdateStatus");
            pv.Add(ddlStatusSearch.SelectedValue);
	...
	protected void gdvSummaryDetails_RowCommand(object sender, GridViewCommandEventArgs e)
	{
		try
		{
...

			{
				...
				Int64 _masterAccountId=0 ;
				if(Arguments[1].ToString()!="")
					_masterAccountId = Convert.ToInt64(Arguments[1].ToString());
				...
				if (ds.Tables[0].Rows.Count > 0)
				{
                    ...
                    hfdMaster.Value = _masterAccountId.ToString();
	...
	protected void gdvSummaryDetails_RowUpdating(object sender, GridViewUpdateEventArgs e)
	{
        try
        {
            ...
            try
            {
                ...
                {
                    if (ddlCustomerStatus.SelectedValue == "BLACK_LIST")
                    {
                        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "none",
                     " <script>  toastr.warning('Please Update the Action Plan For the BLACK LIST CUSTOMER', 'Warning');</script>", false);
	...
	public void SetOpportunity()
	{
		...
		gdvRelated.Columns[7].HeaderText = "Value";
	}
	public void SetProject()
	{
		...
		gdvRelated.Columns[2].HeaderText = "Project Type";
		gdvRelated.Columns[3].HeaderText = "Client";
		gdvRelated.Columns[4].HeaderText = "Owner";
		gdvRelated.Columns[5].HeaderText = "City";
		gdvRelated.Columns[6].HeaderText = "Email";
		gdvRelated.Columns[7].HeaderText = "Status";
	}
	...
	public void BindStatus()
	{
		...
		ddlStatus.DataTextField = "ProjectStatus";
		ddlStatus.DataValueField = "ProjectStatus";
		ddlStatus.DataBind();
	...
	protected void gdvRelated_Sorting(object sender, GridViewSortEventArgs e)
	{
    ...
    protected void btnRelatedPRJ_Click(object sender, EventArgs e)
    {
        aRelated.Attributes["class"] = "";
        aContact.Attributes["class"] = "";
        aRelatedPRJ.Attributes["class"] = "active";
        aVisits.Attributes["class"] = "";
        //aProject.Attributes["class"] = "";
        btnRelated.ForeColor = System.Drawing.Color.Black;
        btnContact.ForeColor = System.Drawing.Color.Black;
        btnRelatedPRJ.ForeColor = System.Drawing.Color.White;
        btnVisits.ForeColor = System.Drawing.Color.Black;
        //btnProject.ForeColor = System.Drawing.Color.Black;
        ddlStatus.Visible = false;
        BindStatus();
