<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="LostOpportunity.aspx.cs" Inherits="Sales_LostOpportunity" %>
                                ...
                                <div class="pull-left" style="width: 33.33%">
                                    ...
                                    <asp:GridView ID="gdvSalesLost" runat="server" AutoGenerateColumns="False" CellSpacing="0" BorderWidth="0"
                                        ...
                                        <Columns>
                                             ...
                                             <asp:TemplateField HeaderText="Compitator" ItemStyle-Width="8%" Visible="True">
                                                <ItemTemplate>
                                ...
                                <HeaderStyle HorizontalAlign="Center" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Status" ItemStyle-Width="8%" Visible="true" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                             ...
                                             <asp:TemplateField HeaderText="Compitator" ItemStyle-Width="8%" Visible="true" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                             ...
                                             <asp:TemplateField HeaderText="Remarks" ItemStyle-Width="8%" Visible="true" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lbl3" Text='<%#(Eval("SalesmanNotes").ToString()) %>'
                                                        runat="server" />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Width="8%" />
                                            </asp:TemplateField>
