...
(function ($, window, document) {
    ...
    $.extend(Wickedpicker.prototype, {
        ...
        showPicker: function (element) {
            ...
            var currentTime = this.setcurrentTime(element);
            //this.setText(element);
            this.showHideMeridiemControl();
            if (this.getText(element) !== this.getTime()) {
                var inputTime = currentTime.replace(/:/g, '').split(' ');
                var newTime = {};
        ...
        hideTimepicker: function (element) {
            ...
            var pickerHidden = {
                start: function () {
                    ...
                    $('[aria-showingpicker="true"]').attr('aria-showingpicker', 'true');
        ...
        setcurrentTime: function (input) {
            return ""+(this.formatTime(this.selectedHour, this.selectedMin, this.selectedMeridiem, this.selectedSec));
        },
        /*
