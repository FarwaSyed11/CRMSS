 ...
 // With placeholder
    ...
    $("#alpaca-select-external").alpaca({
        "options": {
            ...
            "type": "select",
            "focus": false,
            "dataSource": "./../~/Theme/assets/pages/json-forms/json/icecream-list.json"
        }
    });
    // Multiselect
 ...
 // Select2 select
    ...
    // Using connector
        $("#alpaca-option-tree-connector").alpaca({
            "schemaSource": "./../~/Theme/assets/pages/json-forms/json/optiontree-custom-schema.json",
            "optionsSource": "./../~/Theme/assets/pages/json-forms/json/optiontree-custom-options.json"
        });
   ...
   // CKEditor
    ...
    i18next.use(window.i18nextXHRBackend).init({
        ...
        fallbackLng: !1,
        backend: {
            loadPath: "./../~/Theme/assets/locales/{{lng}}/{{ns}}.json"
        },
        returnObjects: !0
    }, 
    function(err, t) {
