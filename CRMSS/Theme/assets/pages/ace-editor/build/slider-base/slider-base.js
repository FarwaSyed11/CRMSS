...
Y.SliderBase = Y.extend( SliderBase, Y.Widget, {
     ...
     * <p><code>&quot;/<em>configured</em>/<em>yu</em>i/<em>builddi</em>r/slider-base/~/Theme/assets/skins/sam/thumb-x.png&quot;</code></p>
     * <p>And vertical thumbs will get</p>
     * <p><code>&quot;/<em>configured</em>/<em>yui</em>/<em>builddir</em>/slider-base/~/Theme/assets/skins/sam/thumb-y.png&quot;</code></p>
     *
    ...
    _initThumbUrl: function () {
        if (!this.get('thumbUrl')) {
            ...
            // <img src="/path/to/build/slider-base/~/Theme/assets/skins/sam/thumb-x.png">
            this.set('thumbUrl', base + 'slider-base/~/Theme/assets/skins/' +
