"use strict";
  /*articl ckeditor*/
    CKEDITOR.replace('editor1', {
        ...
        contentsCss: ['~/Theme/assets/pages/ckeditor/contents.css', '~/Theme/assets/pages/ckeditor/artical.css'],
    ...
    CKEDITOR.replace('editor2', {
        ...
        // An array of stylesheets to style the WYSIWYG area.
        // Note: it is recommended to keep your own styles in a separate file in order to make future updates painless.
        contentsCss: ['~/Theme/assets/pages/ckeditor/contents.css', '~/Theme/assets/pages/ckeditor/document.css'],
