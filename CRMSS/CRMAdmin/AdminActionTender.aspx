<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="AdminActionTender.aspx.cs" Inherits="CRMAdmin_AdminActionTender" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
       <div style="padding-left: 2%; padding-top: 1%;"><h4 style="text-shadow: 1px -1px 8px; color: #a92828;">TENDER PROJECT ADMIN ACTION</h4></div> 
      ...
      <tr style="text-align:center">
        ...
        <th style="width:10%">Consultant</th>
          <th style="width:5%">Owner</th> 
           <th style="max-width:5%">PlotNo</th>
            <th style="width:5%">MKT Overview</th> 
            <th style="width:10%">MKT Remarks</th> 
            <th style="width:5%">MKT Updated Date</th> 
            <th style="width:10%">Action Status</th> 
              <th style="width:5%">Action Date</th> 
            <th style="width:10%">CRM Remarks</th> 
                        ...
                        <div class="nav-align-top">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="navs-top-OPTList" role="tabpanel">
                                    ...
                                    <table class="table table-bordered table-striped Opp-List" style="width:100%;">
...
<%--    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.3.2/js/dataTables.buttons.min.js"></script>
 ...
 <%--     
    ...
    <script src="Script/AdminActionTender.js?V=0.6"></script>
