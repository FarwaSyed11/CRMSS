...
public partial class CRMAdmin_AdminActionTender : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        Session["ApplicationId"] = 1;
        Common.SaveAppUserActivityHistory("1", "/CRMAdmin/AdminActionTender.aspx", "Tender Admin Action", (Session["empno"] == null ? "null" : Session["empno"].ToString()), 0);
    }
    [WebMethod]
