<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="MasterAccount.aspx.cs" Inherits="CRMAdmin_MasterAccount" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
   ...
   <script src="../CRMAdmin/Script/MasterAccount.js?v=0.5"></script>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
        <ContentTemplate>
                ...
                <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="pnlheading">
                        <div class="card-header pnlheading">
                            <h3>
                                <asp:Label ID="Label13" ForeColor="White" Font-Bold="true" runat="server" Text="MASTER ACCOUNT"></asp:Label>
                    ...
                    <div class="card-block">
                         <div class="row">
                              ...
                              <div class="pull-right" style="padding-top: 5px;">
                              <asp:DropDownList ID="ddlVerify" runat="server" CssClass="form-control textBox1" ForeColor="Black">
                                  <asp:ListItem Value="-1">All</asp:ListItem>
                                  <asp:ListItem Value="1">Verified</asp:ListItem>
                                  <asp:ListItem Value="0">Nor Verified</asp:ListItem>
                              </asp:DropDownList>
                             </div>
                        ...
                        <div class="row" style="padding-left: 8px;padding-top: 10px;">
                          <%--  <div class="col-1" style="width: 20%;border-style: groove;" id="dvdAdvancedSearch" runat="server" visible="false">
                               ...
                               <div style="width: 100%;" id="dvdResult" runat="server"> 
                        ...
                        <div id="dvupdate" runat="server" style="overflow-y: auto; height: calc(100vh - 225px); overflow-x: hidden">
                            <asp:GridView ID="gdvSummaryDetails" runat="server" AutoGenerateColumns="False"
                                OnRowCommand="gdvSummaryDetails_RowCommand" OnRowEditing="gdvSummaryDetails_RowEditing" OnRowUpdating="gdvSummaryDetails_RowUpdating"
                                CellSpacing="0" BorderWidth="0" AllowSorting="True" EmptyDataText="No Data Found" OnRowDataBound="gdvSummaryDetails_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Account Number" ItemStyle-Width="5%" Visible="True" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="ID">
                                        <ItemTemplate>
                                            <asp:Label ID="lblAccountNumber" Text='<%#(Eval("ID").ToString()) %>'
                                                runat="server" />
                                            <asp:HiddenField ID="hfdAccountID" Value='<%#(Eval("ID").ToString()) %>'
                                                runat="server" />
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Account Name" ItemStyle-Width="15%" Visible="True" SortExpression="Name">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtName" runat="server" Text='<%# Eval("Name") %>' CssClass="textBox1 form-control"
                                                Font-Size="14px" />
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="HQ Country" ItemStyle-Width="12%" Visible="true" ItemStyle-HorizontalAlign="Center" SortExpression="HQCountry">
                                        <ItemTemplate>
                                            <asp:Label ID="lblHQCountry" Text='<%#(Eval("HQCountry").ToString()) %>' 
                                                runat="server" />
                                        </ItemTemplate>
                                      
                                          <EditItemTemplate>
                                           <asp:DropDownList ID="ddlHQCountryGrid" runat="server"  CssClass="textBox1 form-control"  AutoPostBack="true" OnSelectedIndexChanged="ddlHQCountryGrid_SelectedIndexChanged"
                                                Font-Size="14px" />
                                        </EditItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="HQ City" ItemStyle-Width="10%" Visible="True" ItemStyle-HorizontalAlign="Center" SortExpression="HQCity">
                                        <ItemTemplate>
                                            <asp:Label ID="lblHQCity" Text='<%#(Eval("HQCity").ToString()) %>' runat="server" />
                                        </ItemTemplate>
                                      
                                          <EditItemTemplate>
                                           <asp:DropDownList ID="ddlHQCity" runat="server" CssClass="textBox1 form-control"
                                                Font-Size="14px" />
                                        </EditItemTemplate>
                                    </asp:TemplateField>


                                    <%-- <asp:TemplateField HeaderText="Company" ItemStyle-Width="10%" Visible="true" ItemStyle-HorizontalAlign="Center" SortExpression="Register">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Register" ItemStyle-Width="10%" Visible="false" ItemStyle-HorizontalAlign="Center" SortExpression="Register">
                                        <ItemTemplate>
                                            <asp:Label ID="lblRegister" Text='<%#(Eval("Register").ToString()) %>'
                                                runat="server" />
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Email" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center" SortExpression="Email">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox ID="txtemail" runat="server" Text='<%# Eval("email") %>' CssClass="textBox1 form-control "
                                                Font-Size="14px" />
                                        </EditItemTemplate>
                                      ...
                                      <asp:TemplateField HeaderText="Phone" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center" SortExpression="phone">
                                        <ItemTemplate>
                                           ...
                                           <EditItemTemplate>
                                            <asp:TextBox ID="txtphone" runat="server" Text='<%# Eval("phone") %>' CssClass="textBox1 form-control "
                                                Font-Size="14px" />
                                        </EditItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="5%" />
                                    </asp:TemplateField>
                                      <asp:TemplateField HeaderText="URL" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center" SortExpression="url">
                                        <ItemTemplate>
                                          ...
                                          <EditItemTemplate>
                                            <asp:TextBox ID="txturl" runat="server" Text='<%# Eval("url") %>' CssClass="textBox1 form-control "
                                                Font-Size="14px" />
                                        </EditItemTemplate>
                                        <ItemStyle HorizontalAlign="Center" Width="5%" />
                                    </asp:TemplateField>
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lblEdit" runat="server" Text='' CssClass="btn rounded-pill btn-icon btn-round"
                                                CommandName="Edit" Style="text-align: center"><i class="fa fa-pencil-square-o" title="Edit"></i></asp:LinkButton>
                                        </ItemTemplate>
                                               <EditItemTemplate>
                                   ...
                                   <asp:TemplateField HeaderText="Media Info">
                                        <HeaderStyle Font-Size="Small" Width="4%" HorizontalAlign="Center" />
                                        <ItemStyle Font-Size="Small" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnMediaInfo" runat="server" Style="text-align: center" CommandName="Media" CssClass="btn rounded-pill btn-icon btn-round"
                                                CommandArgument='<%#(Eval("ID").ToString())%>'><i class="fa fa-newspaper-o" title="Media Information"></i></asp:LinkButton>

                                        </ItemTemplate>
                                    </asp:TemplateField>
                                      <asp:TemplateField HeaderText="Major Info">
                                        <HeaderStyle Font-Size="Small" Width="4%" HorizontalAlign="Center" />
                                        <ItemStyle Font-Size="Small" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnMajorInfo" runat="server" Style="text-align: center" CommandName="Major" CssClass="btn rounded-pill btn-icon btn-round"
                                                CommandArgument='<%#(Eval("ID").ToString())%>'><i class="fa  fa-info-circle" title="Major Information"></i></asp:LinkButton>
                                      ...
                                      <asp:TemplateField HeaderText="View">
                                        ...
                                        <ItemStyle Font-Size="Small" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnViewDetails" runat="server" Style="text-align: center" CommandName="View" CssClass="btn rounded-pill btn-icon btn-round"
                                                CommandArgument='<%#(Eval("ID").ToString())%>'><i class="fa  fa-eye" title="View Data"></i></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                ...
                <div style="border-radius: 50px !important; background-color: #ffffff !important; padding-left: 7px; padding-top: 7px; float: left; padding-right: 7px; width: 40%; padding-bottom: 7px; position: fixed; z-index: 100001; left: 30%; top: 64.5px; border: solid; border-color: silver; padding-bottom: 20px">
                    ...
                    <div class="modal-header panl14" style="font-family: system-ui;">
                        ...
                        <div class="pull-left">
                            ...
                            <h4>
                                <asp:Label ID="Label5" class="subpnlhdg" runat="server" Text="NEW MASTER ACCOUNT "></asp:Label>
            ...
            <asp:Panel ID="pnlMediaInfo" runat="server" CssClass="modalPopup" align="center" Style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 50px !important; display: none; font-family: 'Times New Roman'; font-size: medium" BorderStyle="Solid" BorderWidth="1px">
					...
					<div class="popupmaxheight">
						<table class="table table-condensed" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
                                    <asp:Label ID="Label2" runat="server" Text="Medi Name"></asp:Label>
                                </td>
                                ...
                                <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
                                    <asp:Label ID="Label3" runat="server" Text="Media Reference"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 15%" class="no-border">
                                ...
                                <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
                                <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
                                    <asp:Label ID="Label4" runat="server" Text="Media URL"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 15%" class="no-border">
                                ...
                                <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
                                <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
                                    <asp:Label ID="Label6" runat="server" Text="More Info"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 15%" class="no-border">
                              ...
                              <tr>
                                <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
                                    <asp:Label ID="Label40" runat="server" Text="Attatcment Comment"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 15%" class="no-border">
               ...
               <cc1:ModalPopupExtender ID="mpMajorInfo" runat="server" PopupControlID="pnlMajorInfo" TargetControlID="btnMajorInfoClose"
                Enabled="true" CancelControlID="btnMajorInfoClose" DropShadow="true" BehaviorID="ModalPopupExtenderBehavior24" RepositionMode="RepositionOnWindowResizeAndScroll"
                BackgroundCssClass="modalBackground">
            </cc1:ModalPopupExtender>
                ...
                <div style="border-radius: 50px !important; background-color: #ffffff !important; padding-left: 7px; padding-top: 7px; float: left; padding-right: 7px; width: 80%; padding-bottom: 7px; position: fixed; z-index: 100001; left: 10%; top: 64.5px; border: solid; border-color: silver; padding-bottom: 20px">
                    ...
                    <div class="modal-header panl14" style="font-family: system-ui;">
                        ...
                        <div class="pull-left">
                            ...
                            <h4>
                                <asp:Label ID="Label1" class="subpnlhdg" runat="server" Text="Major information"></asp:Label>
                        ...
                        <div class="pull-right">
                             <button type="button" class="btn btn-close"  aria-label="Close" runat="server" id="btnMajorInfoClose"/>
                         <%--   <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../Icons/deleteData.png" Style="padding-top: 10%;" /></td>--%>
                      </div>
					...
					<div class="popupmaxheight">
						<table class="table table-condensed" style="width: 100%">
                            ...
                            <tr>
                                   <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
                                    <asp:Label ID="Label11" runat="server" Text="Info Type"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 15%" class="no-border">
                                ...
                                <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
                                    <asp:Label ID="Label7" runat="server" Text="Source of Info"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 15%" class="no-border">
                                       <asp:DropDownList ID="ddlSourceOfInfoNew" runat="server" CssClass="textBox1 form-control " Font-Bold="True" >
                                         <asp:ListItem  Text="-" Value="-" ></asp:ListItem>
                                ...
                                <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
                                <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
                                    <asp:Label ID="Label8" runat="server" Text="Source Name"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 15%" class="no-border">
                                ...
                                <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
                                <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
                                    <asp:Label ID="Label10" runat="server" Text="More Info"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 15%" class="no-border">
                ...
                <asp:Panel ID="pnlDetailView" runat="server" Visible="false">
                    ...
                    <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                        ...
                        <div class="card-header pnlheading">
                            <div class="pull-left" >
                            <h3>
                                <asp:Label ID="Label9" ForeColor="White" Font-Bold="true" runat="server" Text="MASTER ACCOUNT"></asp:Label>
                         ...
                         <div class="card-block">
                            <asp:Panel ID="Panel2" runat="server" CssClass="pnlsubheading">
                                 ...
                                 <div class="pull-left">
                                     <h5>
                                         <asp:Label ID="Label12" class="panel-heading" Style="color: white;" runat="server" Text="Account Details"></asp:Label></h5>
                                 </div>
                             ...
                             <table class="table table-condensed" style="width: 100%;background-color:#e7e7e7;">
                                 ...
                                 <tr>
                                     ...
                                     <td style="padding: 3px 5px; width: 8%" class="no-border">
                                         <asp:TextBox ID="txtAccounNameEdit" CssClass="textBox1 form-control" Enabled="false" runat="server" />
                                         <asp:HiddenField ID="hfdMasterAccountIdEdit" runat="server" />
                                     </td>
                                     ...
                                     <td style="padding: 3px 5px; width: 8%" class="no-border">
                                         <asp:TextBox ID="txtPhoneEdit" runat="server" CssClass="textBox1 form-control" Enabled="false" Font-Bold="True"></asp:TextBox>
                                     </td>
                                     <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
                                     <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
                                         <asp:Label ID="Label16" runat="server" Text="Mail"></asp:Label>
                                     </td>
                                     <td style="padding: 3px 5px; width: 8%" class="no-border">
                                         <asp:TextBox ID="txtMailEdit" runat="server" CssClass="textBox1 form-control" Enabled="false" Font-Bold="True"></asp:TextBox>
                                     </td>
                                     <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
                                     <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
                                         <asp:Label ID="Label17" runat="server" Text="URL"></asp:Label>
                                     </td>
                                     <td style="padding: 3px 5px; width: 8%" class="no-border">
                                         <asp:TextBox ID="txtURLEdit" runat="server" CssClass="textBox1 form-control" Enabled="false" Font-Bold="True"></asp:TextBox>
                                     </td>
                                 ...
                                 <tr>
                                     ...
                                     <td style="padding: 3px 5px; width: 8%" class="no-border">
                                         <asp:TextBox ID="txtCountryEdit" runat="server" CssClass="textBox1 form-control " Enabled="false" Font-Bold="True"></asp:TextBox>
                                     </td>
                                     <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
                                     ...
                                     <td style="padding: 3px 5px; width: 8%" class="no-border">
                                         <asp:TextBox ID="txtCityEdit" runat="server" CssClass="textBox1 form-control" Enabled="false" Font-Bold="True"></asp:TextBox>
                                     </td>
                           ...
                           <asp:Panel ID="Panel10" runat="server" CssClass="pnlsubheading">
                                 <div class="pull-left">
                                     <h5>
                                         <asp:Label ID="Label46" class="panel-heading" Style="color: white;" runat="server" Text="Account Details"></asp:Label></h5>
                                 </div>
                                <div class="pull-right" style="margin-top: -9px;margin-right: 10px;">
                                      <asp:LinkButton ID="lblAddAccounts" runat="server" Style="text-align: center" CssClass="btn rounded-pill btn-icon btn-round" OnClick="lblAddAccounts_Click"
                                                ><i class="fa fa-plus" aria-hidden="true" title="Add An Account"></i></asp:LinkButton>   
                                 </div>
                                
                             </asp:Panel>
                             
                            <%-- Account details --%>
                       <div id="Div3" runat="server" style="overflow-x: auto">
                                 <asp:GridView ID="gdvAccountDetails" runat="server" AutoGenerateColumns="False"
                                     AllowSorting="True" EmptyDataText="No Data Found" AllowPaging="false" 
                                    OnRowCommand="gdvAccountDetails_RowCommand"
                                     class="table-striped table-bordered nowrap" ForeColor="#333333" CellPadding="4" GridLines="None">
                                     <FooterStyle CssClass="GridFooter" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                                     <RowStyle CssClass="GridItem" BackColor="#E3EAEB" />
                                     <HeaderStyle HorizontalAlign="Center" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                     <Columns>
                                           ...
                                           <asp:TemplateField HeaderText="Account Number" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center">
                                             <ItemTemplate>
                                                     <asp:LinkButton  ID="lblAccountNumber" Text='<%#(Eval("CRMAccountId").ToString()) %>' CommandName="view" CommandArgument='<%#(Eval("AccountNoLink").ToString()) %>'
                                                     runat="server" />
                                             </ItemTemplate>
                                         </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Account Name" ItemStyle-Width="15%" Visible="True" ItemStyle-HorizontalAlign="Center">
                                             <ItemTemplate>
                                          ...
                                          <asp:TemplateField HeaderText="Company" ItemStyle-Width="15%" Visible="True" ItemStyle-HorizontalAlign="Center">
                                             <ItemTemplate>
                                                 <asp:Label ID="iblCompany" Text='<%#(Eval("Company").ToString()) %>'
                                                     runat="server" />
                                             </ItemTemplate>
                                         </asp:TemplateField>

                                          <asp:TemplateField HeaderText="Country" ItemStyle-Width="15%" Visible="True" ItemStyle-HorizontalAlign="Center">
                                             <ItemTemplate>
                                                 <asp:Label ID="lblCountry1" Text='<%#(Eval("Country").ToString()) %>'
                                                     runat="server" />
                                             </ItemTemplate>
                                         </asp:TemplateField>

                                          <asp:TemplateField HeaderText="City" ItemStyle-Width="15%" Visible="True" ItemStyle-HorizontalAlign="Center">
                                             <ItemTemplate>
                                                 <asp:Label ID="lblCity1" Text='<%#(Eval("City").ToString()) %>'
                                                     runat="server" />
                                             </ItemTemplate>
                                         </asp:TemplateField>
                                   
                                       
                                         <asp:TemplateField HeaderText="Owner" ItemStyle-Width="10%" Visible="true" ItemStyle-HorizontalAlign="Center">
                                             <ItemTemplate>
                                                 <asp:Label ID="lblOwner" Text='<%#(Eval("OwnerName").ToString()) %>' runat="server" />
                                             </ItemTemplate>
                                         </asp:TemplateField>
                                          <asp:TemplateField HeaderText="Primary Category" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center">
                                             <ItemTemplate>
                                                   <asp:Label ID="lblPrimaryCategory" Text='<%#(Eval("PrimaryCategory").ToString()) %>' runat="server" />
                                             </ItemTemplate>
                                         </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Sub Category" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center">
                                             <ItemTemplate>
            ...
            <cc1:ModalPopupExtender ID="mpAddAccount" runat="server" PopupControlID="pnlAddNewAccount" TargetControlID="btnNewAccountClose"
                Enabled="true" CancelControlID="btnNewAccountClose" DropShadow="true" BehaviorID="ModalPopupExtenderBehavior25" RepositionMode="RepositionOnWindowResizeAndScroll"
                BackgroundCssClass="modalBackground">
            </cc1:ModalPopupExtender>

            <asp:Panel ID="pnlAddNewAccount" runat="server" CssClass="modalPopup" align="center" Style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 50px !important; display: none; font-family: 'Times New Roman'; font-size: medium" BorderStyle="Solid" BorderWidth="1px">
                ...
                <div style="border-radius: 50px !important; background-color: #ffffff !important; padding-left: 7px; padding-top: 7px; float: left; padding-right: 7px; width: 80%; padding-bottom: 7px; position: fixed; z-index: 100001; left: 10%; top: 64.5px; border: solid; border-color: silver; padding-bottom: 20px">
                    ...
                    <div class="modal-header panl14" style="font-family: system-ui;">
                        ...
                        <div class="pull-left">
                            ...
                            <h4>
                                <asp:Label ID="Label20" class="subpnlhdg" runat="server" Text="NEW ACCOUNT "></asp:Label>
                                 <asp:HiddenField ID="hfdNewAccount" runat="server" ></asp:HiddenField>
                            </h4>
                        ...
                        <div class="pull-right">
                             <button type="button" class="btn btn-close"  aria-label="Close" runat="server" id="btnNewAccountClose"/>
                         <%--   <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../Icons/deleteData.png" Style="padding-top: 10%;" /></td>--%>
                        </div>
					...
					<div class="popupmaxheight">
                        <table class="table table-condensed" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                                    <asp:Label ID="Label21" runat="server" Text="Name"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:TextBox ID="txtAccountName" CssClass="textBox1 form-control " runat="server" />
                                </td>
                                <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
                                <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                            ...
                            <tr>
                                ...
                                <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
                                <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                                    <asp:Label ID="Label33" runat="server" Text="Sub Category "></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                            ...
                            <tr>
                                ...
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:TextBox ID="txtAccountPhone" runat="server" CssClass="textBox1 form-control" Font-Bold="True"></asp:TextBox>
                                </td>
                                <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
                                <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                                    <asp:Label ID="Label23" runat="server" Text="Mail"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:TextBox ID="txtAccountMail" runat="server" CssClass="textBox1 form-control" Font-Bold="True"></asp:TextBox>
                                </td>
                            </tr>

                            <tr>
                                <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                                    <asp:Label ID="Label28" runat="server" Text="URL"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:TextBox ID="txtAccountURL" runat="server" CssClass="textBox1 form-control" Font-Bold="True"></asp:TextBox>
                                </td>
                                <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
                                <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                                ...
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:TextBox ID="txtAccountAddress" runat="server" CssClass="textBox1 form-control" Font-Bold="True" TextMode="MultiLine" Style="resize: none" Height="36px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                                ...
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:DropDownList ID="ddlAccountCountry" runat="server" CssClass="textBox1 form-control " Font-Bold="True" OnSelectedIndexChanged="ddlAccountCountry_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                </td>
                                <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
                                ...
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:DropDownList ID="ddlAccountCity" runat="server" CssClass="textBox1 form-control " Font-Bold="True"></asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                                ...
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:DropDownList ID="ddlAccountSourceofInfo" runat="server" CssClass="textBox1 form-control " Font-Bold="True" OnSelectedIndexChanged="ddlAccountSourceofInfo_SelectedIndexChanged" AutoPostBack="true">
                                        <asp:ListItem Text="-" Value="-"></asp:ListItem>
                                        <asp:ListItem Text="Media" Value="Media"></asp:ListItem>
                                        <asp:ListItem Text="Sales" Value="Sales"></asp:ListItem>
                                        <asp:ListItem Text="Marketing" Value="Marketing"></asp:ListItem>
                                ...
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:TextBox ID="txtAccountSourceName" runat="server" CssClass="textBox1 form-control " Font-Bold="True"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                                ...
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:TextBox ID="txtMajorMoreInfoAccount" runat="server" CssClass="textBox1 form-control " Font-Bold="True"></asp:TextBox>
                                </td>
                                
                              
                            </tr>
                            <asp:Panel ID="pnlMediaInfoAccount" runat="server">
                                 <tr>
                                <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                                    <asp:Label ID="Label60" runat="server" Text="Media Name"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:TextBox ID="txtMediaNameAccount" runat="server" CssClass="textBox1 form-control " Font-Bold="True"></asp:TextBox>
                                </td>
                                       <td style="padding: 3px 5px; width: 1%" class="no-border"></td>
                                     <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                                    <asp:Label ID="Label61" runat="server" Text="Media Reference"></asp:Label>
                                     ...
                                     <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:TextBox ID="txtMediaRefAccount" runat="server" CssClass="textBox1 form-control " Font-Bold="True" ></asp:TextBox>
                                </td>
                            </tr>
                                 <tr>
                                <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                                ...
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:TextBox ID="txtMediaURLAccount" runat="server" CssClass="textBox1 form-control " Font-Bold="True" ></asp:TextBox>
                                </td>
                                       <td style="padding: 3px 5px; width: 1%" class="no-border"></td>
                                     <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                                    <asp:Label ID="Label63" runat="server" Text="Media More Info"></asp:Label>
                                     ...
                                     <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:TextBox ID="txtMediMoreInfoAccount" runat="server" CssClass="textBox1 form-control " Font-Bold="True"></asp:TextBox>
                                </td>
                            </tr>
                                 <tr>
                                <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                                    <asp:Label ID="Label38" runat="server" Text="Logo URL"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:TextBox ID="txtAccountLogoURL" runat="server" CssClass="textBox1 form-control " Font-Bold="True" ></asp:TextBox>
                                </td>
                                       <td style="padding: 3px 5px; width: 1%" class="no-border"></td>
                                     <td style="padding: 3px 5px; width: 4%" class="label-alignment no-border">
                                    <asp:Label ID="Label39" runat="server" Text="Location URL"></asp:Label>
                                </td>
                                     <td style="padding: 3px 5px; width: 8%" class="no-border">
                                    <asp:TextBox ID="txtLocationURL" runat="server" CssClass="textBox1 form-control " Font-Bold="True"></asp:TextBox>
                                </td>
                            </tr>
                            </asp:Panel>
						...
						<div style="padding-top: 20px;">
							<asp:LinkButton ID="lbAccountSave" runat="server" Style="text-align: center" CssClass="btn rounded-pill btn-icon btn-round" OnClick="lbAccountSave_Click"><i class="fa fa-floppy-o" aria-hidden="true" title="Save"></i></asp:LinkButton>
						</div>
					</div>
                ...
                <div style="border-radius: 50px !important; background-color: #ffffff !important; padding-left: 7px; padding-top: 7px; float: left; padding-right: 7px; width: 70%; padding-bottom: 7px; position: fixed; z-index: 100001; left: 15%; top: 64.5px; border: solid; border-color: silver; padding-bottom: 20px">
                    ...
                    <div class="modal-header panl14" style="font-family: system-ui;">
                        ...
                        <div class="pull-left">
                            ...
                            <h4>
                                <asp:Label ID="Label36" class="subpnlhdg" runat="server" Text="Search"></asp:Label>
                            </h4>
                    ...
                    <table class="table table-condensed" style="padding-top: 10px;">
                        ...
                        <tr>
                            <td style="padding: 3px 5px; width: 10%;padding-top:10px" class="label-alignment no-border">
                                <asp:Label ID="Label37" runat="server" Text="Search By Name"></asp:Label>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="text-align: center;">
                    ...
                    <div>
                      ...
                      Do You Really Want To Verify All The Details Regarding of This Master Account
                </div>
                    ...
                    <%--                <li class="nav-item">
                                  ...
                                  <%--  <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                     ...
                                     <li class="nav-item">
                                        <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#tab-ACCMediaInfo" aria-controls="tab-ACCMediaInfo" aria-selected="false">Media Information</button>
                                    </li>
                                   <%-- <li class="nav-item">
...
<%--                                            <asp:LinkButton ID="btnAddAdminRemarks" runat="server" Style="text-align: center; float: right; margin-top: -3%;" CssClass="btn rounded-pill btn-icon btn-round" OnClick="btnAddAdminRemarks_Click"><i class="fa fa-plus" aria-hidden="true" title="Major Info"></i></asp:LinkButton>
                                    ...
                                    <div class="tab-pane fade" id="tab-ACCMediaInfo" role="tabpanel">

                                        <div class="" style="margin-top: 1%;">

                                       <%--    <asp:LinkButton ID="lbMedia" runat="server" Style="text-align: center; float: right; margin-top: -3%;" CssClass="btn rounded-pill btn-icon btn-round"><i class="fa fa-plus" title="Major Info"></i></asp:LinkButton>--%>
