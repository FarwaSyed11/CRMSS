<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="SalesCustomerPotantials.aspx.cs" Inherits="ExportReport_SalesCustomerPotantials" %>
   ...
   .tablepopup {
    ...
    <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
        <div style="padding-left: 2%; padding-top: 1%;">
            <h4 style="text-shadow: 1px -3px 8px; color: #a92828;">Sales Customer Potential</h4>
        </div>
                ...
                <table class="table table-bordered table-striped kpi-user-list-table">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th style="width: 16%; text-align: center; font-style: oblique; vertical-align: middle; display:none">Potential Tender</th>
    ...
    <script src="js/salescustomerpotentials.js"></script>
