<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="OptUpdateReportSalesman.aspx.cs" Inherits="ExportReport_OptUpdate_ReportSalesman" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
        <div style="padding-left: 2%; padding-top: 1%;">
            <h4 style="text-shadow: 1px -3px 8px; color: #a92828;">OPPORTUNITY UPDATES SALESMAN REPORT </h4>
        </div>
        ...
        <div class="card-body" style="margin-top: -2%;">
            ...
            <div class="" style="margin-top: 1%;">
                <table class="table table-bordered table-striped  optr-updates-salesman-table">

                    <thead>
                        <tr>
                            <th colspan="7" style="height: 70px; text-align: center; font-style: oblique; vertical-align: middle; font-size: xx-large;">OPPORTUNITY UPDATES SALESMAN</th>
                        </tr>
                    ...
                    <tbody class="tbody-optupdates-salesman">
                    </tbody>
                </table>
            </div>
   ...
   <%--<script src="js/opportunityupdates.js"></script>--%>
    ...
    <script src="js/optupdatesSalesman.js"></script>
