<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="QuotedSystemReport.aspx.cs" Inherits="ExportReport_QuotedSystemReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
        <div style="padding-left: 2%; padding-top: 1%;">
            <h4 style="text-shadow: 1px -3px 8px; color: #a92828;">Quoted System Report</h4>
        </div>
                ...
                <table class="table table-condensed tblfilter" style="border-bottom-width: 0px !important;" runat="server" id="tbltopsearch">
                    <tr>
                        ...
                        <td class="no-border" style="width: 5%">
                            ...
                            <input type="button" id="btnDownload" value="Download" class="btn btn-primary d-block" style="font-size: small" />
                        </td>
            ...
            <div class="" style="margin-top: 1%;">
                <table class="table table-bordered table-striped opportunity-details-table">
                    ...
                    <thead>
                        ...
                        <tr>
                            <th style="width: 7%; text-align: center; font-style: oblique; vertical-align: middle">OPT #</th>
                            <th style="width: 13%; text-align: center; font-style: oblique; vertical-align: middle">NAME</th>
                            <th style="width: 13%; text-align: center; font-style: oblique; vertical-align: middle">CUSTOMER NAME</th>
                            <th style="width: 9%; text-align: center; font-style: oblique; vertical-align: middle">SALESMAN</th>
                            <th style="width: 9%; text-align: center; font-style: oblique; vertical-align: middle">SALES ASSISTANT</th>
                            <th style="width: 7%; text-align: center; font-style: oblique; vertical-align: middle">STATUS</th>
                            <th style="width: 9%; text-align: center; font-style: oblique; vertical-align: middle">PRODUCT</th>
                            <th style="width: 9%; text-align: center; font-style: oblique; vertical-align: middle">QUOTATION DATE</th>
                            <th style="width: 9%; text-align: center; font-style: oblique; vertical-align: middle">QUOTATION NO</th>
                            <th style="width: 9%; text-align: center; font-style: oblique; vertical-align: middle">REVENUE AMOUNT</th>
                            <th style="width: 7%; text-align: center; font-style: oblique; vertical-align: middle">REVENUE STATUS</th>
                        </tr>
                    </thead>
   ...
   <script src="js/QuotedSystemReport.js"></script>
