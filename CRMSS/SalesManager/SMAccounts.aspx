<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="SMAccounts.aspx.cs" Inherits="SalesManager_SMAccound" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script src="../js/jquery-1.11.2.min.js"></script>
         <script src="../SalesManager/Scripts/SMAccounts.js?v=0.5"></script>
                ...
                <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                    ...
                    <div class="card-block">
                                ...
                                <label class="form-label">
                                    Update Status : 
                                                <asp:DropDownList ID="ddlStatusSearch" runat="server" ForeColor="Black" CssClass="textBox11 form-control">
                                                    <asp:ListItem Value="2" Text="NOT UPDATED"></asp:ListItem>
                        ...
                        <div id="dvupdate" runat="server" style="overflow-y: auto; height: calc(100vh - 270px);overflow-x:hidden">
                            <asp:GridView ID="gdvSummaryDetails" runat="server" AutoGenerateColumns="False" OnRowCommand="gdvSummaryDetails_RowCommand" OnRowUpdating="gdvSummaryDetails_RowUpdating"
                                OnRowDataBound="gdvSummaryDetails_RowDataBound"
                                 Style="overflow-x: scroll" OnSorting="gdvSummaryDetails_Sorting"  
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Update" Visible="true">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lbUpdate" runat="server" Text='' Visible="true" CommandArgument='<%#Eval("CRMAccountId").ToString() %>' CommandName="Update" Style="text-align: center" CssClass="btn rounded-pill btn-icon btn-round"><i class="fa fa-floppy-o" title="Save"></i></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <div class="row">
                                <asp:Button runat="server" ID="btnLoadMoreSummary" OnClick="btnLoadMoreSummary_Click" Width="100%" Text="Load More" Visible="false"></asp:Button>
                            </div>
                        </div>
                        </div>
                    </div>
