...
public partial class SalesManager_FinalPriced : System.Web.UI.Page
{
    ...
    public void BindCompany()
    {
        try
        {
            ...
            DBH.CreateDatasetCRMEBSDATA(ds, "sp_SMJOHUpdates", true, pa, pv);
    ...
    public void LoadOPTForUpdate()
    {
        try
        {
            ...
            DBH.CreateDatasetCRMEBSDATA(ds, "sp_SMFinalPricedUpdates", true, pa, pv);
    ...
    protected void gdvSummaryUpdates_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        try
        {
            if (ddlOverview.SelectedValue != "-1" && txtRemarks.Text != "" && Convert.ToDouble(txtWin.SelectedValue.Trim()) != 0)
            {
                ...
                CBH.CreateDatasetCRMEBSDATA(ds, "sp_SMJOHUpdates", true, pa, pv);
    ...
    protected void gdvSummaryUpdates_RowDataBound(object sender, GridViewRowEventArgs e)
    {
