<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="FinalPriced.aspx.cs" Inherits="SalesManager_FinalPriced" %>
                    ...
                    <div class="card-block">
                        ...
                        <div id="dvupdate" runat="server" style="overflow-y: auto; height: calc(100vh - 210px);overflow-x:hidden">
                            <asp:GridView ID="gdvSummaryUpdates" runat="server" AutoGenerateColumns="False"
                                OnPageIndexChanging="gdvSummaryUpdates_PageIndexChanging" OnSorting="gdvSummaryUpdates_Sorting"
                                OnRowCommand="gdvSummaryUpdates_RowCommand"  OnRowDataBound="gdvSummaryUpdates_RowDataBound"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Others">
                                        ...
                                        <ItemStyle Font-Size="Small" HorizontalAlign="Center" />
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnothers" runat="server" Style="text-align: center" CommandName="Others" CssClass="btn rounded-pill btn-icon btn-round" CommandArgument='<%#Eval("OpportunityNumber")%>'><i class="fa fa-info-circle" title="Others"></i></asp:LinkButton>
                        ...
                        <div class="modal fade" id="mpOthersoverview" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content" style="width: 260%; right: 400px">
