<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="SMLostOpportunity.aspx.cs" Inherits="SalesManager_SMLostOpportunity" %>
            ...
            <script type="text/javascript">
             ...
             <div class="GridviewDiv" id="pnlSummaryView" runat="server">
               ...
               <div id="dvupdate" runat="server" style="overflow-y: auto; height: calc(100vh - 274px);overflow-x:hidden">
                   <asp:GridView ID="gdvLost" runat="server" OnRowCommand="gdvLost_RowCommand"
                                AutoGenerateColumns="false" OnSorting="gdvLost_Sorting"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Lost Amount" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center" SortExpression="LostAmount">
                                        <ItemTemplate>
