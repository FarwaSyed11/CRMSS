<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="SMTender.aspx.cs" Inherits="SalesManager_Default" %>
        ...
        <ContentTemplate>
             ...
             <div class="GridviewDiv" id="pnlSummaryView" runat="server">
                 <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="pnlheading">
                        <div class="pnlheading">
                            <div class="pull-left">
                            <h3>
                                <asp:Label ID="Label13" ForeColor="White" Font-Bold="true" runat="server" Text="SALES MANAGER TENDER"></asp:Label>
               ...
               <div id="Div3" runat="server" style="overflow-y: auto; height: calc(100vh - 270px);overflow-x:hidden">
                   <asp:GridView ID="gdvtender" runat="server" OnSorting="gdvtender_Sorting"
