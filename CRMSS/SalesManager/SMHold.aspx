<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="SMHold.aspx.cs" Inherits="SalesManager_Default" %>
     ...
     <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
        <ContentTemplate>
            ...
            <div class="GridviewDiv" id="pnlSummaryView" runat="server">
                 <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="pnlheading">
                        <div class="pnlheading">
                             <div class="pull-left">
                            <h3>
                                <asp:Label ID="Label13" ForeColor="White" Font-Bold="true" runat="server" Text="SALES MANAGER HOLD"></asp:Label>
                          ...
                          <div class="row">
                            <div class="pull-right">
                                <label class="form-label">
                                    Company : 
                                                <asp:DropDownList ID="ddlholdcm" runat="server" ForeColor="Black" AutoPostBack="true" OnSelectedIndexChanged="ddlholdcm_SelectedIndexChanged" ></asp:DropDownList>
                                </label>
                            </div>
                            &nbsp;&nbsp;  &nbsp;&nbsp;
                               ...
                               <div class="pull-right">
                                   <label class="form-label">
                                       Salesman : 
                                                <asp:DropDownList ID="ddlholdsm" runat="server" ForeColor="Black" AutoPostBack="true" OnSelectedIndexChanged="ddlholdsm_SelectedIndexChanged"></asp:DropDownList>
                                   </label>
               ...
               <div id="Div3" runat="server" style="overflow-y: auto; height: calc(100vh - 270px);overflow-x:hidden">
                   <asp:GridView ID="gdvhold" runat="server"
                       AutoGenerateColumns="false"
                      
                                CellSpacing="0" BorderWidth="0" AllowSorting="True" EmptyDataText="No Data Found"
                                class="table-striped table-bordered nowrap" ForeColor="#333333" CellPadding="4" GridLines="None" OnSorting="gdvhold_Sorting">
