<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="SMWonOpportunity.aspx.cs" Inherits="SalesManager_SMWonOpportunity" %>
             ...
             <div class="GridviewDiv" id="pnlSummaryView" runat="server">
               ...
               <div id="dvupdate" runat="server" style="overflow-y: auto; height: calc(100vh - 274px);overflow-x:hidden">
                   <asp:GridView ID="gdvWon" runat="server"
                        ...
                        OnSorting="gdvWon_Sorting" OnRowCommand="gdvWon_RowCommand"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Marketing" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center" SortExpression="Marketing">
                                      ...
                                      <asp:TemplateField HeaderText="Amount" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center" SortExpression="Amount">
                                        <ItemTemplate>
                                            <asp:Label ID="lblAmount" Text='<%#(Eval("Amount").ToString()) %>'
                                                runat="server" />
                                        </ItemTemplate>
                               ...
                               <div class="row">
                                <div class="pull-left" style="width: 33.33%">
                                    ...
                                    <asp:GridView ID="gdvSalesupdate" runat="server" AutoGenerateColumns="False" CellSpacing="0" BorderWidth="0"
                                        AllowSorting="True" EmptyDataText="No Data Found.." AllowPaging="true" OnRowCommand="gdvSalesupdate_RowCommand" Font-Bold="false"
                                        class="table-striped table-bordered nowrap" ForeColor="#333333" CellPadding="4" GridLines="None">
                                        <FooterStyle CssClass="GridFooter" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                                        <RowStyle CssClass="GridItem" BackColor="#E3EAEB" />
                                        <HeaderStyle HorizontalAlign="Center" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                ...
                                <div class="pull-left" style="width: 33.33%">
                                    ...
                                    <asp:GridView ID="gdvSMupdates" runat="server" AutoGenerateColumns="False" CellSpacing="0" BorderWidth="0"
                                        AllowSorting="True" EmptyDataText="No Data Found.." AllowPaging="true" OnRowCommand="gdvSMupdates_RowCommand" Font-Bold="false"
                                       class="table-striped table-bordered nowrap" ForeColor="#333333" CellPadding="4" GridLines="None">
                                        <FooterStyle CssClass="GridFooter" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                                <RowStyle CssClass="GridItem" BackColor="#E3EAEB" />
                                <HeaderStyle HorizontalAlign="Center" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                ...
                                <div class="pull-left" style="width: 33.33%">
                                    ...
                                    <asp:GridView ID="gdvMarketingUpdate" runat="server" AutoGenerateColumns="False" CellSpacing="0" BorderWidth="0"
                                        AllowSorting="True" EmptyDataText="No Data Found.." AllowPaging="true" OnRowCommand="gdvMarketingUpdate_RowCommand" Font-Bold="false"
                                         class="table-striped table-bordered nowrap" ForeColor="#333333" CellPadding="4" GridLines="None">
                                        <FooterStyle CssClass="GridFooter" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                                <RowStyle CssClass="GridItem" BackColor="#E3EAEB" />
                                <HeaderStyle HorizontalAlign="Center" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" Font-Size="Small" />
