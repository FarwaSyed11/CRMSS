...
public partial class SSHR_HRAOutstandingReport : System.Web.UI.Page
{
    ...
    public static List<ExitPassList> GetHRAourstandingList(string StartDate, string EndDate)
    {
