...
public partial class SSHR_Services_DownloadSalaryAdvanceOutstanding : System.Web.UI.Page
{
    ...
    private void ExportSummary(DataTable dt)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=SalAdvanceOutStandingReport.xls");
