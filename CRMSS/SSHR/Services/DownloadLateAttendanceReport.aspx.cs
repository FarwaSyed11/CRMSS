...
public partial class SSHR_Services_DownloadLateAttendanceReport : System.Web.UI.Page
{
    ...
    private void ExportSummary(DataTable dt)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=LateAttendanceReport.xls");
