...
public partial class SSHR_Services_DownloadLeaveRequestReport : System.Web.UI.Page
{
    ...
    private void ExportSummary(DataTable dt)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=LeaverequestReport.xls");
