...
public partial class SSHR_Services_DownloadHRAOutstandingReport : System.Web.UI.Page
{
    ...
    private void ExportSummary(DataTable dt)
    {
        ...
        {
            if (i == 0)
                sb.Append("<th align='center'  style = 'background-color:  #a92828;height:50px;color: #ffffff;width:100px'>");
            else
        ...
        Response.AddHeader("content-disposition", "attachment;filename=HRAOutStandingReport.xls");
