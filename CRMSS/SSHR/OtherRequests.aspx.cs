...
public partial class SSHR_OtherRequests : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            if (!String.IsNullOrEmpty(Convert.ToString(Session["UserId"])))
            {
                ...
                Common.SaveAppUserActivityHistory("27", "/SSHR/OtherRequests.aspx", "Other Request", (Session["empno"] == null ? "null" : Session["empno"].ToString()), 0);
    ...
    public static List<tableData> GettableData(string UserID, string RequestType, string Status)
    {
        ...
        DBH.CreateDataset_SSHR(ds, "OtherRequestList", true, pa, pv);
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static string setRequestDetails(string LeaveApplicationID, string RefNo, string User, string EmpNo, string OnBehalf, string LeaveBal, string LeaveType, string LeaveReason, string StartDate, string EndDate, string LeaveReqDay
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static string setPPTRequestDetails(string ReqID, string Status, string StatusOrder, string RefNo, string User, string EmpNo, string OnBehalf, string Reason, string OtherReason, string TravellingDate, string EDOfReturn, string ReasonId)
    {
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static void setMiscRequestDetails(string ReqID, string RefNo, string User, string EmpNo, string OnBehalf, string ReqDate, string ReqType, string ReasonText, string ReasonDrop, string AddressToWhom, string OtherRemarks, string FromDate, string ToDate, string CountryToApplyVisa, string ReqTypeVal
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static void setCompanyLoanRequestDetails(string ReqID, string RefNo, string User, string EmpNo, string OnBehalf, string LoanType, string DedStartMonth, string Amount, string Reason, string MonthlyDeduction, string Status)
    {
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static void setLateAttendanceReqDetails(string ReqID, string RefNo, string User, string EmpNo, string OnBehalf, string Date, string ArrivedTime, string Reason, string Status)
    {
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static void setExitPassReqDetails(string ReqID, string RefNo, string User, string EmpNo, string OnBehalf, string Date, string ExitType, string OutTime, string BackTime, string Reason, string Status)
    {
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static String UpdateActionRequest(string ReqID, string ReqType, string WorkFLowID, string OrderNumber, string RoleID, string Action, string Comments, string UserID)
    {
