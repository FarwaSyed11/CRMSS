...
function LoadRequestData(loadername) {
    ...
    //$('.ajax-loader').show();
    $.ajax({
        url: "ManagerView.aspx/GettableData",
        ...
        success: function (result) {
            ...
            if (Type == 0) {
                ...
                htmlHead += `<tr style="text-align: center;">
                               <th class="table-cahnge" colspan="8" style="height: 50px;font-size: x-large;">LEAVE APPLICATION</th></tr>`
                ...
                htmlHead += ` <tr style="text-align: center;" class="Head-tr">
                                      <th class="table-cahnge" colspan="8" style="height: 50px;font-size: x-large;">PASSPORT RELEASE</th></tr>`
                ...
                htmlHead += ` <tr style="text-align: center;">
                               <th class="table-cahnge" colspan="6" style="height: 50px;font-size: x-large;">BANK RELATED REQUEST</th></tr>`
               ...
               <td style="text-align:center" ><a class="`+ item.StageClass + `">` + item.STATUS + `</a></td>
                ...
                htmlHead += ` <tr style="text-align: center;">
                               <th class="table-cahnge" colspan="7" style="height: 50px;font-size: x-large;">MISCELLANEOUS REQUEST</th></tr>`
                ...
                htmlHead += ` <tr style="text-align: center;">
                               <th class="table-cahnge" colspan="9" style="height: 50px;font-size: x-large;">COMPANY LOAN REQUEST</th></tr>`
                ...
                htmlHead += ` <tr style="text-align: center;">
                               <th class="table-cahnge" colspan="8" style="height: 50px;font-size: x-large;">LATE ATTENDANCE REQUEST</th></tr>`
                ...
                htmlHead += ` <tr style="text-align: center;">
                               <th class="table-cahnge" colspan="8" style="height: 50px;font-size: x-large;">EXIT PASS REQUEST</th></tr>`
            ...
            //all Request
                ...
                htmlHead += ` <tr style="text-align: center;">
                               <th class="table-cahnge" colspan="7" style="height: 50px;font-size: x-large;">ALL REQUESTS</th></tr>`
...
$('.tbody-emp-req').on('click', '.ibtn-LAReq-req-info', function () {
...
$('.tbody-emp-req').on('click', '.ibtn-CLR-req-info', function () {
...
function getAllCompanyLoanDetails() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetAllCompanyLoanDetails",
...
function getAllEPReqDetails() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetAllEPReqDetails",
        data: JSON.stringify({ 'ApplicationId': ApplicationId }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function getAllLAReqDetails() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetAllLAReqDetails",
        data: JSON.stringify({ 'ApplicationId': ApplicationId }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function getAllMiscRequestDetails() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetAllMiscReqDetails",
        data: JSON.stringify({ 'ApplicationId': ApplicationId }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function getAllBankDetails() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetAllBankDetails",
        data: JSON.stringify({ 'ApplicationId': ApplicationId }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
         ...
         <div class="row" style="margin-top: 14px;">
                     ...
                     <div class="row">
                        <div class="col-3">
                            <label for="html5-number-input" class="col-form-label label-custom">Request No.</label>
                            <div>
                                <input type="text" id="txtPPTReqNo" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            ...
                            <div>
                               <select id="ddlPPTReason" class="form-select color-dropdown textbox-border-color"></select>
                            </div>
                        </div>
                          ...
                          <div class="col-3 Other-Reason" style="display:none;">
                            ...
                            <div>
                               <select id="ddlPPTOtherReason" class="form-select color-dropdown textbox-border-color"></select>
                            </div>
                        </div>
                         ...
                         <div class="col-3">
                            ...
                            <div>
                                <input type="date" id="txtTravellingDate" name="nmReqDet" class="form-control textbox-border-color" />
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            ...
                            <div>
                                <input type="date" id="txtEptDOReturn" class="form-control textbox-border-color"/>
                            </div>
                        </div>
         ...
         <div id="Bank-details-rectangle-div" class="Bank-Det" style="margin-top: 14px;">
                     <div class="row">
                        <div class="col-2">
                            ...
                            <div>
                                <input type="text" id="txtBDBasic" name="nmBDBasicSalDet" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                        ...
                        <div class="col-2">
                            ...
                            <div>
                                <input type="text" id="txtBDHRA" name="nmBDBasicSalDet" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                          ...
                          <div class="col-2">
                            ...
                            <div>
                               <input type="text" id="txtBDCar" name="nmBDBasicSalDet" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                         ...
                         <div class="col-2">
                            ...
                            <div>
                                 <input type="text" id="txtBDPetrol" name="nmBDBasicSalDet" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                        ...
                        <div class="col-2">
                            ...
                            <div>
                                <input type="text" id="txtBDMobile" name="nmBDBasicSalDet" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                        ...
                        <div class="col-2">
                            ...
                            <div>
                                <input type="text" id="txtBDOther" name="nmBDBasicSalDet" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
         ...
         <div class="row" style="margin-top: 14px;">
                       ...
                       <div class="row">
                          ...
                          <div class="col-3">
                            <label for="html5-number-input" class="col-form-label label-custom">Request No.</label>
                            <div>
                                <input type="text" id="txtBDReqNo" name="nmBasicDet" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            ...
                            <div>
                                <input type="text" id="txtBDReqDate" name="nmBasicDet" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                          ...
                          <div class="col-3">
                            ...
                            <div>
                                <select id="ddlBDReqType" class="form-select color-dropdown textbox-border-color"></select>
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            <label for="html5-number-input" class="col-form-label label-custom">Reason</label>
                            <div>
                                <select id="ddlBDReason" class="form-select color-dropdown textbox-border-color"></select>
                            </div>
                        </div>
                      ...
                      <div class="row Salary-CF">
                       <div class="col-3">
                            ...
                            <div>
                                <input type="text" id="txtBDBank" name="nmSCB" class="form-control textbox-border-color"/>
                            </div>
                        </div>
                          ...
                          <div class="col-3">
                            ...
                            <div>
                                <input type="text" id="txtBDPurpose" name="nmSCB" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                       ...
                       <div class="col-3">
                            ...
                            <div>
                                <input type="text" id="txtBDBankName" name="nmSTL" class="form-control textbox-border-color" disabled/>
                            </div>
                        </div>
                         ...
                         <div class="col-3">
                            ...
                            <div>
                                <input type="text" id="txtBDIBANNo" name="nmSTL" class="form-control textbox-border-color" disabled  />
                            </div>
                        </div>
                          ...
                          <div class="col-3">
                            ...
                            <div>
                                <input type="text" id="txtBDBankAddress" name="nmSTL" class="form-control textbox-border-color"  />
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            ...
                            <div>
                                <input type="text" id="txtBDReqamount" name="nmSTL" class="form-control textbox-border-color"  />
                            </div>
                        </div>
         ...
         <div class="row" style="margin-top: 14px;">
                       ...
                       <div class="row">
                          ...
                          <div class="col-3">
                            <label for="html5-number-input" class="col-form-label label-custom">Request No.</label>
                            <div>
                                <input type="text" id="txMiscReqNo" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            <label for="html5-number-input" class="col-form-label label-custom">Request Date</label>
                            <div>
                                <input type="text" id="txtMiscReqDate" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                          ...
                          <div class="col-3">
                            <label for="html5-number-input" class="col-form-label label-custom">Request Type</label>
                            <div>
                                <select id="ddlMiscReqType" class="form-select color-dropdown textbox-border-color"></select>
                            </div>
                        </div>
                        ...
                        <div class="col-3 MiscReason-Area">
                            <label for="html5-number-input" class="col-form-label label-custom">Reason</label>
                            <div>
                                <input type="text" id="txtMiscReason" name="nmMiscControll" class="form-control textbox-border-color"/>
                            </div>
                        </div>
                        ...
                        <div class="col-3 OtherRemarks-Area" style="display:none;">
                            ...
                            <div>
                                <input type="text" id="txtMiscOtherRemarks" name="nmMiscControll" class="form-control textbox-border-color"/>
                            </div>
                        </div>
                      ...
                      <div class="row">
                       <div class="col-3 Misc_Address-ToWhom">
                            ...
                            <div>
                                <input type="text" id="txtMiscAddToWhom" name="nmMiscControll" class="form-control textbox-border-color"/>
                            </div>
                        </div>
                            ...
                            <label for="html5-number-input" class="col-form-label label-custom">Reason</label>
                            <div>
                                <select id="ddlMiscReason" class="form-select color-dropdown textbox-border-color"></select>
                            </div>
                        </div>
                       ...
                       <div class="col-3 Date-Period">
                            ...
                            <div>
                                <input type="date" id="txtMiscFromDate" class="form-control textbox-border-color" />
                            </div>
                        </div>
                         ...
                         <div class="col-3 Date-Period">
                            ...
                            <div>
                                <input type="date" id="txtMiscToDate" class="form-control textbox-border-color"   />
                            </div>
                        </div>
                          ...
                          <div class="col-3 Date-Period">
                            ...
                            <div>
                                <input type="text" id="txtCountryToApplyVisa" name="nmMiscControll" class="form-control textbox-border-color"  />
                            </div>
                        </div>
                        ...
                        <div class="col-3 Trans-Location">
                            ...
                            <div>
                                <select id="ddlMiscEmpType" class="form-select color-dropdown textbox-border-color">
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-3 Trans-Location">
                            ...
                            <div>
                                <input type="text" id="txtMiscCurrLocation" name="nmMiscControll" class="form-control textbox-border-color"  />
                            </div>
                        </div>
                         ...
                         <div class="col-3 Trans-Location">
                            ...
                            <div>
                                <input type="text" id="txtMiscReqLocation" name="nmMiscControll" class="form-control textbox-border-color"  />
                            </div>
                        </div>
                        ...
                        <div class="col-3 Trans-Type">
                            ...
                            <div>
                                <select id="ddlMiscTransType" class="form-select color-dropdown textbox-border-color">
                           ...
                           <div class="col-3 Date-Of-Change">
                            ...
                            <div>
                                <input type="date" id="txtMiscDateOfChange" name="nmMiscControll" class="form-control textbox-border-color"  />
                            </div>
                        </div>
                        ...
                        <div class="col-3 Diff-Date">
                            <label for="html5-number-input" class="col-form-label label-custom">From Date</label>
                            <div>
                                <input type="date" id="txtMiscFromDateTrans" class="form-control textbox-border-color"  />
                            </div>
                        </div>
                        ...
                        <div class="col-3 Diff-Date">
                            <label for="html5-number-input" class="col-form-label label-custom">To Date</label>
                            <div>
                                <input type="date" id="txtMiscToDateTrans" class="form-control textbox-border-color"  />
                            </div>
                        </div>
         ...
         <div class="row" style="margin-top: 14px;">
                       ...
                       <div class="row">
                          ...
                          <div class="col-3">
                            <label for="html5-number-input" class="col-form-label label-custom">Request No.</label>
                            <div>
                                <input type="text" id="txtCLoanReqNo" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            <label for="html5-number-input" class="col-form-label label-custom">Request Date</label>
                            <div>
                                <input type="text" id="txtCLoanReqDate" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                          ...
                          <div class="col-3">
                            ...
                            <div>
                                <select id="ddlBLLoanType" class="form-select color-dropdown textbox-border-color">
                        ...
                        <div class="col-3">
                            <label for="html5-number-input" class="col-form-label label-custom">Ded Start Month</label>
                            <div>
                                <input type="date" id="txtCLoanDedStartMonth" name="nmCLControll" class="form-control textbox-border-color"/>
                            </div>
                        </div>
                      ...
                      <div class="row">
                       <div class="col-3">
                            ...
                            <div>
                                <input type="text" id="txtCLoanAmount" name="nmCLControll" class="form-control textbox-border-color"/>
                            </div>
                        </div>
                          ...
                          <div class="col-3">
                            ...
                            <div>
                                <input type="text" id="txtCLoanMonthlyDed" name="nmCLControll" class="form-control textbox-border-color"/>
                            </div>
                        </div>
                         ...
                         <div class="col-3">
                            <label for="html5-number-input" class="col-form-label label-custom">Reason</label>
                            <div>
                                <input type="text" id="txtCLoanReason" name="nmCLControll" class="form-control textbox-border-color"/>
                            </div>
                        </div>
         ...
         <div class="row" style="margin-top: 14px;">
                       ...
                       <div class="row">
                          ...
                          <div class="col-3">
                            <label for="html5-number-input" class="col-form-label label-custom">Request No.</label>
                            <div>
                                <input type="text" id="txLAReqNo" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            ...
                            <div>
                                <input type="date" id="txtLAReqDate" class="form-control textbox-border-color"/>
                            </div>
                        </div>
                          ...
                          <div class="col-3">
                            ...
                            <div>
                                <input type="time" id="txtLAreqTime" class="form-control textbox-border-color"/>
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            ...
                            <div>
                                <input type="text" id="txtLAReqReason" class="form-control textbox-border-color"/>
                            </div>
                        </div>
         ...
         <div class="row" style="margin-top: 14px;">
                       ...
                       <div class="row">
                         ...
                         <div class="col-3">
                            <label for="html5-number-input" class="col-form-label label-custom">Request No.</label>
                            <div>
                                <input type="text" id="txtEXTPassNo" class="form-control textbox-border-color" disabled />
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            <label for="html5-number-input" class="col-form-label label-custom">Date</label>
                            <div>
                                <input type="date" id="txtEXTPassDate" class="form-control textbox-border-color" />
                            </div>
                        </div>
                          ...
                          <div class="col-3">
                            ...
                            <div>
                                <select id="ddlEXTPassType" class="form-select color-dropdown textbox-border-color">
                        ...
                        <div class="col-3">
                            ...
                            <div>
                                <input type="time" id="txtEXTPassOutTime" class="form-control textbox-border-color"/>
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            ...
                            <div>
                                <input type="time" id="txtEXTPassBackTime" class="form-control textbox-border-color"/>
                            </div>
                        </div>
                       ...
                       <div class="col-3">
                            ...
                            <div>
                                <input type="text" id="txtEXTPassReason" class="form-control textbox-border-color"/>
                            </div>
                        </div>
...
function GetBasicEmpDet() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetBasicDetails",
...
function loadLeaveType() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetAllLeaveType",
...
function loadLeaveReason() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetAllLeaveReason",
...
function loadApproverAuthorityPeople() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetApproverAuthorityPeople",
...
function loadAllEmployees(Emp) {
    $.ajax({
        url: "ManagerView.aspx/GetAllEmployees",
        data: JSON.stringify({ 'EmpNo': EmpNo }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function getAllDetails() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetAllDetails",
        data: JSON.stringify({ 'ApplicationId': ApplicationId }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function loadPPTReason() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetAllPPTReasons",
        //data: JSON.stringify({ 'data': objAddSurvey }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function loadPPTOtherReason() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetAllPPTOtherReasons",
...
function getAllPPTDetails() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetAllPPTDetails",
        data: JSON.stringify({ 'ApplicationId': ApplicationId }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function loadBDRequestType() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetBDRequestType",
        //data: JSON.stringify({ 'data': objAddSurvey }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function loadBDReason() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetBDREasons",
...
function GetBDBasicSalaryDet() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetBasicSalDet",
        data: JSON.stringify({ 'EmpNo': EmpNo }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function GetBDSTLDet() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetBDSTDet",
        data: JSON.stringify({ 'EmpNo': EmpNo }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function loadMiscRequestType() {
    ...
    $.ajax({
        url: "ManagerView.aspx/GetMiscRequestType",
        //data: JSON.stringify({ 'data': objAddSurvey }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
