...
function LoadRequestData(loadername) {
    ...
    //$('.ajax-loader').show();
    $.ajax({
        url: "MyTeamRequests.aspx/GettableData",
...
function getAllCompanyLoanDetails() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetAllCompanyLoanDetails",
        data: JSON.stringify({ 'ApplicationId': ApplicationId }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function getAllLAReqDetails() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetAllLAReqDetails",
        data: JSON.stringify({ 'ApplicationId': ApplicationId }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function getAllMiscRequestDetails() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetAllMiscReqDetails",
        data: JSON.stringify({ 'ApplicationId': ApplicationId }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function getAllBankDetails() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetAllBankDetails",
        data: JSON.stringify({ 'ApplicationId': ApplicationId }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
    ...
    if (Type == 0) {
        ...
        <div class="row">
            ...
            <div class="col-1">
                ...
                <div>
                    <input type="text" id="txtStartDate" name="nmReqDet" class="form-control"/>
                </div>
            </div>
                <div class="col-1">
            ...
            <div class="col-2 div-EndDate">
                ...
                <div>
                    <input type="text" id="txtEndDate"  class="form-control" disabled />
                </div>
            </div>
            <div class="col-2 div-Retwork">
                <label for="html5-number-input" class="col-form-label label-custom">Return to Work</label>
                <div class="">
                    <input type="text" id="txtReturnToWork" class="form-control" />
                </div>
            </div>
            <div class="col-2">
    ...
    if (Type == 3) {
        ...
        <div class="row">
            ...
            <div class="col-3 Date-Period">
                ...
                <div>
                    <input type="text" id="txtMiscFromDate" class="form-control" />
                </div>
            </div>
            ...
            <div class="col-3 Date-Period">
                ...
                <div>
                    <input type="text" id="txtMiscToDate" class="form-control"   />
                </div>
            </div>
            ...
            <div class="col-3 Date-Of-Change">
                ...
                <div>
                    <input type="text" id="txtMiscDateOfChange" name="nmMiscControll" class="form-control"  />
                </div>
            </div>
            ...
            <div class="col-3 Diff-Date">
                <label for="html5-number-input" class="col-form-label label-custom">From Date</label>
                <div>
                    <input type="text" id="txtMiscFromDateTrans" class="form-control"  />
                </div>
            </div>
            ...
            <div class="col-3 Diff-Date">
                <label for="html5-number-input" class="col-form-label label-custom">To Date</label>
                <div>
                    <input type="text" id="txtMiscToDateTrans" class="form-control"  />
                </div>
            </div>
    ...
    if (Type == 5) {
        ...
        <div class="row">
            ...
            <div class="col-3">
                ...
                <div>
                    <input type="text" id="txtLAReqDate" class="form-control"/>
                </div>
            </div>
    ...
    if (Type == 6) {
        ...
        <div class="row">
            <div class="col-3">
                <label for="html5-number-input" class="col-form-label label-custom">Date</label>
                <div>
                    <input type="text" id="txtEXTPassDate" class="form-control" />
                </div>
            </div>
    ...
    if (Type == 7) {
        ...
        <div class="row">
            ...
            <div class="col-3">
                ...
                <div>
                    <input type="text" id="dtLastEncashDate" class="form-control" disabled/>
                </div>
            </div>
            <div class="col-3">
...
function GetBasicEmpDet() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetBasicDetails",
        data: JSON.stringify({ 'EmpNo': EmpNo }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function GetRefNo() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetRefNo",
        /*    data: JSON.stringify({ 'EmpNo': EmpNo }),*/
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function loadLeaveType() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetAllLeaveType",
...
function loadLeaveReason() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetAllLeaveReason",
...
function loadApproverAuthorityPeople() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetApproverAuthorityPeople",
        ...
        success: function (result) {
            ...
            $.each(listApprAuthPeople, function (key, item) {
                ...
                htm += `<tr > 
                    <td> `+ item.STAGE + ` </td>
                    <td> `+ item.APPROVER + ` </td>
                    <td style="text-align:center;"> `+ datedayformat(item.ApprovedDate) + ` </td>
                    <td> `+ item.COMMENTS + ` </td>
...
//    $.ajax({
//        url: "MyTeamRequests.aspx/GetAllEmployees",
//        data: JSON.stringify({ 'EmpNo': EmpNo }),
//        type: "POST",
//        contentType: "application/json;charset=utf-8",
//        dataType: "json",
...
function GetAllDetails() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetAllDetails",
        data: JSON.stringify({ 'ApplicationId': ApplicationId }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function loadPPTReason() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetAllPPTReasons",
        //data: JSON.stringify({ 'data': objAddSurvey }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function GetPPTRefNo() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetPPTRefNo",
        /*    data: JSON.stringify({ 'EmpNo': EmpNo }),*/
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function loadPPTOtherReason() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetAllPPTOtherReasons",
...
function getAllPPTDetails() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetAllPPTDetails",
        data: JSON.stringify({ 'ApplicationId': ApplicationId }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
        ...
        success: function (result) {
            ...
            //document.getElementById("txtTravellingDate").valueAsDate = datedayformat(new Date(result.d[0].Travelling_Date.split(" ")[0]));
            //document.getElementById("txtEptDOReturn").valueAsDate = datedayformat(new Date(result.d[0].Expected_Date_Of_Return.split(" ")[0]));
...
function loadBDRequestType() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetBDRequestType",
        //data: JSON.stringify({ 'data': objAddSurvey }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function loadBDReason() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetBDREasons",
...
function GetBDRefNo() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetBDRefNo",
        /*    data: JSON.stringify({ 'EmpNo': EmpNo }),*/
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function GetMiscRefNo() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetMiscRefNo",
        /*    data: JSON.stringify({ 'EmpNo': EmpNo }),*/
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function GetBDBasicSalaryDet() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetBasicSalDet",
        data: JSON.stringify({ 'EmpNo': EmpNo }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function GetBDSTLDet() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetBDSTDet",
        data: JSON.stringify({ 'EmpNo': EmpNo }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function GetCLoanRefNo() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetCLoanRefNo",
        /*    data: JSON.stringify({ 'EmpNo': EmpNo }),*/
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function GetLAReqRefNo() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetLAReqRefNo",
        /*    data: JSON.stringify({ 'EmpNo': EmpNo }),*/
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
function GetEPReqRefNo() {
    ...
    $.ajax({
        url: "MyTeamRequests.aspx/GetEPReqRefNo",
        /*    data: JSON.stringify({ 'EmpNo': EmpNo }),*/
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
...
//    html2canvas(document.getElementById('empLeaveModal')).then(function (canvas) {
//        var imageData = canvas.toDataURL('image/png');

//        // Send screenshot data to server
//        $.ajax({
//            type: 'POST',
//            url: 'MyTeamRequest.aspx/SaveImage',
