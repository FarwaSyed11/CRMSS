<%@ Page Title="" Language="C#" MasterPageFile="~/EconnectNew.master" AutoEventWireup="true" CodeFile="SalaryAdvanceOutstanding.aspx.cs" Inherits="SSHR_SalaryAdvanceOutstanding" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

      <style>
      .Table-SalAdvanceReq th {
          text-align: center;
          color: white !important;
          background-color: #d54832;
      }

      .Table-SalAdvanceReq td {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="padding-left: 2%; padding-top: 1%;">
        <h4 style="text-shadow: 1px -1px 8px; color: #a92828;">Salary Advance Outstanding Report</h4>
    </div>
        ...
        <table class="table table-condensed tblfilter" style="border-bottom-width: 1px !important" runat="server" id="tbltopsearch">
            <tr>
                ...
                <td class="no-border" style="width: 15%">
                    <input type="date" class="form-control" id="txtstaDateSalAdvance" />
                </td>
                <td class="no-border  label-alignment" style="width: 10%">
                    <asp:Label ID="Label3" Text="To Date" runat="server" Font-Size="Medium" Font-Bold="true" />
                </td>
                <td class="no-border" style="width: 15%">
                    <input type="date" class="form-control" id="txtEndDateSalAdvance" />
                </td>
                ...
                <td class="no-border col-2 btn-reports">
                    <input type="button" id="DownloadbtnSalAdvance" value="Detailed Report" class="btn btn-primary d-block" style="font-size: small" />
                </td>
    ...
    <div class="" style="margin: 2%;">
        <table class="table Table-SalAdvanceReq" style="width: 100%!important;">
            ...
            <tbody class="tbody-SalAdvanceRequestList">
            </tbody>
        </table>
    </div>
    ...
    <script src="Scripts/salaryadvanereport.js"></script>
