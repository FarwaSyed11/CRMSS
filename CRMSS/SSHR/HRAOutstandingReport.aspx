<%@ Page Title="" Language="C#" MasterPageFile="~/EconnectNew.master" AutoEventWireup="true" CodeFile="HRAOutstandingReport.aspx.cs" Inherits="SSHR_HRAOutstandingReport" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">

     <style>
     .Table-HRA-Outstanding th {
         text-align: center;
         color: white !important;
         background-color: #d54832;
     }

     .Table-HRA-Outstanding td {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div style="padding-left: 2%; padding-top: 1%;">
        <h4 style="text-shadow: 1px -1px 8px; color: #a92828;">HRA Outstanding</h4>
    </div>
        ...
        <table class="table table-condensed tblfilter" style="border-bottom-width: 1px !important" runat="server" id="tbltopsearch">
            <tr>
                ...
                <td class="no-border" style="width: 15%">
                    <input type="date" class="form-control" id="txtstartHRAOutstanging" />
                </td>
                <td class="no-border  label-alignment" style="width: 10%">
                    <asp:Label ID="Label3" Text="To Date" runat="server" Font-Size="Medium" Font-Bold="true" />
                </td>
                <td class="no-border" style="width: 15%">
                    <input type="date" class="form-control" id="txtEndDateHRAOutstanding" />
                </td>
                ...
                <td class="no-border col-2 btn-reports">
                    <input type="button" id="btnHRAoutstandingRepo" value="Detailed Report" class="btn btn-primary d-block" style="font-size: small" />
                </td>
    ...
    <div class="" style="margin: 2%;">
        <table class="table Table-HRA-Outstanding" style="width: 100%!important;">
            ...
            <tbody class="tbody-HRAoutstanding">
            </tbody>
        </table>
    </div>
    ...
    <script src="Scripts/hraOutstanding.js"></script>
