<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="AuditList.aspx.cs" Inherits="AuditManagement_AuditList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
        <div class="row m-3">
            <div class="col-6">
                <div class="pull-left">
                    <h4 style="color: #a92828;">Audit List </h4>
                </div>
            </div>
            <div class="col-6">
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                    <button class="btn btn-primary me-md-2 d-block" id="btnaddauditgridlist" type="button"><i class="fa-regular fa-calendar-plus me-2 fa-lg"></i>Create New Audit</button>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="table">
                <table class="table table-hover audit-list">
                    <thead>
                        <tr style="">
                            <th scope="col" style="border-radius: 5px 0px 0px 0px;text-align:center">Code</th>
                            <th scope="col">Audit Department</th>
                            <th scope="col">Audit Owner</th>
                            <th scope="col">Auditee Owner</th>
                            <th scope="col">Priority</th>
                            <th scope="col" style="text-align:center">Status</th>
                            <th scope="col" style="text-align:center">Duration</th>
                            <th scope="col">Expected Start Date</th>
                            <th>Expected End Date</th>
                            <th scope="col" style="border-radius: 0px 5px 0px 0px;text-align:center">Actions</th>
                        </tr>
                    </thead>
                    <tbody class="audit-list-tbody">
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary btnAddAuditList">Create</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="nav-align-top p-2">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show active" id="navs-top-AuditArea" role="tabpanel">
                            <%--1--%>
                            <div>
                                <a href="#" class="btn btn-primary pull-right btn-add-audit-area mb-3"><i class="fa fa-plus me-2" aria-hidden="true"></i>Create Audit Area</a>
                            </div>
                        ...
                        <div class="tab-pane fade" id="navs-top-RiskManagement" role="tabpanel">
                            <%--Nav 3 Risk--%>
                            <div>
                                <a href="#" class="btn btn-primary pull-right btn-add-risk-grid mb-3"><i class="fa fa-plus mr-2" aria-hidden="true"></i>Add Risk</a>
                            </div>
                        ...
                        <div class="tab-pane fade" id="navs-top-Observations" role="tabpanel">
                            <%--Nav 2 Observation--%>
                            <div>
                                <a href="#" class="btn btn-primary pull-right btn-add-obs-grid mb-3"><i class="fa fa-plus mr-2" aria-hidden="true"></i>Create Observation</a>
                            </div>
             ...
             <div class="modal-content">
                 ...
                 <div class="modal-body proj-popup">
                     ...
                     <div class="row">
                         ...
                         <div class="col-6">
                            <label for="html5-number-input" class="col-form-label label-custom">Risk<span style="color: red;">*</span></label>
                             <div class="">
                        ...
                        <div class="col-5">
                            ...
                            <%--<div class="">
                                <input type="text" id="txtObsOwner" placeholder="Enter observation owner name" class="form-control" />
                            </div>--%>
                        </div>
                         <div class="col-3">
                            <label class="col-form-label label-custom" for="basic-default-name">Status</label>
                        ...
                        <div class="col-12">
                          ...
                          <div class="col-4">
                             <label for="html5-number-input" class="col-form-label label-custom">Consequence A<span style="color: red;">*</span></label>
                             <div class="">
                                 <select id="ddlObsConsA" class="form-select color-dropdown">
                                    <option value="None" selected>Select Consequence A</option>
                                    <option value="Low">Low</option>
                        ...
                        <div class="col-4">
                             <label for="html5-number-input" class="col-form-label label-custom">Consequence B<span style="color: red;">*</span></label>
                             <div class="">
                                  <select id="ddlObsConsB" class="form-select color-dropdown">
                                    <option value="None" selected>Select Consequence B</option>
                                    <option value="Low">Low</option>
                                    <option value="Possible">Possible</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <div class="col-4">
                             <label for="html5-number-input" class="col-form-label label-custom">Consequence AxB<span style="color: red;">*</span></label>
                             <div class="">
                                  <select id="ddlObsConsAxB" class="form-select color-dropdown">
                                    <option value="None" selected>Select Consequence AxB</option>
                                    <option value="Low">Low</option>
                                    <option value="Possible">Possible</option>
                                    <option value="Moderate">Moderate</option>
                                    <option value="High">High</option>
                        ...
                        <div class="col-6">
                            <label for="html5-number-input" class="col-form-label label-custom">Action Plan<span style="color: red;">*</span></label>
                            <div class="">
                                <textarea type="text" id="taObsPlan" class="form-control" rows="4" placeholder="Type action plan here..."></textarea>
                            </div>
                        </div>
                        <div class="col-6">
    ...
    <script src="Scripts/audit-calendar.js"></script>
    <script src="Scripts/risk-control.js"></script>
    <script src="Scripts/audit-list.js"></script>
