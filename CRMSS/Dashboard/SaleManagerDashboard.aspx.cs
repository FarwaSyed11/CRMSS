...
public partial class Dashboard_SaleManagerDashboard : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(Convert.ToString(Session["UserId"])))
        {
            ...
            Common.SaveAppUserActivityHistory(Session["ApplicationId"].ToString(), "/Dashboard/SaleManagerDashboard.aspx", "Sales Manager Dashboard.", Session["empno"].ToString(), 0);
        }
        else
        {
    ...
    public static List<CompanyDDL> LoadCompanyDropdown(string userId)
    {
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "sp_DashboardSaleManager", true, pa, pv);
    ...
    public static List<WonAndLostGrap> GetWonLostgraph(string compId, string manId, string salesmanId, string userId, string year, string userStatus, string Oper)
    {
        ...
        pa.Add("@SalesmanId");
        pv.Add(salesmanId == "" ? "-1" : salesmanId);
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "SoValueMonthWiseForSaleManagerDashBoard", true, pa, pv);
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static List<WonAndLossPerc> GetWonPerc(string compId,  string userId, string year, string userStatus, string manId = "-1", string salesmanId = "-1")
    {
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static List<WonAndLossPerc> GetSalesCalForGC1(string compId,  string userId, string year, string userStatus, string manId = "-1", string salesmanId = "-1")
    {
        ...
        pa.Add("@SalesmanId");
        pv.Add(Convert.ToInt64(salesmanId == "" ? "-1" : salesmanId));
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "sp_YTDSOForSaleManagerDashboard", true, pa, pv);
        List<WonAndLossPerc> WonAndLossPe = new List<WonAndLossPerc>();
        dt = ds.Tables[0];
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static List<WonAndLossPerc> GetSalesCalForGC2(string compId, string userId, string year, string userStatus, string manId="-1", string salesmanId="-1")
    {
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "YTDInvoiceForSalemanagerDashboard", true, pa, pv);
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static List<WonAndLossPerc> GetSalesCalForGC3(string compId,  string userId, string year, string userStatus, string manId = "-1", string salesmanId = "-1")
    {
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "sp_YTDCOLLECTIONForSaleManagerDashboard", true, pa, pv);
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static List<WonAndLossPerc> GetSalesCalForGC4(string compId, string userId, string year, string userStatus, string manId = "-1", string salesmanId = "-1")
    {
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "sp_SalesmanJOHTagetForSaleManagerDashboard", true, pa, pv);
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static List<WonAndLossPerc> GetSalesCalForGC5(string compId, string userId, string year, string userStatus, string manId = "-1", string salesmanId = "-1")
    {
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "sp_QuotingOtherSystemPercForSaleManagerDashboard", true, pa, pv);
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static List<WonAndLossPerc> GetSalesCalForGC6(string compId, string userId, string year, string userStatus, string manId="-1", string salesmanId="-1")
    {
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "sp_OverviewUpdatePercForSaleManagerDashboard", true, pa, pv);
    ...
    public static List<SalesForcasted> GetCurrentForcastedOpportunities(string compId, string manId, string salesmanId, string userId, string year, string userStatus)
    {
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "sp_ForecastedOptForSaleManagerDashboard", true, pa, pv);
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static List<Overview> GetOverview(string compId, string manId, string userId, string year, string userStatus, string salesmanId = "-1")
    {
    ...
    public static List<lostByValueOrCompititor> GetValForLostByCompitOrValue(string compId, string manId, string salesmanId, string userId, string year, string userStatus)
    {
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "sp_lostByProductForSaleManager", true, pa, pv);
