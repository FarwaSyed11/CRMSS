<%@ Page Title="" Language="C#" MasterPageFile="../EconnectNew.master" AutoEventWireup="true" CodeFile="Dashboard.aspx.cs" Inherits="Dashboard_Dashboard" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link href="assets/multiselect/example-styles.css" rel="stylesheet" />
    <%--<link href="assets/multiselect/demo-styles.css" rel="stylesheet" />--%>
    <style>
        .cardfilter {
            position: relative;
            display: flex;
    ...
    background-color: #c747471f !important;
    color: #ff6225;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
             ...
             <table class="table table-condensed tblfilter" style="border-bottom-width: 0px !important;" runat="server" id="tbltopsearch">
                      <tr>
                          ...
                          <td class="no-border" style="width: 12%">
                              ...
                              <select id="selectTypeOpt" class="form-select color-dropdown" style="z-index: 99;" multiple> </select>
                          </td>
                           ...
                           <div class="col-12 col-lg-12 order-1">
                               <div class="card" style="height: 100%;">
                                  <div class="row">
                                      ...
                                      <div class="col-md-1 colwidthfirst">
  <div class="wait-area-sign hidden">
  ...
  <div class="dot"></div>
                                          ...
                                          <div class="text-center rowfisthding">YTD-COLL </div>
                                       ...
                                       <div class="card">
                                           <div class="card-body">
                                             ...
                                             <span class="fw-semibold d-block mb-1">Value</span>
                                               <h5 class="card-title mb-2 final-price-value-card"><img src="assets/img/icons/unicons/line-loader.gif" style="width: 60%;" /></h5>
                                                   </div>
                                                   <div class="col-md-4">
                                                <span class="fw-semibold d-block mb-1">Count</span>
                                               <h5 class="card-title mb-2 final-price-value-card-count"><img src="assets/img/icons/unicons/line-loader.gif" style="width: 85px;" /></h5>
                                                   </div>
                                               </div>
                                   ...
                                   <div class="col-4 mb-2">
                                       <div class="card">
                                           <div class="card-body">
                                               ...
                                               <h5 class="card-title mb-2 no-joh-count"><img src="assets/img/icons/unicons/line-loader.gif" style="width: 45%;" /></h5>
                                               <%--<small class="text-success fw-semibold"><i class="bx bx-up-arrow-alt"></i>+28.14%</small>--%>
                                           </div>
                                       </div>
                                   </div>
                                           ...
                                           <div class="row row-bordered g-0">
                                               <div class="col-md-3">
                                                    <div class="card-body" style="padding-bottom: 60px;">
                                                       ...
                                                       <h6 class="card-title mb-2 no-of-finalized-count"><img src="assets/img/icons/unicons/line-loader.gif" style="width: 83%; margin-bottom: -34%;" /></h6>
                                                   </div>
                                               </div>  
...
<%--                                                       <canvas id="Finalization" style="width: 254px; height:159px; max-width: 600px;display: block;"></canvas>--%>
                                         ...
                                         <div class="row row-bordered g-0">
                                               <div class="col-md-3" >
                                                   <div class="card-body" style="padding-bottom: 52px";>
                                                    ...
                                                    <h6 class="card-title mb-2 pipeline-value-card"><img src="assets/img/icons/unicons/line-loader.gif" style="width: 83%; margin-bottom: -34%;" /></h6>
                                   ...
                                   <div class="card-body">
                                       <div class="d-flex justify-content-between align-items-center mb-3">
                                           <div class="d-flex flex-column align-items-center gap-1">
                                               <h2 class="mb-2 oview-joh-count" style="color: #c74747;"><img src="assets/img/icons/unicons/line-loader.gif" style="width: 39%; padding-right:13%;" /></h2>
                                               <span>#JOH</span>
                                           </div>
            ...
            <div class="nav-align-top card h-100 forecast-opp-tab" style="width:33.2%; background: #ffffff;">
                ...
                <div class="nav-align-top card h-100" style="width:32.2%; background: #ffffff; margin-left: .7%;">
                            <ul class="nav nav-pills mb-3" role="tablist" style="margin-top: 1%;">
                              <li class="nav-item">
                                <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-t50-opp" aria-controls="navs-t50-opp" aria-selected="true">Top 50 JOH</button>
                              </li>
                              <li class="nav-item">
                         ...
                         <div class="tab-content nav-scroll-custom" >
                             ...
                             <div class="tab-pane fade show active" id="navs-t50-opp" role="tabpanel">
                             ...
                             <%--  </div>--%>
                              ...
                              <div class="tab-pane fade" id="navs-t50-tender" role="tabpanel">
    ...
    <script src="../Dashboard/assets/js/dashboards-analytics.js"></script>
            ...
            <script src="Scripts/dashboard.js?v=2.8"></script>
