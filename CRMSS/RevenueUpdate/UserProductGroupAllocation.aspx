<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="UserProductGroupAllocation.aspx.cs" Inherits="CRMSupport_UserProductGroupAllocation" %>
      ...
      <asp:Panel ID="Panel2" runat="server" Visible="true" >
          ...
          <div id="Div5">
                 ...
                 <div class="card-header">
                      <div class="pull-left">
                          <h4>Product Group Allocation  </h4>
                      </div>
                  </div>
                   <div class="card-block">
                      <table class="table table-condensed ">
                          <tr>
                              ...
                              <td class="no-border" style="width: 20%">
                               ...
                               <td class="no-border label-alignment" style="width: 3%"></td>
                              <td class="no-border  label-alignment" style="width: 5%">
                                  <asp:Label ID="Label5" Text="Product Group" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Times New Roman" />
                              </td>
                              <td class="no-border" style="width: 20%">
                                  <asp:DropDownList ID="ddlProductGroup" runat="server" Font-Names="tahoma" CssClass="textBox11 form-control" />
                              </td>
                      ...
                      <div id="Div6" runat="server" style="height: 500px; overflow: scroll;width:100%" class="panel-body">
                          <asp:GridView ID="gdvProductGroupAllocation" runat="server" AutoGenerateColumns="False" DataSourceID="dsUserProductAllocation"
                              AllowSorting="True" EmptyDataText="No Data Found" OnRowCommand="gdvProductGroupAllocation_RowCommand"
                              ...
                              <Columns>
                                  ...
                                  <asp:TemplateField HeaderText="Product Group" ItemStyle-Width="17%" Visible="True">
                                      <ItemTemplate>
                                          <asp:Label ID="lblProductGroup" Text='<%#(Eval("ProductGroup").ToString()) %>'
                                              runat="server" />
                                      </ItemTemplate>
                                  </asp:TemplateField>
                          ...
                          <asp:SqlDataSource ID="dsUserProductAllocation" runat="server" ConnectionString="<%$ ConnectionStrings:CRMEBSDATACon %>" SelectCommand="sp_QuotationEntry" SelectCommandType="StoredProcedure">
                            <SelectParameters>
                                 <asp:Parameter DefaultValue="5" Name="Oper" Type="String" />
