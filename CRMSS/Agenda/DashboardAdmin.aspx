<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="DashboardAdmin.aspx.cs" Inherits="Agenda_DashboardAdmin" %>
                ...
                <table class="table table-condensed tblfilter" style="border-bottom-width: 0px !important;" runat="server" id="tbltopsearch">
                      ...
                      <%--     <td class="no-border  label-alignment" style="width: 3%">
                          ...
                          <td class="no-border" style="width: 12%">
                           ...
                           <td class="no-border  label-alignment" style="width: 2%; background-color:#5355a9;">
                            ...
                            <div class="">  <asp:Label ID="lblOrg" Text="Organization" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Times New Roman" />
                                <select id="DDLOrg" class="form-select color-dropdown">   </select> </div>
                          </td>

                            <td class=" " style="width: 7%">
                            <div class="">  <asp:Label ID="lblDepart" Text="Department" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Times New Roman" />
                                <select id="DDLDept" class="form-select color-dropdown">   </select> </div>
                          </td>

                            <td class=" " style="width: 7%">
                            <div class="">  <asp:Label ID="lblHOD" Text="HOD" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Times New Roman" />
                                <select id="DDLHod" class="form-select color-dropdown">   </select> </div>
                          </td>

                             <td class=" " style="width: 7%">
                            <div class="ddlLineManagerDiv">  <asp:Label ID="Label2" Text="Line Manager" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Times New Roman" />
                                <select id="DDLLineMan" class="form-select color-dropdown">   </select> </div>
                          </td>

                           <td class=" " style="width: 7%">
                              <asp:Label ID="Label1" Text="Employee" runat="server" Font-Size="Medium" Font-Bold="true" Font-Names="Times New Roman" />
                                <select id="DDLEmployees" class="form-select color-dropdown">   </select>
                          </td>
                          ...
                          <td class="no-border" style="width: 1%;">
                              <input type="button" id="btnSearchDashBoard" value="Search" class="btn btn-primary d-block" style="font-size:small; margin-top: 24%;"/> 
                          </td>
                      </tr>
                  </table>
