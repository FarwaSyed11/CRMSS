<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="DashboardManager.aspx.cs" Inherits="Agenda_DashboardManager" %>
                ...
                <table class="table table-condensed tblfilter" style="border-bottom-width: 0px !important;" runat="server" id="tbltopsearch">
                      ...
                      <%--     <td class="no-border  label-alignment" style="width: 3%">
                          ...
                          <td class="no-border" style="width: 5%;">
                              <input type="button" id="btnSearchDashBoard" value="Search" class="btn btn-primary d-block" style="font-size:small; margin-top: 10%;"/> 
                          </td>
                      </tr>
                  </table>
