<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="OPTVerification.aspx.cs" Inherits="CRMQuotation_OPTVerification" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
       <div style="padding-left: 2%; padding-top: 1%;"><h4 style="text-shadow: 1px -3px 8px; color: #a92828;">Opportunity Verification</h4></div> 
  ...
  <table class="table table-bordered table-striped kpi-user-list-table">
    ...
    <thead>
     <tr style="height:50px">
            <th class="hidden" style="width:14%;text-align:center;vertical-align:middle">OPTID</th>
             <th style="width:10%;text-align:center;vertical-align:middle">OPT Number</th>
            <th style="width:16%;text-align:center;vertical-align:middle">NAME</th>
            <th style="width:10%;text-align:center;vertical-align:middle">Customer Name</th>
              <th style="width:10%;text-align:center;vertical-align:middle">Owner</th>
               <th style="width:10%;text-align:center;vertical-align:middle">Assist. Owner</th>
                <th style="width:10%;text-align:center;vertical-align:middle">Country</th>
                 <th style="width:8%;text-align:center;vertical-align:middle">Inquiry Type</th>
   ...
   <!--- Updating OPT Number-->
        <div class="modal fade" id="mpUpdateOPTNumber" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="background: #19191973;">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                     <div class="modal-header">
                    <h5 class="modal-title" ">Enter the Existing OPT Number</h5>
                    <button
                        type="button"
                ...
                <div class="modal-body" style="text-align: center;">
                     <input class="form-control" type="text" value="" id="txtNEWOPTNumber" />
                        <input type="hidden" id="hfdOLDOPTNumber" />
                        <input type="hidden" id="hfdOPTID" />
                </div>
                <div class="modal-footer">
                    <div style="margin-right: 41%;">
                         <button id="btnOverwriteOPTNumber" type="button" class="btn btn-primary" data-bs-dismiss="modal">UPDATE </button>
                    </div>
                </div>
            </div>
        </div>
...
<%--    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.3.2/js/dataTables.buttons.min.js"></script>
 ...
 <%--     
    ...
    <script src="Script/OPTVerification.js?v=1"></script>
