...
public partial class CRMAdmin_QuotationReportNew : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (type == 1)
                ...
                DownloadGeneralQuotationNew(qtnHeaderID);
    ...
    public void DownloadGeneralQuotationNew(Int64 qtnHeaderID)
    {
        ReportDocument rptDoc = new ReportDocument();
        ...
        rptDoc.Load(Server.MapPath("~/Report/GeneralQuotationNew.rpt"));
