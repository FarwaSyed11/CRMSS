...
<body>
    <form id="form1" runat="server" enctype="multipart/form-data">
       ...
       <div style="padding-left: 2%;padding-right: 2%; padding-top: 1%;border-bottom: 1px solid #98a2af !important;"><h4 id="RequestHeader" style=" color: #a92828;float: left;"></h4>
           ...
           <%--     <object data="pdf/p1.pdf" type="application/pdf" style="width:900px;height:1200px;overflow:scroll">;
           If you are unable to view file, you can download from <a href = "pdf/p1.pdf">here</a>;
             or download <a target ="_blank" href ="http://get.adobe.com/reader/">Adobe PDF Reader</a> to view the file.";
            </object>--%>

                
                <iframe src="pdf/p1.pdf#toolbar=0&navpanes=0&scrollbar=0" title="PDF in an i-Frame" frameborder="0" scrolling="auto" style="width:700px;height:800px;"></iframe>

               <%--<iframe src="pdf/p1.pdf" class="pdfview" frameborder="0"></iframe>--%>
