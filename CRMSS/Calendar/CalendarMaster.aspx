<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="CalendarMaster.aspx.cs" Inherits="Calendar_CalendarMaster" %>
                                ...
                                <div class="sticky-top mb-3">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">CRM Activities</h4>
                                        </div>
                                       ...
                                       <div class="col-3 perform-act-on-div">
                                        ...
                                        <div class="">
                                            <select id="ddlActivityOn" class="form-select color-dropdown">
                                                ...
                                                <option value="Actual Visit">Actual Visit</option>
...
<div class="modal fade" id="partiReqNoComment" tabindex="-1" aria-hidden="true">
  ...
  <div class="modal-dialog modal-lg" role="document">
    ...
    <script src="Scripts/calendar-master.js?v=4.2"></script>
