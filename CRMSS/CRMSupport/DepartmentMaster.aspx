                ...
                <div id="Div1">
                    <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                        <div class="card-header">
                            <div class="pull-left">
                                <h4>
                                    <asp:Label ID="lblHeader" runat="server" Text="Organization Department Mapping"></asp:Label></h4>
                            </div>
                        </div>
                        <div class="card-block">
                            ...
                            <table class="table table-condensed" style="width: 70%; padding-top: 20px">
                                <tr>
                                    ...
                                    <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
                                        <asp:Label ID="Label1" runat="server" Text="Department" Font-Size="Small"> </asp:Label>
                                    </td>
