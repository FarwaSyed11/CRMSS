<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="frmSiteSurveyAdmin.aspx.cs" Inherits="CRMSupport_frmSiteSurveyAdmin" %>
        ...
        <ContentTemplate>
             ...
             <div class="GridviewDiv" id="pnlSummaryView" runat="server">
                 <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                            ...
                            <div class="pull-left">
                                <h3>
                                    <asp:Label ID="lblHeader" ForeColor="White" Font-Bold="true" runat="server" Text="SITE SURVEY SEARCH"></asp:Label></h3>
                            </div>
                                      </div>
                        </asp:Panel>
                    ...
                    <table class="table table-condensed" style="width:70%;padding-top:20px" >
                             <tr>
                              ...
                              <td style="padding: 3px 5px;" class="label-alignment no-border">User</td>
                                 ...
                                 <td style="padding: 3px 5px;" class="no-border" align="Center">
                                     <asp:LinkButton ID="btnRefresh" runat="server" Text="" OnClick="btnRefresh_Click" CssClass="btn rounded-pill btn-icon btn-round"  AccessKey="l">
                                         <i class="fa fa-search" title="Search Report"></i>
                                     </asp:LinkButton></td>
                               <td style="padding: 3px 5px;" class="no-border" align="Center">
                                     <asp:LinkButton ID="btnExport" runat="server" Text="" CssClass="btn rounded-pill btn-icon btn-round" OnClick="btnExport_Click">
                                         <i class="fa fa-file-excel-o" title="Export To Excel"></i>
                                     </asp:LinkButton>
                                 </td>
                             </tr>
                             <tr>
                            ...
                            <br />
                             <asp:Panel ID="pnlProjectList" runat="server" Visible="true"  GroupingText="Site Survey Details">
                                ...
                                <asp:GridView ID="gdvProjectNo" runat="server" AutoGenerateColumns="False" OnRowCommand="gdvProjectNo_RowCommand"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="SL No" ItemStyle-Width="5%" Visible="True" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Last Updated Date" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center">
                                         ...
                                         <asp:TemplateField HeaderText="CRM UPDATE STATUS" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center">

                                            <ItemTemplate>
                                                <asp:Label ID="lblCRMUPDATESTATUS" Text='<%#(Eval("CRMUPDATESTATUS").ToString()) %>'
                                                    runat="server" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="View" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lblView" Text='View'  CssClass="btn rounded-pill btn-icon btn-round" CommandArgument='<%#Eval("SurveyId")%>' CommandName="View" runat="server">
                              ...
                              <asp:Panel ID="pnllead" runat="server" Visible="false"  GroupingText="lead List" >
                          <div style="width:100%;overflow:scroll" runat="server">
                ...
                <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                    <div class="card-block">
                        ...
                        <div class="pull-left">
                            <h4>
                                <asp:Label ID="Label14" ForeColor="White" Font-Bold="true" runat="server" Text="Site Survey - Project Details"></asp:Label></h4>
                        </div>
                        <div class="pull-right"  style="margin-top: -9px;margin-right: 10px;">
                            <asp:LinkButton ID="btnUpdate" runat="server" Text="Update" CssClass="btn rounded-pill btn-icon btn-round" Font-Size="Small" AccessKey="a" TabIndex="15" Visible="true" OnClick="btnUpdate_Click" >
                                <i class="fa fa-save" aria-hidden="true" title="Update"></i>
                            </asp:LinkButton>
                        ...
                        <table class="table table-condensed" style="width: 100%">
                            <tr>
                                <td style="padding: 3px 5px; width: 3%" class="label-alignment no-border">
                                    <asp:Label ID="Label15" runat="server" Text="CRM Prject ID"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px; width: 8%" class="no-border">
                                      <div class="pull-left" style="width: 50%">
                                    <asp:TextBox ID="txtCrmProjectNumber" runat="server" CssClass="textBox1 form-control " Font-Bold="True" OnTextChanged="txtCrmProjectNumber_TextChanged" AutoPostBack="true"></asp:TextBox>
                                    <asp:HiddenField ID="hfdCRMProjectID" runat="server" />
                                          </div>
                                        <div class="pull-right">
                                        <asp:LinkButton ID="btnGetFromCrm" CssClass="btn rounded-pill btn-icon btn-round" runat="server" Text="Get" OnClick="btnGetFromCrm_Click">
                                            <i class="fa fa-check-square-o" aria-hidden="true" title="Get"></i>
                                        </asp:LinkButton>
                                    </div>
                                </td>
                                ...
                                <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
                                    <asp:Label ID="Label25" runat="server" Text="Project Name"></asp:Label>
                                </td>

                                <td style="padding: 3px 5px; width: 10%" class="no-border">
                                    <asp:TextBox ID="txtCRMProjectName" runat="server" CssClass="textBox1 form-control " Font-Bold="True" Enabled="False"></asp:TextBox>
                                </td>
                                 <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
                            ...
                            <tr>
                                ...
                                <td style="padding: 3px 5px;" class="no-border">
                                    <asp:TextBox ID="txtCurrentStatus" runat="server" CssClass="textBox1 form-control " Font-Bold="True" Enabled="False"></asp:TextBox>
                                ...
                                <td style="padding: 3px 5px;" class="no-border">
                                    <asp:TextBox ID="txtComments" runat="server" CssClass="textBox1 form-control " Font-Bold="True" Enabled="False"></asp:TextBox>
                                </td>
                                <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
                                  <td style="padding: 3px 5px;" class="label-alignment no-border">
                                    <asp:Label ID="Label11" runat="server" Text="Plot Number"></asp:Label>
                                </td>
                                <td style="padding: 3px 5px;" class="no-border">
                                    <asp:TextBox ID="txtProjectPlotNo" runat="server" CssClass="textBox1 form-control " Font-Bold="True" Enabled="False"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                 <td style="padding: 3px 5px;" class="label-alignment no-border" colspan="6">
                                       <asp:Label ID="lblProjectError" ForeColor="Red" runat="server" Text=""></asp:Label>
                                     </td>
                            </tr>
                        </table>
                    ...
                    <div class="panel-body">
                        <table class="table table-condensed" style="width: 100%">
                            ...
                            <tr>
                                ...
                                <td style="padding: 3px 5px;" class="no-border">
                                    <asp:TextBox ID="txtLeadCurrentStatus" runat="server" CssClass="textBox1 form-control " Font-Bold="True"></asp:TextBox>
