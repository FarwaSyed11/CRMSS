<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PTHistoryUpdated.aspx.cs" Inherits="CRMSupport_PTHistoryUpdated" %>
                        ...
                        <div class="card-block">
                            ...
                            <table class="table table-condensed" style="width:70%;padding-top:20px" >
                             <tr>
                              ...
                              <td style="padding: 3px 5px;" class="label-alignment no-border">Product Type</td>
                                 <td style="padding: 3px 5px;" class="no-border">
                                     <asp:DropDownList ID="ddlProductType" runat="server" CssClass="textBox1 form-control" Width="220px" AccessKey="u">
                                     </asp:DropDownList>
