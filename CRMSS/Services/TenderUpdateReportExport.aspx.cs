...
public partial class Services_TenderUpdateReportExport : System.Web.UI.Page
{
    ...
    private void ExportSummary(DataTable dt)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Tender update Summary Report.xls");
    ...
    private void ExportDetails(DataTable dt)
    {
        ...
        Response.Clear();
        Response.Buffer = true;
        Response.AddHeader("content-disposition", "attachment;filename=Tender Update Detailed Report With VL.xls");
        //Response.TransmitFile(Server.MapPath("~/DownloadedExcelReport/Employee Deatils.xls"));
        Response.Charset = "";
        Response.ContentType = "application/vnd.ms-excel";
        string style = @"<style> .textmode { } </style>";
