...
public partial class Services_ExportOPTupdateSalesAsst : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Int64 SalesAssistantId = Int64.Parse(Request.QueryString["SalesAssistantId"]);
        ...
        pv.Add(SalesAssistantId);





        DBH.CreateDatasetCRMEBSDATA(ds, "sp_EXportSalesAssitOPTUpdateSummary", true, pa, pv);
    ...
    private void ExportSummary(DataTable dt)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Sales Opportunity Updates Summary.xls");
