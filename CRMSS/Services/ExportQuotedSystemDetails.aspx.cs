...
public partial class Services_ExportQuotedSystemDetails : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "sp_ExportQuotedSystemReport", true, pa, pv);
    ...
    private void ExportSummary(DataTable dt)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=QUOTED SYSTEM.xls");
