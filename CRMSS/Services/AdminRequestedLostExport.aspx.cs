...
public partial class Services_Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        AdminRequestedLost(Company, Manager, Salesman, UserId);
    }
    public void AdminRequestedLost(string Company, Int64 Manager, Int64 Salesman,int UserId)
    {
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "sp_AdminRequestedLostExport", true, pa, pv);
