...
public partial class Services_SalesCustomerPotential : System.Web.UI.Page
{
    ...
    private void ExportDetails(DataTable dt)
    {
        ...
        for (int i = 0; i < dt.Columns.Count; i++)
        {
            if (i == 0)
                ...
                sb.Append("<th align='center'  style = 'background-color:  #4287f5;height:50px;color: #ffffff;width:150px'>");
            else if (i >= 11 && i <= 13)
                sb.Append("<th align='center'  style = 'background-color:  #6ea2f5;height:50px;color: #ffffff;width:150px'>");
            else if (i >= 14 && i <= 16)
                sb.Append("<th align='center'  style = 'background-color:  #16959c;height:50px;color: #ffffff;width:150px'>");
            else if (i >= 17 && i <= 19)
                sb.Append("<th align='center'  style = 'background-color:  #11e2ed;height:50px;color: #ffffff;width:150px'>");
            else
                sb.Append("<th align='center'  style = 'background-color:  #a92828;height:50px;color: #ffffff;width:150px'>");
