<%@ WebHandler Language="C#" Class="SalesCustomerPotential" %>
...
public class SalesCustomerPotential : IHttpHandler {

    public void ProcessRequest (HttpContext context) {

        HttpResponse r = context.Response;
        String Company = context.Request.QueryString["Company"];
        Int64 SalesmanId = -1;//int.Parse(context.Request.QueryString["SalesmanId"]);
        Int64 ManagerId = -1;//int.Parse(context.Request.QueryString["ManagerId"]);
        ...
        if (ds.Tables[0].Rows.Count > 0)
        {
            ...
            r.Clear();
            r.Buffer = true;
            r.AddHeader("content-disposition", "attachment;filename=Sales Customer Potential.xls");
