...
public partial class Services_CRMActivityReport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "sp_CRMActivityReport", true, pa, pv);
    ...
    private void ExportDetails(DataTable dt)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=CRM Activity Report.xls");
