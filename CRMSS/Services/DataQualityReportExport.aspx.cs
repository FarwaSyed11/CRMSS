...
public partial class Services_DataQualityReportExport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (oper == 0)
        {
            string Case = Convert.ToString(Request.QueryString["Case"]);
            string company = Convert.ToString(Request.QueryString["company"]);
            QLTProjectReport(Case, company);
        }
    }

    public void QLTProjectReport(string Case,string company)
    {
