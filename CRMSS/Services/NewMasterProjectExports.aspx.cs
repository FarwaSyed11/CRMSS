...
public partial class Services_NewMasterProjectExports : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string Company = Convert.ToString(Request.QueryString["Company"]);
        Int64 User = Int64.Parse(Request.QueryString["User"]);
        string UserCompany = Convert.ToString(Request.QueryString["UserCompany"]);
