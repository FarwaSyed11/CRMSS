<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="MarketingTenderUpdateSummary.aspx.cs" Inherits="CRMReports_MarketingTenderUpdateSummary" %>
                ...
                <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="pnlheading">
                        <div class="card-header pnlheading">
                            <h3>
                                <asp:Label ID="Label13" ForeColor="White" Font-Bold="true" runat="server" Text="Marketing Update  Report"></asp:Label>
                    ...
                    <div class="card-block">
                              ...
                              <div class="pull-left lablealighn">
                               ...
                               <div class="pull-right">
                                   <label class="form-label">
                                                ...
                                                <asp:DropDownList ID="ddlManager" CssClass="textBox11 form-control" runat="server" ForeColor="Black" AutoPostBack="true" OnSelectedIndexChanged="ddlManager_SelectedIndexChanged"></asp:DropDownList>
                              ...
                              <div class="pull-left lablealighn">
                               ...
                               <div class="pull-right">
                                   <label class="form-label">
                                                ...
                                                <asp:DropDownList ID="ddlMarketing" CssClass="textBox11 form-control" runat="server" ForeColor="Black" AutoPostBack="true" OnSelectedIndexChanged="ddlMarketing_SelectedIndexChanged" ></asp:DropDownList>
                        ...
                        <div id="dvupdate" runat="server" style="overflow-y:auto;height: calc(100vh - 220px);overflow-x:hidden">
                            <asp:GridView ID="gdvTenderSummaryReport" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Marketing" HeaderText="Marketing" SortExpression="Marketing" ItemStyle-Width="20%" />
                                    <asp:BoundField DataField="Total Projects" HeaderText="Total Projects" ReadOnly="True" SortExpression="Total Projects" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center"/>
                                    <asp:BoundField DataField="New Projects" HeaderText="New Projects" ReadOnly="True" SortExpression="New Projects" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center"/>
                                    <asp:BoundField DataField="Newly Updated" HeaderText="Newly Updated" ReadOnly="True" SortExpression="Newly Updated" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center"/>
                                    <asp:BoundField DataField="Not Updated New" HeaderText="Not Updated New" ReadOnly="True" SortExpression="Not Updated New" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center"/>
                                    ...
                                    <asp:BoundField DataField="Updated%" HeaderText="Updated %" ReadOnly="True" SortExpression="Updated%"  ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center"/>
                            ...
                            <asp:SqlDataSource ID="sqlTenderUpdate" runat="server" ConnectionString="<%$ ConnectionStrings:CRMEBSDATACon %>" SelectCommand="sp_MTenderUpdateSummary" SelectCommandType="StoredProcedure">
                                <SelectParameters>
                                   ...
                                   <asp:ControlParameter ControlID="ddlManager" PropertyName="SelectedValue" DefaultValue="0" Name="Manager" Type="Int64"></asp:ControlParameter>
                                    <asp:ControlParameter ControlID="ddlMarketing" PropertyName="SelectedValue" DefaultValue="0" Name="MarketingId" Type="Int64"></asp:ControlParameter>
                                </SelectParameters>
                            </asp:SqlDataSource>
