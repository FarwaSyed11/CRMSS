<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="MarketingJOHUpdate.aspx.cs" Inherits="CRMReports_MarketingJOHUpdate" %>
                ...
                <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="pnlheading">
                        <div class="card-header pnlheading">
                            <h3>
                                <asp:Label ID="Label13" ForeColor="White" Font-Bold="true" runat="server" Text="Marketing JOH Update Report"></asp:Label>
                    ...
                    <div class="card-block">
                        ...
                        <div id="dvupdate" runat="server" style="overflow-y:auto;height: calc(100vh - 220px);overflow-x:hidden">
                            <asp:GridView ID="gdvJOHUpdateReport" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                ...
                                class="table-striped table-bordered nowrap" ForeColor="#333333" CellPadding="4" GridLines="None" DataSourceID="sqlJOHUpdate">
                            ...
                            <asp:SqlDataSource ID="sqlJOHUpdate" runat="server" ConnectionString='<%$ ConnectionStrings:CRMEBSDATACon %>' SelectCommand="sp_MarketingJOHUpdateSummaryReport" SelectCommandType="StoredProcedure">
                               <SelectParameters>
