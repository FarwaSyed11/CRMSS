<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="JOHUpdateSales.aspx.cs" Inherits="CRMReports_JOHUpdateSales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <table class="table table-bordered table-striped kpi-user-list-table">
    ...
    <thead>
      <tr>
          <th colspan="7" style="height:70px;text-align:center;font-style:oblique;vertical-align:middle;font-size: xx-large;">SALES JOH UPDATE</th>
    </tr>
...
<%--    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.3.2/js/dataTables.buttons.min.js"></script>
 ...
 <%--     
    ...
    <script src="Scripts/JOHUpdateSales.js"></script>
