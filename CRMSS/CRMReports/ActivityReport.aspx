<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="ActivityReport.aspx.cs" Inherits="CRMReports_ActivityReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
       <div style="padding-left: 2%; padding-top: 1%;"><h4 style="text-shadow: 1px -3px 8px; color: #a92828;">Activity Report</h4></div> 
           ...
           <table class="table table-condensed tblfilter" style="border-bottom-width: 0px !important;" runat="server" id="tbltopsearch">
                      <tr>
                          ...
                          <td class="no-border" style="width: 8%">
                                  <asp:Label ID="Label1" Text="From" runat="server" Font-Size="Medium" Font-Bold="true"  />
                               <input type="text" id="txtFrom" placeholder="Select Date" style="background: white;" class="form-control flatpickr-input active" readonly="readonly">
                          </td>
                           <td class="no-border label-alignment" style="width: 1%"></td>
                     
                          <td class="no-border" style="width: 8%">
                                  <asp:Label ID="Label2" Text="To" runat="server" Font-Size="Medium" Font-Bold="true"  />
                               <input type="text" id="txtTO" placeholder="Select Date" style="background: white;" class="form-control flatpickr-input active" readonly="readonly">
                          </td>
                          ...
                          <td class="no-border" style="width: 5%">
                            ...
                            <td class="no-border" style="width: 5%">
                              ...
                              <input type="button" id="btnDownloadSummary" value="Download Summary" class="btn btn-primary" style="font-size:small;display:none" /> 
                          </td>
                           <td class="no-border" style="width: 5%">

                              <input type="button" id="btnDownloadDetail" value="Download Detailed" class="btn btn-primary " style="font-size:small;display:none" /> 
                          </td>
...
<%--    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.3.2/js/dataTables.buttons.min.js"></script>
 ...
 <%--     
    ...
    <script src="Scripts/ActivityReport.js"></script>
