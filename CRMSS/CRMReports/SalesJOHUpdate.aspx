<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="SalesJOHUpdate.aspx.cs" Inherits="CRMReports_SalesJOHUpdate" %>
                ...
                <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="pnlheading">
                        <div class="card-header pnlheading">
                            <h3>
                                <asp:Label ID="Label13" ForeColor="White" Font-Bold="true" runat="server" Text="Sales JOH Update Report"></asp:Label>
                              ...
                              <div class="pull-left lablealighn">
                               ...
                               <div class="pull-right">
                                   <label class="form-label">
                                                ...
                                                <asp:DropDownList ID="ddlSalesman" CssClass="textBox11 form-control" runat="server" ForeColor="Black" AutoPostBack="true" OnSelectedIndexChanged="ddlSalesman_SelectedIndexChanged"></asp:DropDownList>
                        ...
                        <div id="dvupdate" runat="server" style="overflow-y:auto;height: calc(100vh - 220px);overflow-x:hidden">
                            <asp:GridView ID="gdvJOHUpdateReport" runat="server" AutoGenerateColumns="False" BorderWidth="0px"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="Salesman" HeaderText="Salesman" SortExpression="Salesman" ItemStyle-Width="20%" />
                            ...
                            <asp:SqlDataSource ID="sqlTenderUpdate" runat="server" ConnectionString='<%$ ConnectionStrings:CRMEBSDATACon %>' SelectCommand="sp_SalesJOHUpdateSummary" SelectCommandType="StoredProcedure">
                                <SelectParameters>
                                    ...
                                    <asp:ControlParameter ControlID="ddlSalesManager" PropertyName="SelectedValue" DefaultValue="-1" Name="manager" Type="Decimal"></asp:ControlParameter>
                                  
                                    <asp:ControlParameter ControlID="ddlSalesman" PropertyName="SelectedValue" DefaultValue="-1" Name="salesman" Type="Decimal"></asp:ControlParameter>
                                </SelectParameters>
                            </asp:SqlDataSource>
