<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="JOHSummaryReport.aspx.cs" Inherits="CRMReports_JOHSummaryReport" %>
                ...
                <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="pnlheading">
                        <div class="card-header pnlheading">
                            <h3>
                                <asp:Label ID="Label13" ForeColor="White" Font-Bold="true" runat="server" Text="NOT QUOTED SYSTEM"></asp:Label>
                              ...
                              <div class="pull-left lablealighn">
                               ...
                               <div class="pull-right">
                                   <label class="form-label">
                                                ...
                                                <asp:DropDownList ID="ddlSalesman" CssClass="textBox11 form-control" runat="server" ForeColor="Black" AutoPostBack="true" OnSelectedIndexChanged="ddlSalesman_SelectedIndexChanged1"></asp:DropDownList>
