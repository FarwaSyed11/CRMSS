...
function LoadCompanyDDL() {
    debugger;
    $.ajax({
        url: "SalesPerfomance.aspx/GetCompanyDDL",
...
function LoadSalesmanager() {
    debugger;
    $.ajax({
        url: "SalesPerfomance.aspx/GetSalesmanager",
...
function LoadSalesman() {
    debugger;
    $.ajax({
        url: "SalesPerfomance.aspx/GetSalesman",
...
function LoadSalesPerfomance(loadername) {
    ...
    //$('.ajax-loader').show();
    $.ajax({
        url: "SalesPerfomance.aspx/GettableData",
 ...
 <td style="text-align:right">`+ item.LOIVALUE + `</td>      
