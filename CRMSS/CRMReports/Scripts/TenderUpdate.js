...
function LoadCompanyDDL() {
    debugger;
    $.ajax({
        url: "TenderUpdateWithVL.aspx/GetCompanyDDL",
...
function LoadManager() {
    debugger;
    $.ajax({
        url: "TenderUpdateWithVL.aspx/Getmanager",
...
function LoadMarketing() {
    debugger;
    $.ajax({
        url: "TenderUpdateWithVL.aspx/GetMarkting",
...
$('#btnSearch').on('click', function () {
    ...
    setTimeout(function () {
        LoadTenderUpdateSummary('Please wait...');
...
$('#btnDownloadDetail').on('click', function () {
    ...
    window.open('../Services/TenderUpdateReportExport.aspx?Company=' + company + '&Manager=' + manager + '&marketing=' + marketing + '&oper=' + 1)

});
$('#btnDownloadSummary').on('click', function () {

    window.open('../Services/TenderUpdateReportExport.aspx?Company=' + company + '&Manager=' + manager + '&marketing=' + marketing + '&oper=' + 0)
...
function LoadTenderUpdateSummary(loadername) {
    //$('.kpi-loader-name').html(loadername);
    //$('.ajax-loader').show();
    $.ajax({
        url: "TenderUpdateWithVL.aspx/GettableData",
        data: JSON.stringify({ "UserID": currUserId, "Company": company, "Manager": manager, "marketing": marketing }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
