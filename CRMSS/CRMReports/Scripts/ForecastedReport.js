...
function LoadCompanyDDL() {
    debugger;
    $.ajax({
        url: "ForecastedReport.aspx/GetCompanyDDL",
...
function LoadSalesmanager() {
    debugger;
    $.ajax({
        url: "ForecastedReport.aspx/GetSalesmanager",
...
function LoadSalesman() {
    debugger;
    $.ajax({
        url: "ForecastedReport.aspx/GetSalesman",
...
$('#btnDownload').on('click', function () {
    ...
    window.open('../Services/ForecastedReport.aspx?Company=' + company + '&SalesmanId=' + salesman + '&ManagerId=' + manager + '&oper=' + 2 + '&month=' + month + '&quarter=' + quarter)

});
$('#btnDownloadSummary').on('click', function () {

    window.open('../Services/ForecastedReport.aspx?Company=' + company + '&SalesmanId=' + salesman + '&ManagerId=' + manager + '&oper=1' + '&month=' + month + '&quarter=' + quarter)
...
function LoadForecastedReport(loadername) {
    ...
    //$('.ajax-loader').show();
    $.ajax({
        url: "ForecastedReport.aspx/GettableData",
