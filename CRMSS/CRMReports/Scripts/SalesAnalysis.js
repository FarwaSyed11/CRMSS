...
function LoadCompanyDDL() {
    debugger;
    $.ajax({
        url: "SalesAnalysis.aspx/GetCompanyDDL",
...
function LoadSalesmanager() {
    debugger;
    $.ajax({
        url: "SalesAnalysis.aspx/GetSalesmanager",
...
function LoadSalesman() {
    debugger;
    $.ajax({
        url: "SalesAnalysis.aspx/GetSalesman",
...
$('#btnDownload').on('click', function () {
    ...
    window.open('../Services/SalesCustomerPotential.aspx?Company=' + company + '&SalesmanId=' + salesman + '&ManagerId=' + manager+'&oper=' + 0)
    
});
$('#btnDownloadSummary').on('click', function () {

    window.open('../Services/SalesCustomerPotential.aspx?Company=' + company + '&SalesmanId=' + salesman + '&ManagerId=' + manager + '&oper=' + 1)
...
function LoadSalesCustomerPotential(loadername) {
    ...
    //$('.ajax-loader').show();
    $.ajax({
        url: "SalesAnalysis.aspx/GettableData",
        data: JSON.stringify({ "UserID": currUserId, "Company": company, "Manager": manager, "salesman": salesman }),
        type: "POST",
        contentType: "application/json;charset=utf-8",
        dataType: "json",
