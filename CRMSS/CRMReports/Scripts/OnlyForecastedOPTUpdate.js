...
function LoadCompanyDDL() {
    debugger;
    $.ajax({
        url: "OnlyForecastedOPTUpdate.aspx/GetCompanyDDL",
...
function LoadSalesmanager() {
    debugger;
    $.ajax({
        url: "OnlyForecastedOPTUpdate.aspx/GetSalesmanager",
...
function LoadSalesman() {
    debugger;
    $.ajax({
        url: "OnlyForecastedOPTUpdate.aspx/GetSalesman",
...
function LoadSalesPerfomance(loadername) {
    ...
    //$('.ajax-loader').show();
    $.ajax({
        url: "OnlyForecastedOPTUpdate.aspx/GettableData",
