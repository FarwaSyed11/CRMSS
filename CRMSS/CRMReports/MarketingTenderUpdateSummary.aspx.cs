...
public partial class CRMReports_MarketingTenderUpdateSummary : System.Web.UI.Page
{
    ...
    protected void ddlOrganization_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        BindManager();
        Bindmarketing();
        gdvTenderSummaryReport.DataBind();
    ...
    protected void lbtExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
                ExportDetails(ds.Tables[0], "Marketing Tender Update Summary");
    ...
    private void ExportDetails(DataTable dt,string reportname)
    {
    ...
    protected void lblDetail_Click(object sender, EventArgs e)
    {
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "sp_MTenderUpdateSummary", true, pa, pv);
        if (ds.Tables[0].Rows.Count > 0)
            ExportDetails(ds.Tables[0], "Marketing Tender Update Detail Report");
    }
