<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="SalesManagerJOHupdate.aspx.cs" Inherits="CRMReports_SalesManagerJOHupdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
       <div style="padding-left: 2%; padding-top: 1%;"><h4 style="text-shadow: 1px -3px 8px; color: #a92828;">SALES MANAGER JOH UPDATE </h4></div> 
  ...
  <table class="table table-bordered table-striped kpi-user-list-table">
    ...
    <thead>
      <tr>
          <th colspan="7" style="height:70px;text-align:center;font-style:oblique;vertical-align:middle;font-size: xx-large;">SALES MANAGER JOH UPDATE</th>
    </tr>
        
        <tr>
             <th style="width:16%;text-align:center;font-style:oblique;vertical-align:middle">MANAGER</th>
...
<%--    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.3.2/js/dataTables.buttons.min.js"></script>
 ...
 <%--     
    ...
    <script src="Scripts/SalesManagerJOHUpdate.js"></script>
