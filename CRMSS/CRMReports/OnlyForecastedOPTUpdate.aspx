<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="OnlyForecastedOPTUpdate.aspx.cs" Inherits="CRMReports_OnlyForecastedOPTUpdate" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
       <div style="padding-left: 2%; padding-top: 1%;"><h4 style="text-shadow: 1px -3px 8px; color: #a92828;">Forecasted Opportunity Details</h4></div> 
                      ...
                      <tr>
                          ...
                          <td class="no-border" style="width: 5%">
                              ...
                              <input type="button" id="btnSearch" value="Search" class="btn btn-primary d-block" style="font-size:small" /> 
                               <asp:Button runat="server" id="btnExportDetails" Text="Download Detail Report" class="btn btn-primary d-block" style="font-size:small" OnClick="btnExportDetails_Click"/> 
                          </td>
                      </tr>
                  </table>
      </div>
  ...
  <table class="table table-bordered table-striped kpi-user-list-table">
    ...
    <thead>
        ...
        <tr>
             <th style="width:20%;background-color:gray;text-align:center;font-style:oblique;vertical-align:middle">Owner</th>
            <th style="width:16%;background-color:gray;text-align:center;font-style:oblique;vertical-align:middle"> Big Potential</th>
            <th style="width:16%;background-color:gray;text-align:center;font-style:oblique;vertical-align:middle">Not Potential</th>
              <th style="width:16%;background-color:gray;text-align:center;font-style:oblique;vertical-align:middle">Potential JOH</th>
            <th style="width:16%;background-color:gray;text-align:center;font-style:oblique;vertical-align:middle">Tender Potential</th>
            <th style="width:16%;background-color:gray;text-align:center;font-style:oblique;vertical-align:middle">Grand Total</th>
        </tr>
    </thead>
...
<%--    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.3.2/js/dataTables.buttons.min.js"></script>
 ...
 <%--     
    ...
    <script src="Scripts/OnlyForecastedOPTUpdate.js"></script>
