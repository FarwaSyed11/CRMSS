...
public partial class CRMReports_HoldUpdate : System.Web.UI.Page
{
    ...
    public static List<tableData> GettableData(string UserID, string Company, string Manager, string marketing)
    {
        ...
        List<tableData> HoldUpdatePerc = new List<tableData>();
        dt = ds.Tables[0];
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            HoldUpdatePerc.Add(new tableData()
            {
