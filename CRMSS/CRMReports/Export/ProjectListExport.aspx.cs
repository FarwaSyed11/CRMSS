...
public partial class CRMReports_Export_ProjectListExport : System.Web.UI.Page
{
    ...
    private void ExportSummary(DataTable dt)
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=Project List Report.xls");
