<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="ConsultantPotential.aspx.cs" Inherits="CRMReports_ConsultantPotential" %>
  ...
  .loader-bg-blur{
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
            <div style="padding-left: 2%; padding-top: 1%;"><h4 style="text-shadow: 1px -3px 8px; color: #a92828;">Consultant Potential</h4></div>
                    ...
                    <table class="table table-condensed tblfilter" style="border-bottom-width: 0px !important;" runat="server" id="tbltopsearch">
                        <tr>
                            ...
                            <td class="no-border  label-alignment" style="width: 5%">
                                <asp:Label ID="Label11" Text="Marketing" runat="server" Font-Size="Medium" Font-Bold="true" />
                            </td>
                            <td class="no-border" style="width: 12%">
       ...
       <div class="ajax-loader loader-bg-blur">
              ...
              <h4>Generating Report...</h4>
                ...
                <div class="" style="margin-top: 1%;">
                    <table class="table table-bordered table-striped kpi-user-list-table">
                        ...
                        <thead>
                            <tr>
                                <th colspan="6" style="height:70px;text-align:center;font-style:oblique;vertical-align:middle;font-size: xx-large;">Consultant Potential</th>
                            </tr>
                            <tr>

                                <th style="width:20%;text-align:center;font-style:oblique;vertical-align:middle">Owner</th>
                                <th style="width:16%;text-align:center;font-style:oblique;vertical-align:middle"> Big Potential</th>
                                <th style="width:16%;text-align:center;font-style:oblique;vertical-align:middle">Potential JOH</th>
                                <th style="width:16%;text-align:center;font-style:oblique;vertical-align:middle">Potential Tender</th>
                                <th style="width:16%;text-align:center;font-style:oblique;vertical-align:middle">Not Potential</th>

                                <th style="width:16%;text-align:center;font-style:oblique;vertical-align:middle">Grand Total</th>
                            </tr>
                        </thead>
        ...
        <script src="Scripts/ConsultantPotential.js"></script>
