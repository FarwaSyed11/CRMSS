<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="FaciDashboard.aspx.cs" Inherits="Facility_Management_FaciDashboard" %>
            ...
            <script type="text/javascript">
             ...
             <table class="table table-condensed tblfilter" style="border-bottom-width: 0px !important;" runat="server" id="tbltopsearch">
                      <tr>
                          ...
                          <td class="no-border label-alignment hidden" style="width: 1%"></td>
                          <td class="no-border  label-alignment hidden" style="width: 3%">
                          ...
                          <td class="no-border  label-alignment hidden" style="width: 8%">
                          ...
                          <td class="no-border label-alignment" style="width: 70%"></td>
                          ...
                          <td class=" " style="width: 12%">
                              <asp:DropDownList ID="ddlOverview" runat="server" Font-Names="tahoma" CssClass="form-select color-dropdown">
                                  ...
                                  <asp:ListItem Text="2022" Value="2022" Selected></asp:ListItem>
                                   ...
                                   <div class="col-4 mb-2">
                                       <div class="card">
                                           <div class="card-body">
                                               <div class="card-title d-flex align-items-start justify-content-between">
                                                   <div class="avatar flex-shrink-0">
                                                       <img src="img/NOP.jpg" alt="Credit Card" class="rounded" />
                                                   </div>
                                                   <%-- <div><h4> Final Price </h4></div>--%>
                                                   <div><h5 style="text-shadow: 0px 5px 6px #cfc4c4;"> No. of Property </h5></div>
                                                   <div class="dropdown">
                                                       <button
                                                           class="btn p-0"
                                                           type="button"
                                             ...
                                             <span class="fw-semibold d-block mb-1">Total </span>
                                               <h5 class="card-title mb-2 total-prop-count"><img src="../Dashboard/assets/img/icons/unicons/line-loader.gif" style="width: 60%;" /></h5>
                                                   </div>
                                                   <div class="col-md-4">
                                                <span class="fw-semibold d-block mb-1">Vacant</span>
                                               <h5 class="card-title mb-2 rented-prop-count"><img src="../Dashboard/assets/img/icons/unicons/line-loader.gif" style="width: 85px;" /></h5>
                                                   </div>
                                               </div>
                                   ...
                                   <div class="col-4 mb-2">
                                       <div class="card">
                                           <div class="card-body">
                                               <div class="card-title d-flex align-items-start justify-content-between">
                                                   <div class="avatar flex-shrink-0">
                                                       <img src="img/homeRent1.png" alt="Credit Card" class="rounded" />
                                                   </div>
                                                   <div><h5 style="text-shadow: 0px 5px 6px #cfc4c4;"> Rented </h5></div>
                                                   <div class="dropdown">
                                                       <button
                                                           class="btn p-0"
                                                           type="button"
                                        ...
                                        <div class="row">
                                                   ...
                                                   <div class="col-md-8">
                                                     ...
                                                     <h5 class="card-title mb-2 rented-count"><img src="../Dashboard/assets/img/icons/unicons/line-loader.gif" style="width: 45%;" /></h5>
                                                   </div>
                                                   <div class="col-md-4">
                                                        <span class="fw-semibold d-block mb-1">Value</span>
                                                           <h5 class="card-title mb-2 rented-value"><img src="../Dashboard/assets/img/icons/unicons/line-loader.gif" style="width: 45%;" /></h5>
                                                   </div>
                            ...
                            <div class="col-4 mb-2">
                                       <div class="card" style="height:88%;">
                                           <div class="card-body">
                                               <div class="card-title d-flex align-items-start justify-content-between">
                                                   <div class="avatar flex-shrink-0">
                                                       <img src="img/tenant1.png" alt="Credit Card" class="rounded" />
                                                   </div>
                                                   <div><h5 style="text-shadow: 0px 5px 6px #cfc4c4;">Tenant</h5></div>
                                                   <div class="dropdown">
                                                       <button
                                                           class="btn p-0"
                                                           type="button"
                                        ...
                                        <div class="row">
                                                  ...
                                                  <div class="col-md-6">
                                                       <div class="row">
                                                           <div style="width:65%">Internal</div>
                                                           <div style="width: 39%; margin-left: -12%;"><h6 class="card-title mb-2 internal-count"><img src="../Dashboard/assets/img/icons/unicons/line-loader.gif" style="width: 45%;" /></h6></div>
                                                       </div>
                                                     <div class="row">
                                                           <div style="width:66%">External</div>
                                                           <div style="width: 39%; margin-left: -12%;"><h6 class="card-title mb-2 external-count"><img src="../Dashboard/assets/img/icons/unicons/line-loader.gif" style="width: 45%;" /></h6></div>
                                                       </div>
                                                    <%-- <span class="fw-semibold d-block mb-1">Internal</span>
                                                     <h5 class="card-title mb-2 internal-count"><img src="../Dashboard/assets/img/icons/unicons/line-loader.gif" style="width: 45%;" /></h5>--%>

                                                        <%-- <span class="fw-semibold d-block mb-1">External</span>
                                                           <h5 class="card-title mb-2 external-count"><img src="../Dashboard/assets/img/icons/unicons/line-loader.gif" style="width: 45%;" /></h5>--%>
                                                  </div>
                                                   <div class="col-md-6" style="margin-top: -14%;">
                                                      <div id="exInternalChart"></div>
                                                   </div>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-6 mb-4" style="margin-top: -2%;">
                                       <div class="card">
                                           <div class="row row-bordered g-0">
                                               <div class="col-md-3">
                                                    <div class="card-body" style="padding-bottom: 60px;">
                                                       ...
                                                       <%--<h6 style="display:flex">Finalized</h6>--%>
                                                        <h6 style="display:flex">Expiry Contract</h6>
                                                       <h6 class="card-title mb-2 sum-of-contracts"><img src="../Dashboard/assets/img/icons/unicons/line-loader.gif" style="width: 83%; margin-bottom: -34%;" /></h6>
                                                   </div>
                                               </div>  
...
<%--                                                       <canvas id="Finalization" style="width: 254px; height:159px; max-width: 600px;display: block;"></canvas>--%>
                                         ...
                                         <div class="row row-bordered g-0">
                                               <div class="col-md-3" >
                                                   <div class="card-body" style="padding-bottom: 52px";>
                                                       ...
                                                       <h6 style="display:flex">Cheque Due</h6>
                                                    <h6 class="card-title mb-2 sum-of-cheque-dues"><img src="../Dashboard/assets/img/icons/unicons/line-loader.gif" style="width: 83%; margin-bottom: -34%;" /></h6>
                                               ...
                                               <div class="col-md-9 pipe-parent-height">
                                                   <div class="" style="padding-top: 0px;">
                                                       ...
                                                       <div id="ChequeDueBarChart" class=""></div>
                                                   </div>
                                               </div>
                                           </div>
                                       </div>
                       ...
                       <div class="row" style="position: relative; margin-top: -1.8%;"> 
  ...
  <div class="nav-align-top card h-100 overview-tender-hold-joh-tab" style="width:32.2%; background: #ffffff;">
   ...
   <div class="nav-align-top card h-100 topJOH-tender-opp-tab" style="width:32.2%; background: #ffffff; margin-left: 13px;">
    ...
    <script src="../Dashboard/assets/js/dashboards-analytics.js"></script>
            <script src="Scripts/faci-dashboard.js"></script>
