...
public partial class TODONew_ManagerDashboard : System.Web.UI.Page
{
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static DashboardBox GetCountAndValuesOfTopRightBoxes(string FromDate, string ToDate, string TicketFor)
    {
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "sp_PurchaseDashboard", true, pa, pv);
    ...
    {
        public List<CountAndValuesForBoxes> listTopRightbox { get; set; }
        public List<CountAndValuesForBoxes> listMovementStatusesBoxes { get; set; }
        public List<CountAndValuesForBoxes> listContainerStatus { get; set; }
        public List<CountAndValuesForBoxes> listCountriesMap { get; set; }
    }
}