...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <style>
        ...
        .proj-meeting {
            border-color: #1b72aae3;
            background-color: #1b72aae3;
            color: white;
            text-shadow: 1px 1px 25px white;
        }

        .general-meeting {
            border-color: #8eb52ce3;
            background-color: #8eb52ce3;
            color: white;
            text-shadow: 1px 1px 25px white;
        }

        .bi-monthly-meeting {
            border-color: #db4e1ce3;
            background-color: #db4e1ce3;
            color: white;
            text-shadow: 1px 1px 25px white;
        }

        .training {
            border-color: #d73747e3;
            background-color: #d73747e3;
            color: white;
            text-shadow: 1px 1px 25px white;
        }
        ...
        .dis-div1 {
            ...
            box-shadow: 0px 0px 1px #99999957;
        }
    ...
    background: #f0f8ff3d;
    border-radius: 12px;
    box-shadow: 0px 0px 5px #5f84c669;
   }*/
        .proj-div-shadow {
            margin-top: 2%;
            background: #f4fff03d;
            border-radius: 12px;
            box-shadow: 0px 0px 5px #79c65f69;
        }
        ...
        .task-status-notstarted {
            ...
            border-radius: 6px;
            color: white;
            box-shadow: 0px 0px 3px 0.5px #fbc11e;
        ...
        .task-status-active {
            ...
            border-radius: 6px;
            color: white;
            box-shadow: 0px 0px 4px 0.5px #0b9adcbf;
        }
        ...
        .task-status-completed {
            ...
            border-radius: 6px;
            color: white;
            box-shadow: 0px 0px 4px 1px #98ca3c;
        }
        ...
        .task-status-cancelled {
            ...
            border-radius: 6px;
            color: white;
            box-shadow: 0px 0px 3px 0.5px #f56b61;
        }
        ...
        /*.task-list-table thead, tbody, tfoot, tr, td, th {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
        ...
        <table class="table table-condensed tblfilter" style="border-bottom-width: 0px !important;" runat="server" id="tbltopsearch">
            <tr>
                ...
                <td class="no-border  label-alignment" style="width: 3%">
                    <asp:Label ID="Label10" Text="HOD" runat="server" Font-Size="Medium" Font-Bold="true" />
                </td>
                <td class="no-border" style="width: 12%">
                    <select class="form-select placement-dropdownc" id="ddlHOD"></select>
                </td>

                <td class="no-border label-alignment" style="width: 1%"></td>
                <td class="no-border  label-alignment" style="width: 5%">
                    <asp:Label ID="Label11" Text="Manager" runat="server" Font-Size="Medium" Font-Bold="true" />
                </td>
                <td class="no-border" style="width: 12%">
                ...
                <td class="no-border label-alignment" style="width: 1%"></td>
                <td class="no-border  label-alignment" style="width: 5%">
                    <asp:Label ID="Label1" Text="Employee" runat="server" Font-Size="Medium" Font-Bold="true" />
                </td>
                <td class="no-border" style="width: 12%">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body" style="padding-top: 5%">
                                            ...
                                            <div id="external-events">
                                                ...
                                                <div class="external-event collection hidden">Collection</div>
                                                <div class="external-event follow-up hidden">Follow up</div>
                                                <div class="external-event others hidden">Others</div>--%>

                                                <div class="external-event proj-meeting">Project Meeting</div>
                                                <div class="external-event general-meeting">General Meeting</div>
                                                <div class="external-event bi-monthly-meeting">Bi-Monthly Meeting</div>
                                                <div class="external-event training">Training</div>
                                ...
                                <div style="max-height: 300px; overflow-y: auto;">
                                    <h4 style="text-align: center; border-bottom: 1px solid;">Invitation List</h4>
                ...
                <div class="modal-body" style="min-height: 400px;">
                    ...
                    <div class="nav-align-top">
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <button type="button" class="nav-link liTask not-allowed-cursor" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-task" aria-controls="navs-top-task" aria-selected="false">Task</button>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" style="min-height: 550px;">
                            ...
                            <div class="tab-pane fade show active" id="navs-top-home" role="tabpanel">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="">
                                            <select id="txtType" class="form-select color-dropdown magicmove">
                                                <option value="Project Meeting">Project Meeting</option>
                                                <option value="General Meeting">General Meeting</option>
                                                <option value="Bi-Monthly Meeting">Bi-Monthly Meeting</option>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="">
                                            <input class="form-control magicmove" type="text" value="" id="txtSubject" />
                                        </div>
                                    </div>
                                ...
                                <div class="row" style="margin-top: 1%;">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="row">
                                            <div class="col-4">
                                                <label class="col-form-label label-custom" for="basic-default-name">Meeting Category</label>
                                                <div>
                                                    <select id="ddlCategoryMeeting" class="form-select color-dropdown magicmove">
                                            ...
                                            <div class="col-5">
                                                ...
                                                <input type="text" id="weeklyDatePickerStart" placeholder="Select Date" style="background: white;" class="form-control flatpickr-input magicmove active" readonly="readonly">
                                            </div>
                                            <div class="col-3">
                                                <label for="html5-time-input" class=" col-form-label label-custom">From Time</label>
                                                <input class="form-control magicmove" type="time" value="12:30:00" id="from-timepicker" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-2">
                                        ...
                                        <div class="row">
                                            <div class="col-1">
                                                <input type="text" id="weeklyDatePickerEnd" placeholder="Select Date" style="background: white; display: none;" class="form-control flatpickr-input magicmove active" readonly="readonly">
                                            </div>
                                            <div class="col-10">
                                                <label for="html5-time-input" class=" col-form-label label-custom">To Time</label>
                                                <input class="form-control magicmove" type="time" value="12:30:00" id="to-timepicker" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-4">
                                        ...
                                        <div>
                                            <select id="ddlActStatus" class="form-select color-dropdown magicmove">
                                ...
                                <div class="row proj-div-shadow hidden">

                                    <div class="ddlAccIDDiv" style="width: 27%">
                                        <label for="html5-number-input " class="col-form-label label-custom magicmove">Project Name</label>
                                        <div class="">
                                            <%--//<input class="form-control" type="text" value="" id="txtAccountId" />--%>
                                            <select id="ddlAccID" class="form-select color-dropdown ddlAccID magicmove">
                                            </select>
                                        </div>
                                    </div>

                                    <div class="proj-info-detail-label-div" style="width: 72%">
                                        <div class="row">

                                            <div class="col-3">
                                                <label for="html5-number-input " class="col-form-label label-custom">Priority</label>
                                                <div class="box-priority" style="position: absolute; top: 32px;">
                                                    <i class="fa fa-circle task-priority-impo" aria-hidden="true" style="font-size: 11px; color: Orange;"></i>&nbsp; Important
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <label for="html5-number-input " class="col-form-label label-custom">Created Date</label>
                                                <div class="box-crdate" style="position: absolute; top: 32px;">2023-06-07</div>
                                            </div>
                                            <div class="col-3">
                                                <label for="html5-number-input " class="col-form-label label-custom">Schedule Start Date</label>
                                                <div class="box-sch-st-date" style="position: absolute; top: 32px;">2023-05-07</div>
                                            </div>
                                            <div class="col-3" style="text-align: center;">
                                                <label for="html5-number-input " class="col-form-label label-custom">Milestones</label>
                                                <div>
                                                    <div class="box-mstone" style="display: inline-flex; position: relative; top: -5px;">
                                                        <div class="progrees-bar-grid"><span style="position: absolute; margin-left: -0.5%;">3/5 </span>
                                                            <div style="width: 50%; background: #87d37c; border-radius: 4px; height: 17px;"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-3">
                                                ...
                                                <div class="box-owner-name" style="position: absolute; top: 32px;">
                                                    Anwar Ahmed
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <label for="html5-number-input " class="col-form-label label-custom">Duration in Days</label>
                                                <div class="box-duration-date" style="position: absolute; top: 32px;">2023-06-07</div>
                                            </div>
                                            <div class="col-3">
                                                <label for="html5-number-input " class="col-form-label label-custom">Schedule End Date</label>
                                                <div class="box-sch-end-date" style="position: absolute; top: 32px;">2023-05-07</div>
                                            </div>
                                            <div class="col-3" style="text-align: center;">
                                                <label for="html5-number-input " class="col-form-label label-custom">Tasks</label>
                                                <div>
                                                    <div class="box-tasks" style="display: inline-flex; position: relative; top: -6px;">
                                                        <div class="progrees-bar-grid"><span style="position: absolute; margin-left: -0.5%;">3/5 </span>
                                                            <div style="width: 50%; background: #87d37c; border-radius: 4px; height: 17px;"></div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row" style="margin-top: 1%;">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <textarea class="form-control magicmove" id="taRemarks" rows="4" placeholder="Enter Remarks"></textarea>
                                    </div>
                                ...
                                <div class="row taMOMDiv">
                                    ...
                                    <div class="row r-parent">
                                        ...
                                        <div class="col-6 ffDateFrom">
                                            ...
                                            <div class="row">
                                                <div class="col-8">
                                                    <input type="text" id="weeklyDatePickerStartFF" placeholder="Select Date" style="background: white;" class="form-control flatpickr-input magicmove active" readonly="readonly">
                                                </div>
                                                <div class="col-4" style="top: -38px;">

                                                    <label for="html5-time-input" class=" col-form-label label-custom">From Time</label>
                                                    <input class="form-control magicmove" type="time" value="12:30:00" id="from-timepickerFF" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-2 ffDateTo">
                                            ...
                                            <div class="row">
                                                <div class="col-1">
                                                    <input type="text" id="weeklyDatePickerEndFF" placeholder="Select Date" style="background: white; display: none" class="form-control flatpickr-input magicmove active" readonly="readonly">
                                                </div>
                                                <div class="col-11">
                                                    <input class="form-control magicmove" type="time" value="12:30:00" id="to-timepickerFF" />
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-4 ffIsFuturFollow" style="text-align: center; top: 55%;">
                                            <div class="form-check form-check-info">
                                                <input class="form-check-input magicmove cbIsFuturAct" type="checkbox" value="" id="customCheckInfo" />
                                    ...
                                    <div class="col-12" style="margin-top: 0;">
                                        ...
                                        <div>
                                            <textarea class="form-control magicmove" id="taMOM" rows="4" placeholder="Enter Minutes of Meeting"></textarea>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-pane fade" id="navs-top-task" role="tabpanel">
                                <%--Nav Task--%>
                                <div>
                                ...
                                <div class="" style="margin-top: 0%;">
                                    <table class="table task-list-table" style="width: 100%; border-color: inherit; border-style: none !important; border-width: 0;">
                                        <%--<caption class="ms-4">List of Projects</caption>--%>
                                        <thead>
                                        ...
                                        <tbody class="tbody-task-list" style="text-align: center; font-size: 12px;">
                                        </tbody>
                                    </table>
                                </div>
                            ...
                            <div class="tab-pane fade" id="navs-top-attendees" role="tabpanel">
                                ...
                                <div class="row" style="top: 23px; position: relative;">
                                    ...
                                    <div class="col-8">
                                        <div style="text-align: center; color: #d4432c !important">
                                            <h3 style="text-shadow: 1px 1px 14px orange;">List of Added Participants</h3>
                                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-4" style="border-right: 1px solid #00000040">
                            <div class="row" style="padding: 2px;">
                                ...
                                <div class="col-8">
                                    <input type="text" class="form-control" id="txtForecastOptNo" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57" disabled>
                                </div>
                            </div>
                            <div class="row" style="padding: 2px;">
                                <div class="col-4">
                                    <label>Forecasted For</label>
                                </div>
                                <div class="col-8">
                            ...
                            <div class="row" style="padding: 2px;">
                                ...
                                <div class="col-8">
                                    <input type="text" class="form-control" id="txtForecastAmount" onkeypress="return event.charCode >= 48 &amp;&amp; event.charCode <= 57">
                                </div>
                            </div>
                            <div class="row" style="padding: 2px;">
                                <div class="col-4">
                                ...
                                <div class="col-8">
                                    <textarea class="form-control" id="taForecastRemarks" placeholder="Input Remarks…." aria-describedby="basic-icon-default-message2"></textarea>
                                </div>
                            </div>
                        ...
                        <div class="col-8" <%--style="border-right: solid 1px #4740402b"--%>>
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <span class="act-subject">- </span></div>

                            </div>
                            <div class="row">
                                <div class="col-12 act-customer-div hidden">
                                    <label>Customer : </label>
                                    <span class="act-customer">- </span></div>

                            </div>
                            <div class="row">
                                <div class="col-12 act-project-div hidden">
                                    <label>Project :</label>
                                    <span class="act-project">- </span></div>

                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <label>Invited By :</label>
                                    <span class="act-invited-by">- </span></div>
                        ...
                        <div class="col-4">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <span class="act-type">- </span></div>
                            </div>

                            <div class="row">
                                <div class="col-12">
                                    <label>Activity Date : </label>
                                    <span class="act-date">- </span></div>
                            </div>
                            <div class="row">
                                <div class="col-12">
                                    <label>Activity Time :</label>
                                    <span class="act-time">- </span></div>
            ...
            <div class="modal-content oppInfoModalContent">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <select class="form-select color-dropdown" id="ddlTaggedPerson"></select>
                        <br />
    ...
    <script src="Scripts/calendar-master.js?v=1.1"></script>
