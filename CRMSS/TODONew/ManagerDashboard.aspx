<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="ManagerDashboard.aspx.cs" Inherits="TODONew_ManagerDashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li class="nav-item">
      <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-ticket" aria-controls="navs-ticket" aria-selected="true">Tickets</button>
    </li>
    <li class="nav-item">
      <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-container" aria-controls="navs-container" aria-selected="false">Task</button>
    </li>
    <li class="nav-item">
      <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#navs-raisedbyme" aria-controls="navs-raisedbyme" aria-selected="false">Raised by Me</button>
    </li>
  </ul>
  <div class="tab-content">
           ...
           <ul class="p-0 m-0 overview-tab-ull" style="margin-top: -4% !important;"> 
               <li class="d-flex" style="margin-bottom: 0.5rem !important;">
                                               ...
                                               <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                   <div class="me-2">
                                                       <span style="font-size:smaller;">Requested</span>
                ...
                <li class="d-flex" style="margin-bottom: 0.5rem !important;">
                                               ...
                                               <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                   <div class="me-2">
                                                       <span style="font-size:smaller;"  class="tic-pending-heading">Assigned</span>
               ...
               <li class="d-flex" style="margin-bottom: 0.5rem !important;">
                                               ...
                                               <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                   <div class="me-2">
                                                       <span style="font-size:smaller;"  class="tic-pending-heading">Started</span>
               ...
               <li class="d-flex" style="margin-bottom: 0.5rem !important;">
                                               ...
                                               <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                   <div class="me-2">
                                                       <span style="font-size:smaller;">Cancelled</span>
    ...
    <div class="tab-pane fade" <%--style="width:60%;"--%> id="navs-container" role="tabpanel">
        ...
        <div class="row" style="MARGIN-TOP: -2%;">
           ...
           <div class="col-8">               
                   <div style="font-size: larger; text-shadow: 0px 5px 6px #cfc4c4; position: relative; top: -9px;">Total Task Count </div>  
      ...
      <%--Raised by Me Tab--%>
      <div class="tab-pane fade"  id="navs-raisedbyme" role="tabpanel">
      
        <div class="row" style="MARGIN-TOP: -2%;">

           <div class="col-8">               
                   <div style="font-size: larger; text-shadow: 0px 5px 6px #cfc4c4; position: relative; top: -9px;">Total Count </div>  
                   <div style="position: relative; top: -13px; font-size: xx-large; color:#e35d5d;"><b class="cont-total">0</b></div>             
           </div>

           <div class="col-4">
               <div id="containerRoundChart1" style="margin-top: -29%;"></div>
           </div>
    ...
    <%--yearly graph display none--%>
                       ...
                       <%--        </div>--%>
                         ...
                         <%--       </div> 
                           ...
                           <!--/ Other 60% remaining area-->
                            <%--Pie Chart PR--%>
                          <div style="width:60%;"> <div id="chartContainer" style="width: 60%; height: 400px"></div>  </div> 
                           <%--end--%>
            ...
            <%--Overview update marketing--%>
                       ...
                       <div class="row" style="position: relative; margin-top: -8px;;"> 
            ...
            <div class="nav-align-top card h-100 forecast-opp-tab" style="width:33.2%; background: #ffffff; margin-left:1%">
                ...
                <div class="tab-content card-body" style="float: left; overflow-y: auto; height: 565px;" role="tabpanel">
                    <div class="tab-pane fade show active" id="navs-pills-top-home" >
                        <div class="row"> 
                             <div id="barcharhorizon" style="height: 500px; width: 100%;">  </div>
                                <%--<div class="col-md-8 ">                                                         
                         ...
                         <ul class="p-0 m-0 forcasted-opportunity-ul ">  </ul>
                    </div>
 ...
 <script src="https://unpkg.com/leaflet@1.9.3/dist/leaflet.js"
    ...
    <script src="../Dashboard/assets/js/dashboards-analytics.js"></script>
            <script src="Scripts/manager-dashboard.js?v=1.1"></script>
