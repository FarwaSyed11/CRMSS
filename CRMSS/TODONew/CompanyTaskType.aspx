<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="CompanyTaskType.aspx.cs" Inherits="TODONew_CompanyTaskType" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
       <div style="padding-left: 2%;padding-right: 2%; padding-top: 1%;"><h4 id="RequestHeader" style="text-shadow: 1px -3px 8px; color: #a92828;float: left;">Department Task Type</h4>
  ...
  <table class="table table-bordered table-striped maindata-list-table">
    ...
    <thead>
     <tr style="height:50px">
         ...
         <th style="width:20%;text-align:center;vertical-align:middle">Description</th>
          <th  style="width:10%;text-align:center;vertical-align:middle">No of Days Required</th>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer" style="display:block;">
        ...
        <div class="modal fade" id="modalWorkflow" style="background: rgb(177 171 171 / 36%); zoom: 85%;" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl" role="document" style="width: 82%;">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="">
                        ...
                        <a href="#" id="btnAddNewWorkFlow" class="animated-button1" style="float: right; font-size: smaller;"><%--<i class="fa fa-plus" aria-hidden="true"></i>&nbsp;--%><span></span><span></span><span></span><span></span><i class="fa fa-plus" aria-hidden="true"></i>&nbsp;Add New</a>

                    </div>

                    <div class="" style="margin-top: -2%;">
                        <table class="table WorkFlow-table" style="width: 100%;">
                    ...
                    <div style="background: #dbdbdb17; padding: 17px; border-radius: 12px; border: 1px solid #dbd7d6; box-shadow: 0px 0px 13px -7px #444444;">
                        ...
                        <div class="col-4">
                                ...
                                <div class="">
                                    ...
                                    <select class="form-control textbox-border-color" id="ddlWFType">
                            ...
                            <div class="col-6 multi-ddl-owner-div">
                                <label for="html5-number-input" class="col-form-label label-custom">Employee <span style="color: red;">*</span></label>
                                <div class="EmployeeDrop">
                                    <select id="ddlAssignEmp" class="form-select color-dropdown ddlOwnerTask"></select>
                                 ...
                                 <div class="RoleDrop" style="display:none;">

                                      <select class="form-control textbox-border-color" id="ddlEmployeeType">
                                       <option value="LineManager">Line Manger</option>
                            ...
                            <div class="col-2">
                                <label for="html5-number-input" class="col-form-label label-custom">Order Numb <span style="color: red;">*</span></label>
                                <div class="">

                                    <input type="text" class="form-control textbox-border-color" id="txtOrderNumb" />
                        ...
                        <div class="row" style="padding-top:1%;">
                            ...
                            <div class="col-8">
                                <div class="col mb-3 discriptionDiv">
                                    <label for="nameBasic" class="col-form-label label-custom">Description </label>
                                    <textarea id="txtWFDescription" rows="2" class="form-control textbox-border-color" placeholder="Enter Description"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-4">
                                ...
                                <label class="col-form-label label-custom" style="font-weight: bold; color: black;">Status</label>
                                <div>
                                    <div class="netliva-switch" style="padding-top:6%;">
                                        <input type="checkbox" id="cbWFStatus" netliva-switch="OK">
                                        <label for="cbWFStatus" data-active-text="Active" data-passive-text="Inactive" style="width: 160px; --switch-active-color: #98ca3c; --switch-passive-color: #66666696; max-width: 58%"></label>
                                    </div>
                                </div>
    ...
    <script src="Scripts/CompanyTaskType.js?v=1.4"></script>
    <script src="Scripts/task-main-ticket.js?v=1.4"></script>
   ...
   <%--   <script src="Asset/css/netliva_switch.css"></script>
    ...
    <link href="Asset/css/todonew.css" rel="stylesheet" />
