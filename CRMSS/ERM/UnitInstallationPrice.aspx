<%@ Page Title="" Language="C#" MasterPageFile="~/EconnectNew.master" AutoEventWireup="true" CodeFile="UnitInstallationPrice.aspx.cs" Inherits="ERM_UnitInstallationPrice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
        ...
        <div class="row" style="padding-left: 2%;">
            <div style="width: 22%;" class="pull-left">
                <h4 style="color: #a92828; margin-top: 13px">Unit Installation Price</h4>
            </div>
            <div style="width: 21%" class="pull-left"></div>
        ...
        <div class="card-body" style="margin-top: -1%;">
            ...
            <div class="" style="margin-top: 3%;">
                ...
                <table class="table Item-UnitInstallationPrice-details" style="width: 100%;">
                    ...
                    <tbody class="tbody-UnitInstallationPrice">
                    </tbody>
                </table>
            </div>
        </div>
   ...
   <div class="modal fade" id="mpAddUIPriceConfirmation" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal fade" id="modalPriceHistory" style="background: rgb(177 171 171 / 36%); zoom: 80%;" tabindex="-1" aria-hidden="true">
    ...
    <script src="Scripts/UnitInstallationPrice.js?v=0.5"></script>
