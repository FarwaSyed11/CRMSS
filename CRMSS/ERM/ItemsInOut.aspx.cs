...
public partial class ERM_ItemsInOut : System.Web.UI.Page
{
	...
	public static List<DDL> GetAllSystems(string UserId, string ReqId)
	{
		...
		DBH.CreateDatasetERM_Data(ds, "sp_InOutItemsCalc", true, pa, pv);
	...
	[WebMethod]
	[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
	public static List<DetsByProjOrOptNo> GetDetByProjNo(string ProjNo, string OptNo)
	{
		...
		List<DetsByProjOrOptNo> oList = new List<DetsByProjOrOptNo>();
		...
		if (ds.Tables.Count > 0)
		{
			...
			for (int i = 0; i < dt.Rows.Count; i++)
			{
				oList.Add(new DetsByProjOrOptNo()
				{
					ID = dt.Rows[i]["ID"].ToString(),
	...
	[WebMethod]
	[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
	public static void AddOutputItems(ItemTOCList data)
	{
	...
	[WebMethod]
	[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
	public static void AddInputItems(ItemTOCList data)
	{
		...
		foreach (var item in data.listItemsTOC)
		{
			...
			pa.Add("@OutputItemId");
			pv.Add(item.OutputItemId);

			pa.Add("@Calc");
			pv.Add(item.Calculation);
	...
	[WebMethod]
	[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
	public static List<ProductMasterModel> GetAllInputItemsByOutputItem(string ItemId) //string SysName, string Category, string ItemCode, string ReqId, 
	{
		...
		if (ds.Tables.Count > 0)
		{
			...
			for (int i = 0; i < dt.Rows.Count; i++)
			{
				oListPro.Add(new ProductMasterModel()
				{
					InOutTransId = dt.Rows[i]["ID"].ToString(),
					ItemId = dt.Rows[i]["ItemID"].ToString(),
					OracleItemId = dt.Rows[i]["OracleItemID"].ToString(),
					Category = dt.Rows[i]["Category"].ToString(),
					ItemDesc = dt.Rows[i]["ItemDesc"].ToString(),
					...
					System = dt.Rows[i]["System"].ToString(),
					CreatedBy = dt.Rows[i]["CreatedBy"].ToString(),
					Calculation = dt.Rows[i]["Calculation"].ToString(),
					CreatedDate = dt.Rows[i]["CreatedDate"].ToString()
				});
			}
		}
	...
	[WebMethod]
	[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
	public static List<ProductMasterModel> GetAddedOutputItems(string SysName, string Category, string ItemCode, string ReqId)
	{
	...
	[WebMethod]
	[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
	public static List<ProductMasterModel> GetAddedInputItemsByOutputItem(string ItemId) //string SysName, string Category, string ItemCode, string ReqId, 
	{
	...
	[WebMethod]
	[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
	public static void DeleteInputItem(string InOutTransId, string UserId)
	{
	...
	[WebMethod]
	[ScriptMethod(ResponseFormat = ResponseFormat.Json)]
	public static void DeleteOutputItem(string OutputItemId, string UserId)
	{
	...
	public class ProductMasterModel
	{
		...
		public string InOutTransId { get; set; }
	}
	...
	public class DetsByProjOrOptNo
	{
		public string ID { get; set; }
