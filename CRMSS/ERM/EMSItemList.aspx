...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="modal fade" id="addReqModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" style="min-width: 98%; height: 90%;">
            <div class="modal-content" style="height: 108%;">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <ul class="nav nav-tabs progressbar d-flex flex-row" id="progress-bar" role="tablist">
                                            ...
                                            <li class="nav-link tabstyle" id="nav-Structure-tab" data-bs-toggle="tab" data-bs-target="#nav-Structure" type="button" role="tab" aria-controls="nav-Structure" aria-selected="false">Create Structure</li>
                                            <li class="nav-link tabstyle" id="nav-TOC-tab" data-bs-toggle="tab" data-bs-target="#nav-TOC" type="button" role="tab" aria-controls="nav-TOC" aria-selected="false">Create TOC</li>
                                            <li class="nav-link tabstyle" id="nav-Summary-tab" data-bs-toggle="tab" data-bs-target="#nav-Summary" type="button" role="tab" aria-controls="nav-Summary" aria-selected="false">Summary</li>
                                                    ...
                                                    <div class="row border-bottom">
                                                        <div class="d-flex " style="width: 17%;">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="">
                                                                    <label id="txtEstRef" value="" class="form-control noborderbg"></label>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="d-flex " style="width: 17%;">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="">
                                                                    <label id="txtRevision" value="" class="form-control noborderbg"></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex " style="width: 17%;">
                                                            <div class="me-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 20 20">
                                                                    <path fill="#a92828" d="M1 4c0-1.1.9-2 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2zm2 2v12h14V6zm2-6h2v2H5zm8 0h2v2h-2zM5 9h2v2H5zm0 4h2v2H5zm4-4h2v2H9zm0 4h2v2H9zm4-4h2v2h-2zm0 4h2v2h-2z" />
                                                                </svg>
                                                            </div>
                                                            <div>
                                                                <label for="html5-number-input" class="  label-custom">Year</label>
                                                                <div class="">
                                                                    <label id="txtEstYear" value="" class="form-control noborderbg"></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex " style="width: 17%;">
                                                            <div class="me-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 48 48">
                                                                    <g fill="none" stroke="#a92828" stroke-linecap="round" stroke-linejoin="round" stroke-width="4">
                                                                        <path d="M40 23v-9L31 4H10a2 2 0 0 0-2 2v36a2 2 0 0 0 2 2h12m4-12h14m-14 6h14M30 28v14m6-14v14" />
                                                                        <path d="M30 4v10h10" />
                                                                    </g>
                                                                </svg>
                                                            </div>
                                                            <div>
                                                                ...
                                                                <div class="">
                                                                    <label id="txtOppRef" value="" class="form-control noborderbg" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="d-flex " style="width: 15%;">
                                                            <div class="me-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 24 24">
                                                                    <path fill="#a92828" d="M20 18H4V8h16m0-2h-8l-2-2H4c-1.11 0-2 .89-2 2v12a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2m-1 6v-1h-1.5l.5-2h-1l-.5 2h-2l.5-2h-1l-.5 2H12v1h1.25l-.5 2H11v1h1.5l-.5 2h1l.5-2h2l-.5 2h1l.5-2H18v-1h-1.25l.5-2zm-3.25 2h-2l.5-2h2z" />
                                                                </svg>
                                                            </div>
                                                            <div>
                                                                <label for="html5-number-input" class="  label-custom">Proj Ref</label>
                                                                <div class="">
                                                                    <label id="txtProjRef" value="" class="form-control noborderbg"></label>
                                                                </div>
                                                            </div>
                                                        </div>
         ...
         <div class="flatpickr">
             <input id="txtEstDate" value="" class="form-control noborderbg" style="" type="text" placeholder="Select Date.." />
         </div>
     </div>--%>
                                                    </div>

                                                    <div class="row mt-4 mb-4" style="">
                                                        <h5 class="fw-bold prpmdl-hed" id="lbladditemsa" style="">Details</h5>
                                                    </div>
                                                        ...
                                                        <div class="d-flex " style="width: 25%;">
                                                            <div class="me-2">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="2rem" height="2rem" viewBox="0 0 32 32">
                                                                    <path fill="#a92828" d="M16 20h14v2H16zm0 4h14v2H16zm0 4h7v2h-7z" />
                                                                    <path fill="#a92828" d="M14 26H4V6h7.17l3.42 3.41l.58.59H28v8h2v-8a2 2 0 0 0-2-2H16l-3.41-3.41A2 2 0 0 0 11.17 4H4a2 2 0 0 0-2 2v20a2 2 0 0 0 2 2h10Z" />
                                                                </svg>
                                                            </div>
                                                            <div>
                                                                <label for="html5-number-input" class="  label-custom">Project Name </label>
                                                                <div class="">
                                                                    <label id="txtPrjName" value="" class="form-control noborderbg" style=""></label>
                                                                </div>
                                                            </div>
                                                        </div>
                                                 ...
                                                 <div class="">
                                                     <img src="images/gif-user.gif" title="Add New" class="fa-icon-hover" style="cursor: pointer; width: 36px; padding-top: 11px;" ></label>
                                                 </div>
                                             </div>--%>
  ...
  <input type="radio" id="rdQtAndSp" name="Quotation" value="AS PER DRAWING AND SPECIFICATION" style="margin-left: 5%">AS PER DRAWING & SPECIFICATION
                                                ...
                                                <div id="div-structure">
                                                    <div class="row">
                                                        <div class="col-12 mb-3">
                                                            <button type="button" class="btn btn-primary btnAddStructure float-right" style="">Add New Structure</button>
                                                        </div>
                                                        <div class="col-12">
                                            ...
                                            <%--    <div style="display: flex; justify-content: end;">
                                                    <button type="button" class="btn btn-primary btn-add-item-toc-grid">
                                            ...
                                            <div class="tab-pane fade" id="nav-Summary" role="tabpanel" aria-labelledby="nav-Summary-tab">Summary and reports</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <%--<div class="modal-body">
                    <div class="row">
                        <div class="col-md-5">
                            <label for="html5-number-input" class="col-form-label label-custom">Opportunity No. <span style="color: red;">*</span></label>
                            <div>
                                <input id="txtOPTNo" class="form-control" type="text" style="width: 100%;" placeholder="Opportunity No.">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <label for="html5-number-input" class="col-form-label label-custom">Request No. <span style="color: red;">*</span></label>
                            <div>
                                <input id="txtReqNo" class="form-control" type="text" style="width: 100%;" placeholder="Request No.">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <label for="html5-number-input" class="col-form-label label-custom">Request Date <span style="color: red;">*</span></label>
                            <div>
                                <input class="form-control" type="text" placeholder="Enter Request Date" style="background-color: white;" id="dtReqdate">
                            </div>
                        </div>
                    </div>

                    <div class="row mt-2">
                        <label for="html5-number-input" class="col-form-label label-custom">Items <span style="color: red;">*</span></label>
                        <div><i class="fa fa-plus" aria-hidden="true"></i><a href="#" class="btn-item-list" style="text-decoration: underline;">Add Items</a> </div>
                    </div>

                    <div class="item-table-viewonly hidden" style="overflow-y: auto; max-height: 350px;">
                        <div style="text-align: center;">
                            <h6 class="mt-1">Selected Items List</h6>
                        </div>
                        <table class="mt-1 table " style="width: 100%; zoom: 75%;">

                            <thead style="position: sticky; top: -3px;">
                                <tr class="Head-tr">
                                    <th style="width: 52px !important">Delete</th>
                                    <th>Item Code</th>
                                    <th>Quantity</th>
                                    <th>Item Desc</th>
                                    <th class="hidden">Inv Item Id</th>
                                    <th class="hidden">UOM</th>
                                </tr>
                            </thead>

                            <tbody class="tbody-items-list-viewonly">
                            </tbody>
                        </table>
                    </div>
                </div>--%>
    ...
    <div class="modal fade" id="ModalAddStructure" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="">Structure Main Details</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body" style="">
                    <div class="row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="row pt-2 mt-2 border-top" id="mainFloorTypes">
                                <div class="mainFloorSub d-flex">
                                    <div class="form-check col-5 ps-5 ">
                                        <input class="form-check-input" type="checkbox" value="Base" id="flexCheckBasement">
                                        <label class="form-check-label" for="flexCheckBasement">
                                            Basement
                                        </label>
                                    </div>
                                    <div class="col-4 mb-2">
                                        <input class="form-control bsmntFloor" type="number" id="" placeholder="enter floors..." disabled>
                                    </div>
                                    <div class="col-3 mb-2">
                                        <input class="form-control bsmntFloor" type="number" id="" placeholder="order #..." disabled>
                                    </div>
                                </div>

                                <div class="mainFloorSub d-flex">
                                    <div class="form-check col-5 ps-5">
                                        <input class="form-check-input" type="checkbox" value="Park" id="flexCheckParking">
                                        <label class="form-check-label" for="flexCheckParking">
                                            Parking
                                        </label>
                                    </div>
                                    <div class="col-4 mb-2">
                                        <input class="form-control parkFloor" type="number" id="" placeholder="enter floors..." disabled>
                                    </div>
                                    <div class="col-3 mb-2">
                                        <input class="form-control parkFloor" type="number" id="" placeholder="order #..." disabled>
                                    </div>
                                </div>

                                <div class="mainFloorSub d-flex">
                                    <div class="form-check col-5 ps-5">
                                        <input class="form-check-input" type="checkbox" value="FLR" id="flexCheckNormal">
                                        <label class="form-check-label" for="flexCheckNormal">
                                            Floor
                                        </label>
                                    </div>
                                    <div class="col-4 mb-2">
                                        <input class="form-control normalFloor" type="number" id="" placeholder="enter floors..." disabled>
                                    </div>
                                    <div class="col-3 mb-2">
                                        <input class="form-control normalFloor" type="number" id="" placeholder="order #..." disabled>
                                    </div>
                                </div>
                                <div class="mainFloorSub d-flex">
                                    <div class="form-check col-5 ps-5">
                                        <input class="form-check-input" type="checkbox" value="Roof" id="flexCheckTerrace">
                                        <label class="form-check-label" for="flexCheckTerrace">
                                            Roof
                                        </label>
                                    </div>
                                    <div class="col-4 mb-2">
                                        <input class="form-control terrFloor" type="number" id="" placeholder="enter floors..." disabled>
                                    </div>
                                    <div class="col-3 mb-2">
                                        <input class="form-control terrFloor" type="number" id="" placeholder="order #..." disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="addUpdateSystemnItems" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
