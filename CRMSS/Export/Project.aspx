<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="Project.aspx.cs" Inherits="Export_Project" %>
                       ...
                       <asp:LinkButton ID="lbkAdvanceButton"  Style="text-align: center" CssClass="btn rounded-pill btn-icon btn-round" OnClick="lbkAdvanceButton_Click"    
                        ...
                        <div class="row" style="padding-left: 8px;padding-top: 10px;">
                            <div class="col-1" style="width: 20%;border-style: groove;" id="dvdAdvancedSearch" runat="server" visible="false">
                                ...
                                <asp:Panel runat="server" ID="pnlOwner" style="padding-top:5px" Visible="false">
                                    <div class="row">
                                        <div style="width: 30%">
                                            Marketing 
                                        </div>
                                        <div style="width: 60%">
                                            <asp:DropDownList ID="ddlOwner"  CssClass="form-control textBox1" runat="server" ForeColor="Black"  style="max-width:100%"></asp:DropDownList>
                                        </div>
                                        <div style="width: 5%">
                                               <asp:Button ID="btnOwner" runat="server" CssClass="btn btn-close" style="padding: 10px 0px;" OnClick="btnOwner_Click">
                                    ...
                                    <div class="row">
                                        ...
                                        <div style="width: 60%">
                                            <asp:DropDownList ID="ddlSalesStageSearch" CssClass="form-control textBox1" runat="server" ForeColor="Black" >
                                                <asp:ListItem Text="JOH" Value="JOH" Selected="True"></asp:ListItem>
                        ...
                        <div id="dvupdate" runat="server" style="overflow-y: auto; height: calc(100vh - 225px); overflow-x: hidden">
                            <asp:GridView ID="gdvProjectSummaryDetails" runat="server" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Project Number" ItemStyle-Width="5%" Visible="True" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" SortExpression="PRJNumber">
                                        <ItemTemplate>
                                            <asp:Label ID="lblPRJNumber" Text='<%#(Eval("PRJNumber").ToString()) %>'
                                                runat="server" />
                                            <asp:HiddenField ID="hfdPRJNumber" Value='<%#(Eval("PRJNumber").ToString()) %>'
                                                runat="server" />
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Name" ItemStyle-Width="15%" Visible="True" SortExpression="Name" HeaderStyle-HorizontalAlign="Left">
                                        ...
                                        <ItemTemplate>
                                            <asp:Label ID="lblPRJName" Text='<%#(Eval("Name").ToString()) %>'
                                                runat="server" />
                                        </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="View">
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lblView" runat="server" Text='' CommandName="View" CssClass="btn rounded-pill btn-icon btn-round"
                                                CommandArgument='<%#Eval("PRJNumber")%>' Style="text-align: center"><i class="fa fa-eye" title="View"></i></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
						...
						<table class="table table-condensed" style="width: 100%;">
							...
							<tr>
                               ...
                               <tr>
									...
									<td style="padding: 3px 5px; width: 8%" class="no-border">
										<asp:DropDownList ID="ddlCountryNP" runat="server" CssClass="textBox1 form-control " Font-Bold="True" ></asp:DropDownList>
									</td>
                                    </tr>
                        ...
                        <div class="card-header pnlheading">
                         ...
                         <div class="card-block">
                           ...
                           <asp:Panel ID="Panel10" runat="server" CssClass="pnlsubheading">
                                 <div class="pull-left">
                                     <h5>
                                         <asp:Label ID="Label46" class="panel-heading" Style="color: white;" runat="server" Text="Opportunity Details"></asp:Label></h5>
                                 </div>
                                <div class="pull-right" style="margin-top: -9px;margin-right: 10px;">
                                  ...
                                  OnRowCommand="gdvOPtDetails_RowCommand"   
                                     ...
                                     <Columns>
                                           ...
                                           <asp:TemplateField HeaderText="Opportunity Number" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center">
                                             <ItemTemplate>
                                                     <asp:LinkButton ID="lblOPTNumber" Text='<%#(Eval("OPTNumber").ToString()) %>' CommandName="view" CommandArgument='<%#(Eval("OPTNumber").ToString()) %>'
                                                     runat="server" />
                                             </ItemTemplate>
                                         </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Opportunity Name" ItemStyle-Width="15%" Visible="True">
                                             <ItemTemplate>
                                                 <asp:Label ID="lblOPTName" Text='<%#(Eval("OPTNumber").ToString()) %>'
                                                     runat="server" />
                                                 <asp:HiddenField ID="hfdOpportunityId" Value='<%#(Eval("OPTID").ToString()) %>' runat="server" />
                                             ...
                                             <ItemTemplate>
                                                 <asp:Label ID="lblContractor" Text='<%#(Eval("CustomerName").ToString()) %>' runat="server" />
                                             </ItemTemplate>
                                         </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Assistant Owner" ItemStyle-Width="10%" Visible="True" ItemStyle-HorizontalAlign="Center">
                                             <ItemTemplate>
                                                 <asp:Label ID="lblAssistantOwner" Text='<%#(Eval("AssistantOwner").ToString()) %>' runat="server" />
                                             </ItemTemplate>
                                         </asp:TemplateField>
                                         ...
                                         <asp:TemplateField HeaderText="Status" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center">
                                            ...
                                            <asp:TemplateField HeaderText="Created Date" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center">
                                             <ItemTemplate>
                                                    <asp:Label ID="lblCreatedDate" Text='<%#(Eval("CreatedDate").ToString()) %>' runat="server" />
                                             </ItemTemplate>
                                         </asp:TemplateField>
