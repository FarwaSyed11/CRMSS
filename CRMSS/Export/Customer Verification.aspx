<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="Customer Verification.aspx.cs" Inherits="Export_Customer_Verification" %>
  ...
  <table class="table table-bordered table-striped kpi-user-list-table">
    ...
    <thead>
     <tr style="height:50px">
            <th class="hidden" style="width:14%;text-align:center;vertical-align:middle">Customer Name</th>
             <th style="width:10%;text-align:center;vertical-align:middle">Primary Category</th>
            <th style="width:16%;text-align:center;vertical-align:middle">Country</th>
            <th style="width:10%;text-align:center;vertical-align:middle">City</th>
              <th style="width:10%;text-align:center;vertical-align:middle">Phone</th>
               <th style="width:10%;text-align:center;vertical-align:middle">Email</th>
...
<%--    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.3.2/js/dataTables.buttons.min.js"></script>
 ...
 <%--     
    ...
    <script src="Script/CustomerVerification.js?v=1"></script>
