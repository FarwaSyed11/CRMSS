...
public partial class Export_DashboardExport : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(Convert.ToString(Session["UserId"])))
        {
            ...
            Common.SaveAppUserActivityHistory(Session["ApplicationId"].ToString(), "/Export/DashboardExport.aspx", "Export Dashboard.", Session["empno"].ToString(), 0);
        }
        else
        {
    ...
    //        DBH.CreateDatasetCRMEBSDATA(ds, "sp_DashboardValueExport", true, pa, pv);
    ...
    public static List<ManagerDDL> LoadManagerDropdown(string compId, string userId)
    {
        ...
        for (int i = 0; i < dt.Rows.Count; i++)
        {
            ...
            man.ManagerName = dt.Rows[i]["ManageName"].ToString();
    ...
    [WebMethod]
    [ScriptMethod(ResponseFormat = ResponseFormat.Json)]
    public static List<SalemanDDL> LoadSalemanDropdownExport(string userId, string compId, string manId)
    {
        DBHandler DBH = new DBHandler();
        DataSet ds = new DataSet();
        DataTable dt = new DataTable();
    ...
    public static List<WonAndLostGrap> GetWonLostgraph(string compId, string manId, string salesmanId, string userId, string year, string userStatus, string Oper)
    {
        ...
        DBH.CreateDatasetCRMEBSDATA(ds, "sp_ExportDashboard", true, pa, pv);
    ...
    public static AllinOne GetCountnvalForGCs(string compId, string manId, string salesmanId, string userId, string year, string userStatus)
    {
        ...
        if (ds.Tables.Count > 0)
        {
            ...
            for (int i = 0; i < ds.Tables[1].Rows.Count; i++)
            {
                ...
                {
                    SoValue = ds.Tables[1].Rows[i]["SoValue"].ToString(),
                    LostValue = ds.Tables[1].Rows[i]["LostValue"].ToString(),
            ...
            List<SalesForecast> salesForecastList = new List<SalesForecast>();            
                ...
                salesForecast.SalesForecastValue = ds.Tables[3].Rows[1]["VALUE"].ToString();
                salesForecast.SalesForecastedCount = ds.Tables[3].Rows[0]["VALUE"].ToString();
            ...
            // for Number of Open JOH box value and count
            List<NumberOfJOH> NoOfJobsList = new List<NumberOfJOH>();            
          
                NumberOfJOH noofjobs = new NumberOfJOH();
                noofjobs.OTPCount = ds.Tables[4].Rows[0]["Value"].ToString();
                noofjobs.OTPValue = ds.Tables[4].Rows[1]["Value"].ToString();
                //noofjobs.Year = ds.Tables[3].Rows[i]["year"].ToString();
                NoOfJobsList.Add(noofjobs);


            // Country APEX Graph values 
            ...
            for (int i = 0; i < ds.Tables[5].Rows.Count; i++)
            {
                ...
                val.FinalizedValue = ds.Tables[5].Rows[i]["OPENVALUE"].ToString();
                //val.Year = ds.Tables[5].Rows[i]["Year"].ToString();
                val.Product = ds.Tables[5].Rows[i]["CountryCode"].ToString();
            ...
            for (int i = 0; i < ds.Tables[6].Rows.Count; i++)
            {
                ...
                pVla.PipelineValue = ds.Tables[6].Rows[i]["OPENVALUE"].ToString();
                //pVla.Year = ds.Tables[6].Rows[i]["Year"].ToString();
            ...
            oView.JOHCount = ds.Tables[7].Rows[1]["value"].ToString();

            oView.Secured = ds.Tables[7].Rows[5]["Type"].ToString();
            oView.SecuredValue = ds.Tables[7].Rows[5]["value"].ToString();

            oView.UnderRisk = ds.Tables[7].Rows[6]["Type"].ToString();
            oView.UnderRiskValue = ds.Tables[7].Rows[6]["value"].ToString();

            oView.OnTrack = ds.Tables[7].Rows[3]["Type"].ToString();
            oView.OnTrackValue = ds.Tables[7].Rows[3]["value"].ToString();

            oView.EarlyToJudge = ds.Tables[7].Rows[0]["Type"].ToString();
            oView.EarlyToJudgeValue = ds.Tables[7].Rows[0]["value"].ToString();

            oView.Lost = ds.Tables[7].Rows[2]["Type"].ToString();
            oView.LostValue = ds.Tables[7].Rows[2]["value"].ToString();

            oView.Others = ds.Tables[7].Rows[4]["Type"].ToString();
            oView.OthersValue = ds.Tables[7].Rows[4]["value"].ToString();
            ...
            for (int i = 0; i < ds.Tables[8].Rows.Count; i++)            {
                sPreviousCastList.Add(
                     ...
                     {
                         ForcastedValue = ds.Tables[8].Rows[i]["ForecastedValue"].ToString(),
                         OptNo = ds.Tables[8].Rows[i]["OptNumber"].ToString(),
                         OptName = ds.Tables[8].Rows[i]["optName"].ToString(),
                         Owner = ds.Tables[8].Rows[i]["Owner"].ToString(),
                         OptId = ds.Tables[8].Rows[i]["OptId"].ToString(),
                         StatusCode = ds.Tables[8].Rows[i]["StatusCode"].ToString()
                     });
            }
            ...
            for (int i = 0; i < ds.Tables[9].Rows.Count; i++)
            {
                sCurrentCastList.Add(
                     new SalesForcastedvalues
                     {
                         ForcastedValue = ds.Tables[9].Rows[i]["ForecastedValue"].ToString(),
                         OptNo = ds.Tables[9].Rows[i]["OptNumber"].ToString(),
                         OptName = ds.Tables[9].Rows[i]["optName"].ToString(),
                         Owner = ds.Tables[9].Rows[i]["Owner"].ToString(),
                         OptId = ds.Tables[9].Rows[i]["OptId"].ToString(),
                         StatusCode = ds.Tables[9].Rows[i]["StatusCode"].ToString()
                     });
            }
            ...
            for (int i = 0; i < ds.Tables[10].Rows.Count; i++)
            {
                sFutureCastList.Add(
                     new SalesForcastedvalues
                     {
                         ForcastedValue = ds.Tables[10].Rows[i]["ForecastedValue"].ToString(),
                         OptNo = ds.Tables[10].Rows[i]["OptNumber"].ToString(),
                         OptName = ds.Tables[10].Rows[i]["optName"].ToString(),
                         Owner = ds.Tables[10].Rows[i]["Owner"].ToString(),
                         OptId = ds.Tables[10].Rows[i]["OptId"].ToString(),
                         StatusCode = ds.Tables[10].Rows[i]["StatusCode"].ToString()
                     });
            }
            ...
            for (int i = 0; i < ds.Tables[11].Rows.Count; i++)
            {
                ...
                topOpp.OppId = "0";
                topOpp.Value = ds.Tables[11].Rows[i]["OPENVALUE"].ToString();
                topOpp.OppNumber = ds.Tables[11].Rows[i]["OPTNumber"].ToString();
                topOpp.Name = ds.Tables[11].Rows[i]["Name"].ToString();
                topOpp.Owner = ds.Tables[11].Rows[i]["Owner"].ToString();
    ...
    public class CountrynValueForMap {
