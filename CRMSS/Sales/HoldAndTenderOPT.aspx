<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="HoldAndTenderOPT.aspx.cs" Inherits="Sales_HoldAndTenderOPT" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
  ...
  text-decoration: none;
        ...
        .Opportunity-list-table th {
            text-align: center;
            color: white !important;
            background-color: #d54832;
        }

             .Opportunity-list-table td
        {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="ajax-loader loader-bg-blur">
      ...
      <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
       <div class="hold-header" style="padding-left: 2%; padding-top: 1%;"><h4 style="text-shadow: 1px -3px 8px; color: #a92828;">HOLD OPPORTUNITIES</h4></div> 
         <div class="tender-header" style="padding-left: 2%; padding-top: 1%;display:none;"><h4 style="text-shadow: 1px -3px 8px; color: #a92828;">TENDER OPPORTUNITIES</h4></div> 
  <div class="card-body" style="margin-top: -2%;">
     ...
     <div>
      ...
      <div class="table-responsive" style="margin-top: 1%;">
          <table class="table Opportunity-list-table">

              <thead>
                  <tr>
                      <th style="width:10%;">Opportunity Number</</th>
                      <th>Name</th>
                      <th>MEP Contractor</</th>
                      <th>Salesman</th>
                      <th>Consultant</th>
                      <th style="width:8%;">Update Aging</</th>
                      <th>Value</</th>
                      <th>VIEW</th>
                      <%-- <th>PropertyUsage</th>
                                             <th>ContractValue</th>
              ...
              <tbody class="tbody-Opportunties">
              </tbody>
          </table>
      </div>
     ...
     <div class="modal fade" id="ModalOptDetails" data-bs-backdrop="static" tabindex="-1" aria-hidden="true">
           <div class="modal-dialog modal-xl" role="document" style="max-width: 95%;">
             <div class="modal-content"<%-- style="background: antiquewhite;"--%>>
               <div class="modal-header">
                 <h5 class="modal-title" id="lblprojDetailModal">Opportunity Details</h5>
               ...
               <div class="modal-body">
                   ...
                   <div id="OptDetailsRowDiv" style="background: #1d1b1b36; padding: 17px; border-radius: 12px; border: 1px solid #1d1b1b36; box-shadow: 4px 4px 13px -7px #1d1b1b36;">
                       ...
                       <div class="row">
                           ...
                           <div style="width: 20%;">
                               ...
                               <div class="">
                                   ...
                                   <input class="form-control" type="text" id="txtPrjNo" readonly />
                               </div>
                           </div>
                           ...
                           <div style="width: 20%;">
                               ...
                               <div class="">
                                   <input class="form-control" type="text" id="txtOptNo"  readonly />
                           ...
                           <div style="width: 20%;">
                               ...
                               <div class="">
                                   ...
                                   <input class="form-control" type="text" id="txtOptName"  readonly />
                               </div>
                           </div>
                           ...
                           <div style="width: 20%;">
                               ...
                               <div class="">
                                   ...
                                   <input class="form-control" type="text" id="txtClient"  readonly />
                               </div>
                           </div>

                           <div style="width: 20%;">
                               <label for="html5-number-input" class="col-form-label label-custom">Developer Owner/Client</label>
                               <div class="">

                                   <input class="form-control" type="text" id="txtDevOwnerOrClient"  readonly />
                               </div>
                           </div>
                       ...
                       <div class="row">
                           ...
                           <div style="width: 20%;">
                               ...
                               <div class="">
                                   ...
                                   <input class="form-control" type="text" id="txtMainContractor" readonly />
                               </div>
                           </div>
                           <div style="width: 20%">
                               <label for="html5-number-input" class="col-form-label label-custom">Main Contractor Owner </label>
                               <div class="">

                                   <input class="form-control" type="text" id="txtMainContrOwner" readonly />
                               </div>
                           </div>

                           <div style="width: 20%;">
                               <label for="html5-number-input" class="col-form-label label-custom">MEP Consultant</label>
                               <div class="">
                                   <input class="form-control" type="text" id="txtMepConsultant" readonly />
                           ...
                           <div style="width: 20%;">
                               ...
                               <div class="">
                                   <input class="form-control" type="text" id="txtMarketing" readonly />
                       ...
                       <div class="row">
                           ...
                           <div style="width: 20%;">
                               ...
                               <div class="">
                                   <input class="form-control" type="text" id="txtSalesman" readonly />

                               </div>
                           </div>

                           <div style="width: 20%;">
                               <label for="html5-number-input" class="col-form-label label-custom">SalesStage </label>
                               <div class="">
                                   <input class="form-control" type="text" id="txtSalesstage" readonly />
                           ...
                           <div style="width: 20%;">
                               ...
                               <div class="">
                                   <input class="form-control" type="text" id="txtStatus" readonly />
                   ...
                   <div style="margin-top: 1.5%;">
                       ...
                       <div class="nav-align-top">
                           <ul class="nav nav-tabs" id="mstone-task-modal-ul" role="tablist">
                               <li class="nav-item">
                                   <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#navs-top-Revenue" aria-controls="navs-top-Revenue" aria-selected="true">Revenue List</button>
                               </li>
                           ...
                           <div class="tab-content">
                               <%--1st--%>
                               <div class="tab-pane fade show active" id="navs-top-Revenue" role="tabpanel" style="margin-top: -1%;">
                       ...
                       <%--            <div>
                                   ...
                                   <div class="table-responsive" style="margin-top: 1%; width: 100%;">
                                       ...
                                       <table class="table table-Revenue-Details" style="width: 100%;">

                                           <thead>
                                               <tr style="text-align: center;">
                                                  
                                                    <th style="display:none;">Order Level</th>
                                                   <th>Product Type</th>
                                                   <th>VL Status</th>
                                           ...
                                           <tbody class="tbody-Revenue-details" style="text-align: center;">
                                           </tbody>
                                       </table>
...
<%--    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.3.2/js/dataTables.buttons.min.js"></script>
 ...
 <%--     
    ...
    <script src="Scripts/HoldAndTenderOPT.js?v=1.2"></script>
