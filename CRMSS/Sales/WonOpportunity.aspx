<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="WonOpportunity.aspx.cs" Inherits="Sales_WonOpportunity" %>
            ...
            <script type="text/javascript">
             ...
             <div class="GridviewDiv" id="pnlSummaryView" runat="server">
                 <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                    ...
                    <asp:Panel ID="Panel1" runat="server" CssClass="pnlheading">
                        <div class="pnlheading">
                             <div class="pull-left">
                            <h3>
                                <asp:Label ID="Label13" ForeColor="White" Font-Bold="true" runat="server" Text="WON LIST"></asp:Label>
                    ...
                    <div class="card-block">
                          <div class="row">
                            ...
                            &nbsp;&nbsp;  &nbsp;&nbsp;
                              ...
                              <div class="pull-left" style="max-width:15%;">
                                <label class="form-label" style="margin-right:-20%">
                                    Contractor : 
                                                <asp:DropDownList ID="ddlContractor" runat="server" ForeColor="Black" AutoPostBack="true" CssClass="textBox11 form-control" OnSelectedIndexChanged="ddlContractor_SelectedIndexChanged" Width="85%"></asp:DropDownList>
                                </label>
                            </div>
                              &nbsp;&nbsp;  &nbsp;&nbsp;
                              <div class="pull-left">
                               ...
                               <div class="pull-left">
                                   <label class="form-label">
                                       Year : 
                                                <asp:DropDownList ID="ddlYear" runat="server" ForeColor="Black" CssClass="textBox11 form-control" OnSelectedIndexChanged="ddlYear_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                   </label>
               ...
               <div id="dvupdate" runat="server" style="overflow-y: auto; height: calc(100vh - 274px);overflow-x:hidden">
                   <asp:GridView ID="gdvWon" runat="server"
                                AutoGenerateColumns="false"
                       OnRowCommand="gdvWon_RowCommand" OnSorting="gdvWon_Sorting"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Marketing" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center" SortExpression="Marketing">
                                     ...
                                     <asp:TemplateField HeaderText="Amount" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center" SortExpression="LostAmount">
                                        <ItemTemplate>
                                            <asp:Label ID="lblAmount" Text='<%#(Eval("LostAmount").ToString()) %>'
                                                runat="server" />
                                        </ItemTemplate>
             ...
             <asp:Panel ID="pnlDetailView" runat="server" Visible="false">
                    ...
                    <div class="card" style="box-shadow: 6px 6px 12px 1px #888787 !important; border-radius: 5px !important;">
                           <asp:Panel ID="Panel3" runat="server" CssClass="pnlheading">
                            <div class="pull-left" >
                            <h3>
                                <asp:Label ID="Label8" ForeColor="White" Font-Bold="true" runat="server" Text="Won Opportunity"></asp:Label>
                              ...
                              <tr>
                               ...
                               <tr>
                                     ...
                                     <td style="padding: 3px 5px; width: 3%" class="label-alignment no-border">
                                      ...
                                      <td style="padding: 3px 5px; width: 10%" class="no-border">
										 <asp:TextBox ID="txtStatusDate" runat="server" CssClass="textBox1 form-control" Font-Bold="True" Enabled="false"></asp:TextBox>
									 </td>
                                     <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
									 <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
										 <asp:Label ID="Label22" runat="server" Text="Initiate Lost Date" Visible="false"></asp:Label>
									 </td>
                                 <td style="padding: 3px 5px; width: 10%" class="no-border">
										 <asp:TextBox ID="txtReqLostDate" runat="server" CssClass="textBox1 form-control" Font-Bold="True" Enabled="false" Visible="false"></asp:TextBox>
									 </td>
                                        <td style="padding: 3px 5px; width: 1%" class="label-alignment no-border"></td>
									    <td style="padding: 3px 5px; width: 5%" class="label-alignment no-border">
										 <asp:Label ID="Label21" runat="server" Text="Salesman Lost Date" Visible="false"></asp:Label>
									 </td>
                                   <td style="padding: 3px 5px; width: 10%" class="no-border">
										 <asp:TextBox ID="txtLostDate" runat="server" CssClass="textBox1 form-control" Font-Bold="True" Enabled="false" Visible="false"></asp:TextBox>
									 </td>
                         ...
                         <%--  three panels start --%>
                               <div class="row">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Updated Date" ItemStyle-Width="8%" Visible="true" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                             ...
                                             <asp:TemplateField HeaderText="History" ItemStyle-Width="5%" Visible="true" ItemStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="BtnSalesupdate" runat="server" CommandArgument='<%#(Eval("OptNumber").ToString()) %>' CommandName="History" Style="text-align: center" CssClass="btn rounded-pill btn-icon btn-round"><i class="fa fa-history" title="History"></i></asp:LinkButton>
                                ...
                                <div class="pull-left" style="width: 33.33%">
                                    ...
                                    <asp:GridView ID="gdvMarketingUpdate" runat="server" AutoGenerateColumns="False" CellSpacing="0" BorderWidth="0"
                                        AllowSorting="True" EmptyDataText="No Data Found.." AllowPaging="true" OnRowCommand="gdvMarketingUpdate_RowCommand"
                                         class="table-striped table-bordered nowrap" ForeColor="#333333" CellPadding="4" GridLines="None">
                                        <FooterStyle CssClass="GridFooter" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                                <RowStyle CssClass="GridItem" BackColor="#E3EAEB" />
                                <HeaderStyle HorizontalAlign="Center" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                            ...
                            <asp:Panel ID="pnlRevenue" runat="server" CssClass="pnlsubheading">
                             ...
                             <div id="Div1" runat="server" style="overflow-y: auto; max-height: calc(100vh - 650px);overflow-x:hidden">
                                  ...
                                  <asp:GridView ID="gdvRevenue" runat="server" AutoGenerateColumns="False" CellSpacing="0" BorderWidth="0"
                                        AllowSorting="True" EmptyDataText="No Data Found.." Width="100%" OnRowCommand="gdvRevenue_RowCommand"  
                                         class="table-striped table-bordered nowrap" ForeColor="#333333" CellPadding="4" GridLines="None">
                                        <FooterStyle CssClass="GridFooter" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" />
                                <RowStyle CssClass="GridItem" BackColor="#E3EAEB" />
                                <HeaderStyle HorizontalAlign="Center" BackColor="#1C5E55" Font-Bold="True" ForeColor="White" Font-Size="Small" />
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Scope" ItemStyle-Width="15%" Visible="true" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                            ...
                                            <ItemStyle HorizontalAlign="Center" Font-Bold="false"/>
                                             ...
                                             <asp:TemplateField HeaderText="S/O Number" ItemStyle-Width="8%" Visible="true" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSONo" Text='<%#(Eval("SalesOrderNo").ToString()) %>'
                                                        runat="server" />
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Center" Font-Bold="false"/>
                                            </asp:TemplateField>

                                             <asp:TemplateField HeaderText="S/O Date" ItemStyle-Width="8%" Visible="true" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSODate" Text='<%#(Eval("SalesOrderDate").ToString()) %>'
                                                        runat="server" />
                                                </ItemTemplate>
                                               <ItemStyle HorizontalAlign="Center" Font-Bold="false"/>
                                            </asp:TemplateField>
