<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/EconnectNew.master" AutoEventWireup="true" CodeFile="RelatedOpportunity.aspx.cs" Inherits="Sales_RelatedOPTAndProject" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="ajax-loader loader-bg-blur">
      ...
      <div class="card" style="margin-top: 1%; width: 97%; left: 1.5%;">
       <div style="padding-left: 2%; padding-top: 1%;"><h4 style="text-shadow: 1px -3px 8px; color: #a92828;">RELATED OPPORTUNITY</h4></div> 
  ...
  <div class="card-body" style="margin-top: -2%;">
     ...
     <div>
      ...
      <div class="" style="margin-top: 1%;">
          <table class="table OPT-list-table">

              <thead>
                  <tr>
 
                      <th style="width:8%;">OPT.No</th>
                      <th style="width:14%;">Name</th>
                      <th style="width:6%;">MEP Contractor</th>
                      <th style="width:8%;">Salesman</th>
                      <th style="width:6%;">Consultant</th>
...
<%--    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.3.2/js/dataTables.buttons.min.js"></script>
 ...
 <%--     
    ...
    <script src="Scripts/RelatedOpportunity.js?v=0.5"></script>
